...
<title>:: SADAREM :: Expired SADAREM Certificates detailed Report</title>
...
function fn_excel()
{
	...
	document.ExpiredSadaremdataform.action="<%=request.getContextPath()%>/expiredSadaremCertisReport.do?mode=excelNew";
			...
			else if($('#endDate').val()==''||$('#endDate').val()==null)
		 	{
				alert("Please Enter To Date before submitting");}
				...
				else
					{
							...
							document.ExpiredSadaremdataform.action="<%=request.getContextPath()%>/expiredSadaremCertisReport.do?mode=getExpiredSadaremdata&randomid="+Math.random();
							document.ExpiredSadaremdataform.submit();
	  ...
	  <tr>
	    <td align="left" valign="middle" width="100%">
	    			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
					  <tr>
					    <th class="hd_gd" align="center" valign="middle">R.5.3 Expired SADAREM Certificates Report </th>
					  </tr>
	  				<tr>
  					<td>
		        ...
		        <table width="90%" align="center">
  				...
  				<tr class="gridHdrStyle">
  				 ...
  				 <%-- 	<th height="30" class="hd_gd" align="center" valign="middle" >
  				 	...
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >District</th>
  				 	...
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Person Id</th>
  				 	...
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Gender</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Age</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Proof Id</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Proof Type</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Type Of Disability</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >House Number</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Issued Date</th>
  				 	<th height="30" class="hd_gd" align="center" valign="middle" >Expired Date</th>
  				</tr>
  				...
  				<tr class="gridHdrStyle">
  				  ...
  				  <%
	  				...
	  				<tr>
	  				    ...
	  				    <td class="<%=classStyle%>" align="left" valign="middle"><%=tempList.get(11) %></td>
	  				 	<td class="<%=classStyle%>" align="left" valign="middle"><%=tempList.get(12) %></td>
	  				 	<td class="<%=classStyle%>" align="left" valign="middle"><%=tempList.get(13) %></td>
	  				 	<td class="<%=classStyle%>" align="left" valign="middle"><%=tempList.get(14) %></td>
