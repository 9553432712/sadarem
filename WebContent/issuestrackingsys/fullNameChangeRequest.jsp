	...
	document.title = "::SADAREM :: ";
		...
		$("#printbutid").click(function()
	     ...
	     $("#raiseissueButID").click(function ()
	      ...
	      if($('#surname').val()=="" || $('#surname').val()==null || $('#surname').length == 0)
			{
 	      ...
 	      else if($('#fname').val()=="" || $('#fname').val()==null || $('#fname').length == 0)
			{
			...
			if(confirm("Are you sure you want to submit the request?"))
				{
					...
					document.name_issue.action="<%=request.getContextPath()%>/fullNameChangeIssue.do";
					            ...
					            <div class="panel panel-primary" >
					                ...
					                <div class="panel-body" style="background-color: #eee;">
 											 ...
 											 <div class="form-group row"> 
 					                            <div class="input-group col-md-12" title="Surname"> 
 					                              <div class="input-group-addon" style="background-color: #2E9BD8; color:#fff;" > Surname <font color='red'>*</font> </div>  
					                                <input type="text" name="surname" id="surname" class="form-control" autocomplete="off"    value='<%=basicData.get(9)%>' onBlur="this.value = SpaceReplace(this.value);"  onkeypress="return onKeyPressAlphbateOnly(event);" maxlength="50">   
 					                             </div> 
 					                           </div> 
