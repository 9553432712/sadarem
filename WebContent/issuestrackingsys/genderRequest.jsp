	   ...
	   $("#raiseissueButID").click(function ()
		...
		{  
			if(confirm("Are you sure you want to submit the request?"))
			{
				...
				document.name_issue.action="<%=request.getContextPath()%>/genderChangeIssue.do";
											 ...
											 <div class="form-group row"> 
					                            <div class="input-group col-md-12" title="Gender">
					                             ...
					                             <span class="input-group-addon"> <%=gender %></span>
					                                <input type="hidden" name="genderId" id="genderId" class="form-control" autocomplete="off"    value='<%=genderId%>'>  
					                                <input type="hidden" name="gender" id="gender" class="form-control" autocomplete="off"    value='<%=gender%>'>
					                             </div>
					                              ...
					                              <div id="collapseOne" class=" panel-collapse collapse" style="width:90%;margin:0px auto;">
														 <div class="form-group row" style="align:center">
												            <div class="input-group col-md-12" title="Proofs">
												                 ...
												                 <input type="text" id="proofid_1" name="proofid_1" class="form-control"  maxlength=30 onblur="validate('proofidentity_1','proofid_1')" autocomplete=off />
												            </div>
												            </div>		
												         <div class="form-group row"> 
