			...
			<div class="row">
				<div class="col-md-12">
					<table> 
                      <thead>
                      <tr>
                       <td rowspan=2 align="center" style="border-left:#337ab7 1px solid; background-color:#337ab7;padding:5px;color:#fff;">Grievance ID</td>
                       <td rowspan=2 align="center" style="background-color:#337ab7;padding:5px;color:#fff;">Grievance Type</td>
                       <!-- <td  align="center" style="background-color:#337ab7;padding:5px; color:#fff;">SADAREM ID</td> -->
                       <td rowspan=2 align="center" style="background-color:#337ab7;padding:5px; color:#fff;">Person Name</td>
                       <td rowspan=2 align="center" style="background-color:#337ab7;padding:5px;color:#fff;">District</td>
                       <td rowspan=2 align="center" style="background-color:#337ab7;padding:5px;color:#fff;">Mandal</td>
                       <td rowspan=2 align="center" style="border-right:#337ab7 1px solid;background-color:#337ab7;padding:5px;color:#fff;">Request Raised Date</td>
                        
                       <td colspan=3 align="center" style="border-right:#337ab7 1px solid;background-color:#337ab7;padding:5px;color:#fff;">Current Status</td>
                       </tr>    <tr>
                         <td  align="center" style="border-right:#337ab7 1px solid;background-color:#337ab7;padding:5px;color:#fff;">Status</td>  
                      <td  align="center" style="border-right:#337ab7 1px solid;background-color:#337ab7;padding:5px;color:#fff;">Remarks</td>  
	                   ...
	                   if(openbasicData1!=null && openbasicData1.size()>0){
                        ...
                        <%--    <td  style="border:#337ab7 1px solid; width:15%;" align="left"><%=innerList.get(2)%></td> --%>
                           ...
                           <td  style="border:#337ab7 1px solid; width:10%;" align="center"><%=innerList.get(7) %></td> 
                           <td  align="center" style="border:#337ab7 1px solid; width:10%;" ><b> <%=innerList.get(6) %> </b></td>
                           <td  style="border:#337ab7 1px solid; width:10%;" align="left"><%=innerList.get(9) %></td>
                           <td  align="center" style="border:#337ab7 1px solid; width:10%;" ><%=innerList.get(8) %></td> 
                          </tr>     
                            <%}
                           }
                           else
