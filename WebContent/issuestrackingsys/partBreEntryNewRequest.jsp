 ...
 <%
    ...
    ArrayList PartBReasonCategoryList = new ArrayList();
	...
	PartBReasonCategoryList = (ArrayList)request.getAttribute("PartBReasonCategory");
  ...
  $(document).ready( function()
	{
	  ...
	  document.title = "::SADAREM :: ";
	   ...
	   $("#raiseissueButID").click(function ()
		{
		   if($('#PartBReasonCategory').val()=="-1" || $('#PartBReasonCategory').val()==null || $('#PartBReasonCategory').length==0)
		   {
		       alert("Please select Category");
		       $('#PartBReasonCategory').focus();
		       return false;
		   }
		...
		{  
			if(confirm("Are you sure you want to submit the request?"))
			{
				...
				document.name_issue.action="<%=request.getContextPath()%>/partbReEntryIssue.do";
...
<input type="hidden" id="FormSessionID" name="FormSessionID" value="<%=FormID%>" />
					...
					<marquee><font color="red">After the Final Approval of grievance,Further process of Part-B will be done in their respective Camps/Districts.</font></marquee>
									 		 ...
									 		 <div class="form-group row"> 
					                            <div class="input-group col-md-12" title="Gender">
					                              <div class="input-group-addon" style="background-color: #2E9BD8; color:#fff;" > Category <font color='red'>*</font> </div> 
					                               <%=ComboUtil.createStrComboBoxAuto("PartBReasonCategory",PartBReasonCategoryList, "", "form-control", "",true,true, "")%>
		 										</div>
					                           </div> 
