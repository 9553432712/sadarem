      	...
      	else if(($('#proofidentity_2').val() != -1) && ($('#proofDoc_2').val()=="" || $('#proofDoc_2').val()==null || $('#proofDoc_2').length == 0))
      	{
			...
			{  
				if(confirm("Are you sure you want to submit the request?"))
				{
					...
					document.name_issue.action="<%=request.getContextPath()%>/relationNameTypeChangeIssue.do";
											 ...
											 <div class="form-group row"> 
					                            <div class="input-group col-md-12" title="Relation Name">
					                              <div class="input-group-addon" style="background-color: #2E9BD8; color:#fff;" > Relation Name <font color='red'>*</font> </div> 
					                                <input type="text" name="relationname" id="relationname" class="form-control" autocomplete="off"    value='<%=basicData.get(17)%>' onBlur="this.value = SpaceReplace(this.value);"  onkeypress="return onKeyPressAlphbateOnly(event);" maxlength="50">  
					                             </div>
					                            ...
					                            <div class="input-group  col-md-12" title="Relation Type">    
					                               ...
					                               --%> 
					                                <div class="input-group-addon" style="background-color: #2E9BD8; color:#fff; " value='<%=(String)basicData.get(16)%>'> Relation Type <font color='red'>*</font></div> 
					                              <%=ComboUtil.createStrComboBoxAuto("relationType",relationTypeList,(String)basicData.get(25), "form-control","",true,true,"")%>  
					                             </div>
					                            </div>
					                           ...
					                           <div class="form-group row"> 
					                            <div class="input-group  col-md-12" title="Telugu name"> 
					                              <div class="input-group-addon" style="background-color: #2E9BD8; color:#fff;" > <%=telugu%>(<%=fullname%>)<font color='red'>*</font></div> 
					                                <input type="text" name="telname" id="telname" class="form-control" autocomplete="off" onkeypress="return onKeyPressAlphbateOnly(event);"  onkeyup="javascript1:surname_many_words()" onfocus="javascript1:surname_many_words()" value='<%=basicData.get(17)%>' >
					                              
					                                <div class="input-group-addon"  id="fulnametelugu" name="fulnametelugu"><%=(String)basicData.get(18)%></div>  
					                              ...
					                              <div id="collapseOne" class=" panel-collapse collapse" style="width:90%;margin:0px auto;">
														 <div class="form-group row" style="align:center">
												            <div class="input-group col-md-12" title="Proofs">
												                 ...
												                 <input type="text" id="proofid_1" name="proofid_1" autocomplete="off" class="form-control"   maxlength=30 onblur="validate('proofidentity_1','proofid_1')" />
												            </div>
												            </div>		
												         <div class="form-group row"> 
					                              ...
					                              <div id="collapseTwo" class=" panel-collapse collapse" style="width:90%;margin:0px auto;">
														 <div class="form-group row" style="align:center">
												            <div class="input-group col-md-12" title="Proofs">
												                 ...
												                 <input type="text" id="proofid_2" name="proofid_2" autocomplete="off" class="form-control" maxlength=30 onblur="validate('proofidentity_2','proofid_2')" />
												            </div>
												            </div>		
												         <div class="form-group row"> 
							                              <div class="input-group col-md-12" title="Document"> 
