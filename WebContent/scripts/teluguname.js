		...
		document.name_issue.txtDescription.value=document.name_issue.telugu.value;
		}
		function Catname()
		{
		
		document.name_issue.txtCatName.value=document.name_issue.telugu.value;
		}
		function Flashnews()
		{
		 
		document.name_issue.txtFlashNews.value=document.name_issue.telugu.value;
		}
		function Videos()
		{
		
		document.name_issue.txthvsubject.value=document.name_issue.telugu.value;
		}
		function  description()
		{
		document.name_issue.txthvdescription.value=document.name_issue.telugu.value;
		}
...
{
  var text_pmw = many_words(document.name_issue.telname.value);
  ...
  document.name_issue.hidfulnametelugu.value = html_txt;
}
function relation_many_words(index_pmw)
{
  var text_pmw = many_words(document.name_issue.teluguname.value);
  ...
  document.getElementById('fullnametelugu').innerHTML = ans;
  ...
  document.name_issue.hidfullnametelugu.value = html_txt;
}
