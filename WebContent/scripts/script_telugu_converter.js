...
function print_many_words(index_pmw,convert_text,html_text)
{
  var text_pmw = many_words( document.getElementsByName(index_pmw)[0].value);
  ...
  while (text_pmw.length) 
   ...
   document.getElementsByName(convert_text)[0].value = ans;
