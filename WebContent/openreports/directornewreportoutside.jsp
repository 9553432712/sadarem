...
<title>:: SADAREM :: R1.2 New Report</title>
    	...
    	$("#districtwiseformSubmitbut").click(function( event )
    			{
    				...
    				if($("#fromdate1").val()=="")
    					...
    					else
    					{
    						...
    						document.districtwiseform.action="<%=request.getContextPath()%>/directorNewReportOutside.do?randomid="+Math.random();
...
<body>
 ...
 <div class="main_container" oncontextmenu="return false;" ondragstart="return false" onselectstart="return false" >                   
    ...
    <div align="center"><font color="#337ab7" size="4px"><b>R1.2.1 : SADAREM Assessment Report District Wise</b></font></div>
...
<%-- <div class="panel panel-primary" id="campwiseform">
 ...
 <%=districtheadingmsg%>
<a href="<%=request.getContextPath()%>/directorNewReportOutside.xls?mode=excelNew&fromdate1=<%=fromdate1%>&todate=<%=todate1%>&district=<%=district1%>&heading=<%=districtheadingmsg%>">
<img height="30" width="30" src="<%=request.getContextPath()%>/images/excel.jpg" border="0" align="right" title="Export Excel"/>
 </a> <br> <font style="text-align:left; float:left;" color='red'>Note: These are tentative counts only!!</font><br></div> 
