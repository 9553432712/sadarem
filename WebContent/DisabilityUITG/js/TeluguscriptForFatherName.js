		...
		document.partAForm.txtDescription.value=document.partAForm.telugu.value;
		}
		function Catname()
		{
		
		document.partAForm.txtCatName.value=document.partAForm.telugu.value;
		}
		function Flashnews()
		{
		
		document.partAForm.txtFlashNews.value=document.partAForm.telugu.value;
		}
		function Videos()
		{
		
		document.partAForm.txthvsubject.value=document.partAForm.telugu.value;
		}
		function  description()
		{
		document.partAForm.txthvdescription.value=document.partAForm.telugu.value;
		}
...
{
  var text_pmw = many_words(document.partAForm.firstnameenglish.value);
  ...
  document.partAForm.firstnametelugu.value = ans;
  ...
  document.partAForm.telugufathername.value = html_txt;
}
