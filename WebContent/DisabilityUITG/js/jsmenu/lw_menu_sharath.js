...
var imgPath = "scripts/jsmenu/"

var TextColor = "white"
var SubMenuBorder = "white"

var mainItemForeground = "#3e81d2"
var mainItemBorder = "#3e81d2"
var mainItemBackground = "#6fabe3"

var mainItemHoverForeground = "#3e81d2"
var mainItemHoverBorder = "#3e81d2"
var mainItemHoverBackground = "#3e81d2"

var subItemForeground = "#3e81d2"
var subItemBorder = "#3e81d2"
var subItemBackground = "#6fabe3"

var subItemHoverForeground = "#3e81d2"
var subItemHoverBorder = "black"
var subItemHoverBackground = "#3e81d2"	//"B6D2FA"#E1FFB5
...
//------ input is function(mode) without qoutes for mode within function-----------
		...
		{
			sHTML += "<td style='padding-left:1px' width=15><img src='"
			if (menu[menuId].img=="")
			{
			...
			sHTML += "' width=10 height=16 border=0></td>"
		}
		...
		sHTML += "<td style='color:"+TextColor+";font-weight:bold;padding-left:3px;padding-right:3px' align=left>" + menu[menuId].description.replace(" ","&nbsp;") + "</td><td style='padding-right:1px' align=right width="+nArrowWidth+">"
		if (menu[menuId].numChild>0)
		{
			if ((orientation==0)&&(menu[menuId].levelId==0))
			{
...
function DrawMenu ()  {
	...
	sHTML="<table height='1%' width=40% cellpadding=0 cellspacing=0>"
	for (var i=0; i<menuCounter; i++)
	{
