...
//------ input is function(mode) without qoutes for mode within function-----------
		...
		sHTML += "<td style='color:"+TextColor+";font-weight:bold;padding-left:5px;padding-right:5px' align=left>" + menu[menuId].description.replace(" ","&nbsp;") + "</td><td style='padding-right:2px' align=right width="+nArrowWidth+">"
		if (menu[menuId].numChild>0)
		{
			if ((orientation==0)&&(menu[menuId].levelId==0))
			{
