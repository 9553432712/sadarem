		...
		document.PwdRequestForm.txtDescription.value=document.PwdRequestForm.telugu.value;
		}
		function Catname()
		{
		
		document.PwdRequestForm.txtCatName.value=document.PwdRequestForm.telugu.value;
		}
		function Flashnews()
		{
		
		document.PwdRequestForm.txtFlashNews.value=document.PwdRequestForm.telugu.value;
		}
		function Videos()
		{
		
		document.PwdRequestForm.txthvsubject.value=document.PwdRequestForm.telugu.value;
		}
		function  description()
		{
		document.PwdRequestForm.txthvdescription.value=document.PwdRequestForm.telugu.value;
		}
...
{
  var text_pmw = many_words(document.PwdRequestForm.firstnameenglish.value);
  ...
  document.PwdRequestForm.firstnametelugu.value = ans;
  ...
  document.PwdRequestForm.telugufathername.value = html_txt;
}
