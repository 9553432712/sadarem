...
{
  var text_pmw = many_words(document.PwdRequestForm.surnameenglish.value);
  ...
  document.PwdRequestForm.surnametelugu.value = ans;
  ...
  document.PwdRequestForm.telugupersonname.value = html_txt;
}
