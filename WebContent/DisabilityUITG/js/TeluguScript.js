...
{
  var text_pmw = many_words(document.partAForm.many_words_text.value);
  ...
  document.partAForm.converted_text.value = ans;
  ...
  document.partAForm.html_text.value = html_txt;
}
