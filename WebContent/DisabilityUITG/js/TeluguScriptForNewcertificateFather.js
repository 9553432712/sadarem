		...
		document.NewCertificateForm.txtDescription.value=document.NewCertificateForm.telugu.value;
		}
		function Catname()
		{
		
		document.NewCertificateForm.txtCatName.value=document.NewCertificateForm.telugu.value;
		}
		function Flashnews()
		{
		
		document.NewCertificateForm.txtFlashNews.value=document.NewCertificateForm.telugu.value;
		}
		function Videos()
		{
		
		document.NewCertificateForm.txthvsubject.value=document.NewCertificateForm.telugu.value;
		}
		function  description()
		{
		document.NewCertificateForm.txthvdescription.value=document.NewCertificateForm.telugu.value;
		}
...
{
  var text_pmw = many_words(document.NewCertificateForm.firstnameenglish.value);
  ...
  document.NewCertificateForm.firstnametelugu.value = ans;
  ...
  document.NewCertificateForm.telugufathername.value = html_txt;
}
