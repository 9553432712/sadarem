...
{
  var text_pmw = many_words(document.partAForm.surnameenglish.value);
  ...
  document.partAForm.surnametelugu.value = ans;
  ...
  document.partAForm.telugupersonname.value = html_txt;
}
