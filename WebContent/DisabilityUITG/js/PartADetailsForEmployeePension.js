...
function DistrictName(){
    var district_id = document.forms[0].district_id;
    if(district_id !=null){
...
<!-- Validation for MandalName -->
function MandalName(){
    var mandal_id = document.forms[0].mandal_id;
    if(mandal_id !=null){
        if(mandal_id.value == ""){
...
<!-- Validation for VillageName -->
function VillageName(){
    var village_id = document.forms[0].village_id;
    if(village_id !=null){
        if(village_id.value == ""){
...
<!-- Validation for PanchayatName-->
function PanchayatName(){
    var panchayat_id = document.forms[0].panchayat_id;
    if(panchayat_id !=null){
        if(panchayat_id.value == ""){
            alert("Please Select Panchayat Name!");
...
<!-- Validation for HabitationName -->
function HabitationName(){
    var habitation_id = document.forms[0].habitation_id;
    if(habitation_id !=null){
        if(habitation_id.value == ""){
