        ...
        <form action="gotoexcel.do" method="post">
            <table  border="1" height="10%" align="center" cellspacing="1"
                ...
                <tr class="tbl_bg2_content" >
                    <td align="center" bgcolor="white"><font color="#660000">
                                 <b>S.NO</b></font></td> 
                    <td align="center" bgcolor="white"><font color="#660000">
                                 <b>District Name</b></font></td>
                    <td align="center" bgcolor="white"><font color="#660000">
                                <b>District Level Count</b></font></td>
                </tr>
                ...
                <logic:iterate id="modify" name="reportlist" scope="request">
                    <tr class="tbl_bg2_content">
                        ...
                        <%=++i%> </td>
                        <td align="center"  bgcolor="white">
                        <a href="getMandalidForSurgery.do?getMandalReport=getMandalReport&districtid=<bean:write name="modify" property="districtid"/>&field=<%=fieldvalue%>&secondfield=<%=secondfieldvalue%>&FromDate=<%= fromdate %>&ToDate=<%= todate %>">
                        <bean:write name="modify" property="district"/></a></td>
                        <td align="center"  bgcolor="white"><a href="selectdistrictforsurgery.do?nexxt=start&back=start&getdistrictPersonalReport=getdistrictPersonalReport&districtid=<bean:write name="modify" property="districtid"/>&FieldValue=<%=fieldvalue%>&SecondFieldValue=<%=secondfieldvalue%>&FromDate=<%= fromdate %>&ToDate=<%= todate %>&distcount=<bean:write name="modify" property="districtcount"/>">
                        <bean:write name="modify" property="districtcount"/></a>
                               </td>
