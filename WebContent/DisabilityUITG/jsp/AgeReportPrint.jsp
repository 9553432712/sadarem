...
<html>
    ...
    <body onload="window.print();">
          ...
          <table  align="center" cellspacing="0" border="0" cellpadding="0" class="innerTable" width="100%">
            ...
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%">
                ...
                <tr>
                    <td align="center" class="formaltbg" ><b>   SADAREM AgeWise Report<br>
 ...
 As On <font color="blue"><%=f%></font> To <font color="blue"><%=t%> <% if(name!=null) {%>, <%=name%> <%}%></font>   </b></td>
             ...
             <logic:present name="empWiseDetails">
                    <logic:empty name="empWiseDetails">
                        <table align="center">  <tr>
                                <td  align="center" valign="top">
                                    <table  align="center">
                                        <tr><td  align="center" ><font color="red"><b>No Data</b></font></td></tr>
                                    </table></td></tr></table>
                                </logic:empty>
                            </logic:present>
                 ...
                 <bean:define id="reg" value="0"/>
                   ...
                   <!--     <table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="innerTable">-->
                            <tr>
                                <td height="445" align="center"  valign="top" width="100%">
                                    <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%">
