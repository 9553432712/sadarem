...
<BODY onload="disableLink();">
    ...
    <html:form action="updateTotalDisabilityPrint.do" styleId="territoryform" onsubmit="return avoidDuplicateForm(this)">
        <br>
         <% String message=(String)request.getAttribute("msg"); %>
  <% if(message!=null)  { %> <font color="black"><center><%=message %> <% } %></center><br>
        <table  align="center" cellspacing="1" cellpadding="5" class="innerTable" width="85%">
        <tr>
            <td class="heading" align="center">Select The Appropriate Disability Link (TO UPDATE DISABILITY)</td>
        </tr>
        </table>
        <table  align="center" cellspacing="1" cellpadding="5" border="1" class="innerTable1" width="85%">
            <tr><font size="2"><td>
                ...
                <logic:equal name="disabilityIdForm" property="disabilityId" value="1">
                    ...
                    <font size="3"color=#FF3300><li><a href="Locomotorneedsselect.do?getLocomotorneeds=getLocomotorneeds" id="locomotor" onclick="disableLink();"><font size="2">
                                      Locomotor Disability</li></a></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <table>
          ...
          <tr>
              ...
              <td width="50%">
                  ...
                  <font size="3"color=#FF3300><a href="getMentalRetardationIqvaluesPrint.do?getMentalRetardationIQValues=getMentalRetardationIQValues" id="mentalretardation" onclick="disableLink();"><font size="2">
        ...
        <table align="center"><tr><td>
            <input type="Submit" value="Next" onclick="return radio_button_checker()" class="button"></td>
        </tr></table>
    </html:form>
