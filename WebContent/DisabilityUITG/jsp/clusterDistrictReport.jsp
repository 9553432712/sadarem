<%-- 
    Document   : clusterDistrictReport
    Created on : Sep 2, 2013, 4:08:37 PM
    Author     : 310926
--%>
                ...
                <td align="center" bgcolor="#e4f5fd" valign="top">
                    ...
                    <logic:present name="data">
                        <table align="center" cellpadding="0" cellspacing="0" border="0" width="60%">
                            <tr><td class="formhdbg" align="center" colspan="10"> Report for District: <%=dName%>, Cluster: <%=cName%>, Mandal: <%=mName%></td></tr>
                            <tr>
