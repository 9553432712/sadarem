...
<html>
    <head>
        ...
        <%
                    // String campBasedId = (String) request.getParameter("medicalBoard");
                    // String campDate = (String) request.getParameter("date");
        ...
        <link rel='stylesheet' href='./DisabilityUITG/css/calendar.css' title='calendar'>
        ...
        <script>
            function fnSetDateFormat(oDateFormat)
            {
                ...
                sDateString = oDateFormat['Date'] +"/"+ oDateFormat['Month'] +"/"+ oDateFormat['FullYear'];
                document.forms[0].elements['date'].value = sDateString;
        ...
        <script type="">
            ...
            function getCampBasedDisabilityDetails(){

                if(document.forms[0].elements['campDate'].value==""){
                    alert("Please select the Assessment date");
                    document.forms[0].elements['campDate'].focus();
                    return false;

                }else {
                    document.forms[0].mode.value ="campBasedDisabilityDetails";
    ...
    <body>
        <html:form action="/campWiseDoctorsCount">
            ...
            <%--<html:hidden property="campBasedData" value="<%=campBasedId%>"/>
            ...
            <table cellpadding="1" cellspacing="8" align="center" width="85%" class="innerTable">

                <tr align="center">



                    <td class="label" colspan="2">Assessment date<font color="red"><b>*</b></font>
                        <html:text property="campDate" styleId="txtCalendarSeventh" style="inputBoxStyle" readonly="true"/>
                        <img src='./DisabilityUITG/images/cal.gif' align='absmiddle' onmouseover="fnInitCalendar(this, 'txtCalendarSeventh', 'style=calendar.css,restrict=true,instance=single,close=true')">
                ...
                <tr>
                    ...
                    <td class="label" align="center" colspan="4">
                        <html:button property="but" value="Get Report" onclick="getCampBasedDisabilityDetails();"/>
            ...
            <logic:present name="campBasedOnDisabilityDetails">
                <table  align="center" cellspacing="0" border="0" cellpadding="0" class="innerTable" width="85%">
                    ...
                    <logic:iterate name="campBasedOnDisabilityDetails" id="row">
                        ...
                        <tr>
                            ...
                            <td class="formaltbg" align="center">
                                ${row.doctorRegNumber}
                                <html:hidden property="docRegNo" value="${row.doctorRegNumber}"/>
                            </td>
                            <td class="formaltbg" align="left">
                                ${row.doctorDesignation}
                            </td>
                            <td class="formaltbg" align="center" id="${row.disabilityId}">
                                <html:text property="countOfPwd" size="3" styleId="pwdCount${row.sno}" onkeypress="return onlyNumbers();" maxlength="5"/>
                            </td>
                        </tr>
                ...
                <table  align="center" cellspacing="0" border="0" cellpadding="0" width="90%">
                    <tr>
                        <td class="label" align="center" colspan="4">
                            <html:button property="but" value="Continue" onclick="getAssessedPwdDoctorsCount();"/>
                        </td>
                    </tr>
                </table>
