<%-- 
    Document   : villageWiseStatusReportForPartBPrint
    Created on : Jun 23, 2010, 1:56:30 PM
    Author     : srinivas_p
--%>
...
<%          String fromdate = (String) request.getParameter("fromdate");
            ...
            partBVillageReport = (ArrayList) session.getAttribute("partBVillageReport");
    ...
    <table  border="1" cellspacing="1" cellpadding="5" class="innerTable" width="60%">
        ...
        <tr>
            <td class="label" align="center" colspan="15">
                <font color="#c71585">
                    Village Wise Report For Personal Information & Assessed PWD's Details As On <%= fromdate%> To <%= todate%>&nbsp;&nbsp;&nbsp;Mandal:<%=mandalname%></font>
                <%if (districtname == null) {%><font color="#c71585">District:<%=districtname%></font><% } else {%>
                <font color="#c71585">District: <%=districtname%></font> </td></tr>
                <% }%>
        <tr>
            <td align="center" class="labelBlue" rowspan=2>S.No</td>
            <td ALIGN="center" class="labelBlue" rowspan=2>Village</td>
        ...
        <% int i = 0;%>
        <logic:iterate id="disabilityreport" name="partBVillageReport" scope="session">
            <tr>
                <td class="label"><%=++i%></td>
        ...
        <tr>
            <%--  <td class="label">&nbsp;&nbsp;</td>--%>
            <td align="center" class="label" colspan="2"><b>Total</b></td>
