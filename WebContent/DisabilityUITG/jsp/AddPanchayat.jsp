...
<html:html>
    ...
    <head>
        <script>
            ...
            if (validate_required(panchayat_name,"Panchayat cannot be empty")==false)
            {
    ...
    <html:form action="addPanchayat.do?addPanchayat=addPanchayat" onsubmit="return validate_form(this)" >
        ...
        <tr class="tbl_bg2_content_hdr"> 
            <td ><center><font size="4">Add Panchayat</font></center></td>
        </tr></table> 
        <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="80%" height="40%">		
            ...
            <tr class="tbl_bg2_content_hdr_new"> <font size="2"><td><b> Panchayat Name</font></td>
                <td colspan="3"> 
                    <html:text property="panchayat_name" value=""/>
                </td>
            </tr>
