        ...
        <form action="gotoexcel.do" method="post">
            ...
            <table  border="1" height="10%" align="center" cellspacing="1" 
                ...
                <caption><h2><font face="vardana" color="#660000">
                    <%= session.getAttribute("TableHeading") %>
                </font></h2></caption>
                <tr class="tbl_bg2_content" >
                    <td colspan="3" align="center"  bgcolor="white">
                        <font  size="2" color="#660000"><b>S.No</b></font>
                    </td> <td align="center"  bgcolor="white">
                    <font  size="2" color="#660000"><b>District Name</b></font></td>
                    <td align="center"  bgcolor="white">
                    <font  size="2" color="#660000"><b>District Level Count</b></font></td>
                </tr>
                <% int i=0;%>  
                ...
                <logic:iterate id="modify" name="reportlist" scope="request">
                    <tr class="tbl_bg2_content">
                        <td colspan="3" align="center" bgcolor="white"><%=++i%>
                        <td align="center" bgcolor="white"><a href="getMandalidForEducation.do?getMandalReport=getMandalReport&districtid=<bean:write name="modify" property="districtid"/>&field=<%=fieldvalue%>&secondfield=<%=secondfieldvalue%>&FromDate=<%= fromdate %>&ToDate=<%= todate %>">
                        <bean:write name="modify" property="district"/></a></td>
                        <td align="center" bgcolor="white">
                        <a href="selectdistrictforeducation.do?nexxt=start&back=start&getdistrictPersonalReport=getdistrictPersonalReport&districtid=<bean:write name="modify" property="districtid"/>&FieldValue=<%=fieldvalue%>&SecondFieldValue=<%=secondfieldvalue%>&FromDate=<%= fromdate %>&ToDate=<%= todate %>&distcount=<bean:write name="modify" property="districtcount"/>"> 
                        <bean:write name="modify" property="districtcount"/></a></td>
