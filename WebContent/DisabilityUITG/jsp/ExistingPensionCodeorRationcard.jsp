<%-- 
    Document   : ExistingPensionCodeorRationcard
    Created on : Aug 3, 2012, 11:15:40 AM
    Author     : 490058
--%>
     ...
     function selectflow(val){
         ...
         if(val!=null && val==1){
            ...
            // document.getElementById("selectFlow").value='rati';
             document.forms[0].action="existingRationcardorNot.do?PartArestrict=true";
             document.forms[0].submit();
...
<br><br>
 ...
 <table  align="center" cellspacing="1" cellpadding="8" class="innerTable">
    ...
    <tr><td colspan="2" align="center" class="heading">Select Non-Pensioners/Pensioners</td></tr>
