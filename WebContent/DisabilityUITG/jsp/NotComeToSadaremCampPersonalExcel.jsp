    ...
    <body>
        <logic:present name="notComeToCampList" scope="request">
            <table  align="center" cellspacing="1" border="0" cellpadding="4" class="innerTable" width="90%">
                <tr><td class="formhdbg" align="center" colspan="16" bgcolor="blue"><b><font color="white">District: <%=districtName%>, Phase: <%=phaseName%>, Who are Not Come to SADAREM Camp Report</font></b></td></tr>
                            <tr>
                                ...
                                <td class="formhdbg" align="center" bgcolor="gray"><font color="white">First Name</font></td>
                                <td class="formhdbg" align="center" bgcolor="gray"><font color="white">Middle Name</font></td>
                                <td align="center" class="formhdbg" bgcolor="gray"><font color="white">Last Name</font></td>
                                <td align="center" class="formhdbg" bgcolor="gray"><font color="white">Retalation Name</font></td>
                                ...
                                <td class="formhdbg" align="center" bgcolor="gray"><font color="white">Disability</font></td>
                            ...
                            <logic:iterate id="modify" name="notComeToCampList" scope="request">
                                ...
                                <tr>
                                    ...
                                    <td class="formbg" align="left"><bean:write name="modify" property="firstName"/></td>
                                    <td class="formbg" align="left"><bean:write name="modify" property="middleName"/></td>
                                    <td  class="formbg" align="left"><bean:write name="modify" property="lastName"/></td>
                                    ...
                                    <td class="formbg" align="left"><bean:write name="modify" property="houseno"/></td>
