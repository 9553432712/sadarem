<%-- 
    Document   : districtWiseStatusReportForPartB
    Created on : May 30, 2010, 2:20:12 PM
    Author     : srinivas_p
--%>
...
<BODY>
 <html:form action="districtstatusreportforPartB.do?distWisestatusreportforPartB=distWisestatusreportforPartB"
