        ...
        <script>
            ...
            function getIsseRaiseDetails() {
                ...
                if(document.forms[0].elements['sadaremId'].value=="") {
                    ...
                    return false;
                }if(document.forms[0].elements['newName'].value=="") {
                    alert("Please Enter To be Modified Name!");
                    document.forms[0].elements['newName'].focus();
                    return false;
                }
            ...
            function getNameChanges(){
                if(document.forms[0].elements["sadaremId"].value.length <17) {
                    ...
                    document.forms[0].mode.value="nameChangesDetails";
                    document.forms[0].submit();
                }
            ...
            function onlystring(event,thisval)
            {
                if(space(event,thisval)){
                    ...
                    var charCode = e.which || e.keyCode;
                    if (charCode > 31 && ((charCode > 64&&charCode < 91)||(charCode>96&&charCode<123)||charCode==32||charCode==151 || charCode==32)){
                        return true;
                    }
                    return false;
                }
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" align="left" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:text property="sadaremId" styleId="saId10" maxlength="17" onkeypress="return onlyNumbers();" onchange="getNameChanges();" style="width=180px"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    To be Modified Name:<font color="red"><b>*</b></font>
                                </td>
                                <td>
                                    <html:text property="newName" maxlength="50" onkeydown="return isAlpha(event.keyCode,newName);" onchange="return allString(this),capitalizeMe(this);"
                                               style="width=180px"/>
                                </td>
                            </tr>
                            <tr>
                                <td> CampIncharge Mobile :<font color="red"><b>* </b></font></td>
                                <td><html:text property="mobile" maxlength="10" onkeypress="return onlyNumbersForMobile(window.event);" onkeyup="zeroFunction('mobile');"  onchange="allnumeric(this),validMobileNo();" style="width=180px"/>
                                </td>
                            </tr>
