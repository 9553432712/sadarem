        ...
        <script>
            ...
            function getIssueRaiseDetails() {
                ...
                if(document.forms[0].elements['sadaremId'].value=="") {
                    ...
                    return false;
                } if(document.forms[0].elements['newRelationName'].value=="") {
                    alert("Please Enter To be Modified Relation Name!");
                    document.forms[0].elements['newRelationName'].focus();
                    return false;
                }
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="1" align="left" width="100%" border="0" >
                            ...
                            <tr >
                                ...
                                <td>
                                    <html:text property="sadaremId" maxlength="17" onkeypress="return onlyNumbers();" onchange="getRelationNameChanges();" style="width:180px"/>
                                </td></tr>
                            <tr> <td>Relation Name : <font color="red"><b>*</b></font></td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    To be Modified Relation Name: <font color="red"><b>*</b></font>
                                </td>
                                <td>
                                    <html:text property="newRelationName" maxlength="50" onkeypress="return onlystring(event,this)" onchange="return allString(this),capitalizeMe(this);" style="width:180px"/>
