    ...
    <head>
        ...
        <script>
            ...
            function getIsseRaiseDetails() {
                ...
                document.forms[0].action="./issueRaiseApproval.do?mode=insertIssueRaise&flag=4";
            ...
            function getRelationNameChanges(){
                if(document.forms[0].elements['categoryFormId'].value=="11"){
                    document.getElementById('nameChangeSadaremID1').style.display="none";
                }
    ...
    <body>
        <html:form action="/issueRaiseApproval" enctype="multipart/form-data">
            ...
            <table cellpadding="0" cellspacing="1" align="center" width="90%" border="0" class="inputform">
                ...
                <tr>
                    <td>
                        <table cellpadding="0" cellspacing="0" align="left" width="90%" border="0" >
                            <tr>
                            ...
                            <tr>
                                ...
                                <td  id="sadaremId1">
                                    <html:text property="sadaremId" maxlength="17" onkeypress="return onlyNumbers();" onchange="validSADAREMID();" styleId="saId1" style="width:180px"/>
                                </td>
                            </tr>
                            <tr>
