...
<body>
    <form action="MentalRetardationForwdActionPrint.do" >
        <p>SADAREM ID : <%=session.getAttribute("personcode")%></p>
        <table  align="center" cellspacing="1" cellpadding="8" class="inputform" width="90%">
            <tr>
                <th class="heading"><center>PSYCHOLOGICAL ASSESSMENT</center></th>
            </tr>
        </table>
        ...
        <table  align="center" cellspacing="1" cellpadding="8" border="1" class="inputform" width="90%">
            <tr>
