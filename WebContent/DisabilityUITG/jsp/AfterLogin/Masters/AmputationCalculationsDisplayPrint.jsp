        ...
        <form>
            <logic:notEmpty name="amputationBean" scope="request" >
                ...
                <table width="100%" border="0" align="center"  >
                    ...
                    <tr align="left">
                        <th align="center"><font size="4">3.&nbsp;&nbsp;AMPUTATION</font></th>
                    </tr>
                </table>
                <logic:equal scope="request" property="upperExtrmHeading" value="true" name="amputationBean">
                    <table width="100%" border="0" align="center"  >
                        <tr align="left">
                            <th align="left"><font size="3">3.1 &nbsp;&nbsp;UPPER EXTREMITY AMPUTATION</font></th>
                        </tr>
                    </table>
                ...
                <logic:equal scope="request" property="lowerExtrmHeading" value="true" name="amputationBean">
                    <table width="100%" border="0" align="center"  >
                        <tr align="left">
                            <th align="left"><font size="3">3.2&nbsp;&nbsp; LOWER EXTREMITY AMPUTAION </font></th>
                        </tr>
                    </table>
                ...
                <logic:equal scope="request" property="complicationsHeading" value="true" name="amputationBean">
                    <table width="100%" border="0" align="center"  >
                        <tr align="left">
                            <th align="left"><font size="3">3.3&nbsp;&nbsp;COMPLICATIONS </font></th>
                        </tr>
                    </table>
                    <table width="100%"  border="0" align="center">
