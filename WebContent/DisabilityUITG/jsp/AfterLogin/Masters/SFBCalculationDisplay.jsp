    ...
    <body>
        ...
        <form>
            ...
            <logic:present name="sFBBean" scope="request">
               <tr>
                   <th  align="center" colspan="4" class="heading">5.&nbsp;&nbsp;Seguin Form Board(S.F.B)</th>
                    </tr>
                    <tr><td   colspan="4" style="text-align: center" class="label">ID No:&nbsp;<font color="blue"><%=personcode%></font></td></tr>
                    <tr><td  colspan="4"  style="text-align: center" class="label">Name:&nbsp;<font color="blue"><%=name%></font></td></tr>
