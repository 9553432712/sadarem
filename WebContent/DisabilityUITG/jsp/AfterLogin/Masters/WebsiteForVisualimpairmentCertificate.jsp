<%--
    Document   : WebsiteForVisualimpairmentCertificate
    Created on : Nov 24, 2010, 9:49:10 AM
    Author     : 509865
--%>
                                                    ...
                                                    <td  align="left" class="label" style="line-height:20px;">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <font color="blue"><bean:write name="reportprint"  property="visualImpairmentPhysicalRequirementList" /></font>
                                                                <%}%>
                                                            <li>
