<%--
    Document   : WebsiteForPhysicallimpairmentCertificate
    Created on : Nov 24, 2010, 9:42:47 AM
    Author     : 509865
--%>
                                                    ...
                                                    <td  align="left" class="label" style="line-height:20px;">
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <bean:write name="reportprint"  property="maritialstatus"/>
                                                                <font color="blue">
                                                                    <bean:write name="reportprint"  property="name"/>
                                                                </font>,
                                                                <bean:write name="reportprint"  property="relationship"/>
                                                                <font color="blue">
                                                                    <bean:write name="reportprint"  property="relationname"/>
                                                                </font>, <font color="blue">
                                                                    <bean:write name="reportprint"  property="gender"/>
                                                                </font>, age <font color="blue">
                                                                    <bean:write name="reportprint"  property="age"/>
                                                                </font> years,
                                                                <logic:notEmpty name="reportprint" property="housenumber"> resident of H.No.# <font color="blue">
                                                                        <bean:write name="reportprint"  property="housenumber"/>
                                                                    </font>, </logic:notEmpty>
                                                                    <font color="blue">
                                                                    <bean:write name="reportprint"  property="habitation_name"/>
                                                                </font> Habitation, <font color="blue">
                                                                    <bean:write name="reportprint"  property="village_name"/>
                                                                </font> Village, <font color="blue">
                                                                    <bean:write name="reportprint"  property="mandal_name"/>
                                                                </font>Mandal, <font color="blue">
                                                                    <bean:write name="reportprint"  property="district_name"/>
                                                                </font> District, is suffering from
                                                                <bean:write name="reportprint"  property="validity"/>
                                                                disability of the following category:- <br />
                                                                <font color="blue">
                                                                    <bean:write name="reportprint" property="disabilitytype"/>
                                                                </font>.
                                                                <logic:notEmpty name="reportprint" property="totalsubdisabilities"> <br />
                                                                    The disability is in relation to
                                                                    <bean:write name="reportprint"  property="genderInitial2"/>
                                                                    : <font color="blue">
                                                                        <bean:write name="reportprint"  property="totalsubsubdisabilities" />
                                                                    </font> <font color="blue">
                                                                        <bean:write name="reportprint"  property="totallocomotorarmlegeffectedlist" />
                                                                    </font> <br />
                                                                    <logic:notEmpty name="reportprint" property="totalsubdisabilities"> Sub-type of disability :<font color="blue">
                                                                            <bean:write name="reportprint"  property="totalsubdisabilities" />
                                                                        </font> </logic:notEmpty>
                                                                </logic:notEmpty>
                                                                <%if ("true".equals(causeOfDisabilityFlag)) {%>
                                                                <br />
                                                                <br />
                                                                Cause of Disability : <font color="blue" >
                                                                    <bean:write name="reportprint"  property="totalcauseofdisabilities" />
                                                                </font>
                                                                <%}%>
                                                                <logic:notEmpty name="reportprint" property="disabilityreason"> <br />
                                                                    <font color="blue" >
                                                                        <bean:write name="reportprint"  property="disabilityreason" />
                                                                        .</font> </logic:notEmpty>
                                                                </li>
                                                                <li>
                                    	Re-assessment of this case is <font color="blue">
                                                                    <bean:write name="reportprint"  property="kindofdisability"/>
                                                                    &nbsp;
                                                                    <bean:write name="reportprint"  property="period"/>
                                                                </font>                                    </li>
                                                            <li>
                                    	 Percentage of disability in
                                                                <bean:write name="reportprint"  property="genderInitial2"/>
                                                                case is &nbsp;<font color="blue">
                                                                    <bean:write name="reportprint" property="disabilityPercentage"/>
                                                                </font>%&nbsp;[
                                                            ...
                                                            <li>
                                                                ...
                                                                <bean:write name="reportprint"  property="genderInitial2"/>
                                                                duties. <font color="blue">
                                                                    <bean:write name="reportprint"  property="physicalImpairmentPhysicalRequirementList" />
                                                                </font>
                                                                <%}%>
                                                            </li>
                                                            <li>
