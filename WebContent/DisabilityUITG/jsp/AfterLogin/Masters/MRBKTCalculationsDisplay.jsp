...
<html:html>
    ...
    <logic:notEmpty  name="bKTBean" scope="request">
     <table  align="center" cellspacing="1" cellpadding="8" class="inputform" width="90%">
          <tr align="center">
            <th  class="heading">BKT Detailed Test Calculations
            </th>
          </tr>
         <tr><td colspan="3"  style="text-align: center"><b>ID No.&nbsp;<font color="blue"><%=personcode%></font></b></td></tr>
         <tr><td colspan="3"  style="text-align: center"><b>Name.&nbsp;<font color="blue"><%=name%></font></b></td></tr>
