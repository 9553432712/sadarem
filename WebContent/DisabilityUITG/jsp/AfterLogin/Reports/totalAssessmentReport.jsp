...
<title>:: SADAREM :: R1.0 Report</title>
    	...
    	$("#districtwiseformSubmitbut").click(function( event )
    			{
    				...
    				if($("#fromdate1").val()=="")
    					...
    					else
    					{
    						...
    						document.districtwiseform.action="<%=request.getContextPath()%>/newtotalassessmentreport.do?randomid="+Math.random();
...
<body>
       	...
       	<div class="col-sm-1" style="text-align:center;">
    		...
    		<div class="panel-group" id="accordion">
				    ...
				    <div class="panel  panel-primary  " id="districtwiseform">
				        <div class="panel-heading collapsed" data-toggle="collapse" data-target="#collapseTwo" href="#collapseTwo" class="collapsed" style="cursor: pointer;">
				             <h4 class="panel-title" align="center">
				          			R1.0 : Total Assessment Report District Wise
				      		</h4>
				        </div>
 ...
 <%-- <%=districtheadingmsg%> --%>
<a href="<%=request.getContextPath()%>/newtotalassessmentreport.xls?mode=excelNew&fromdate1=<%=fromdate1%>&todate=<%=todate1%> ">
<img height="30" width="30" src="<%=request.getContextPath()%>/images/excel.jpg" border="0" align="right" title="Export Excel"/>
 ...
 else if(!(fromdate1.length()>0) && !(todate1.length()>0))
     {	
     %>
