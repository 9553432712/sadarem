...
<html:html>
    ...
    <BODY >
        ...
        <form action="MentalCertificate.do">
            ...
            <table border="2" class="inputform" bgcolor="green" width="90%">
                                        ...
                                        <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="90%">
                                            ...
                                            <tr valign="top" class="tbl_bg2_content">
                                                <td width="45%" colspan="2">
                                                    <font size="3">
                                                        <div align="left"><b>I.D.No:&nbsp;</b>  <font color="blue"><bean:write name="reportprint"  property="personcode"/></font></div></font>
                                                </td>
                                                <td  width="45%">
                                                    <font size="3">
...
<%--                                                 <img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reportprint"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"> --%>
                                                ...
                                                <img align="right" src="<%=request.getContextPath()%>/dispimg.do?action=showsadaremimg&sadaremid=<bean:write name="reportprint"  property="personcode"/>&distName=<%=districtname%>&randiomid=<%=Math.random()%>"  width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"/>
                                                
                                                    <p align="justify"><div align="justify"><font size ="4" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that Shri/Smt/Kum:</font> <font color="blue" size="4"><bean:write name="reportprint"  property="name"/></font>, <bean:write name="reportprint"  property="relationship"/><font color="blue" size="4"> <bean:write name="reportprint"  property="relationname"/></font>,&nbsp;<font color="blue" size="4"><bean:write name="reportprint"  property="gender"/></font> aged <font color="blue" size="4"><bean:write name="reportprint"  property="age"/></font> years,
                                                        ...
                                                        <logic:equal name="reportprint" property="disabilitytype" value="Physically(Locomotor/orthopaedically) Disabled">
                                                            ...
                                                            <logic:notEmpty name="reportprint"  property="hand_stgrip_left">
                                        ...
                                        <center>
                                            ...
                                            <a href="CertificateWithPersoncode.do?print=certificateprint&flag=false&personcode=<bean:write name="reportprint"  property="personcode"/>" target="_blank">
...
<%if ("0".equals(apflag)) {%>
                                    ...
                                    <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="90%">
                                        ...
                                        <tr valign="top" class="tbl_bg2_content">
                                            <td colspan="3"><img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reportprint"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"><br><br>
