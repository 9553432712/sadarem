...
<title>:: SADAREM :: R5.3 Report</title>
    	...
    	$("#districtwiseformSubmitbut").click(function( event )
    			{
    				...
    				if($("#fromdate1").val()=="")
    					...
    					else
    					{
    						...
    						document.districtwiseform.action="<%=request.getContextPath()%>/newExpiredSadaremCertificates.do?randomid="+Math.random();
...
<body>
				    ...
				    <div class="panel  panel-primary" id="districtwiseform">
				        <div class="panel-heading" data-toggle="collapse" data-target="#collapseTwo" href="#collapseTwo" class="collapsed" style="cursor: pointer;text-align:center;">
				             <h4 class="panel-title">
				          			<b>R5.3: Expired SADAREM Certificates</b>
				      		</h4>
				        </div>
 ...
 { %>
 <div <%if(fromdate1.length()==10 && todate1.length()==10 && !district1.equals("-1") && !mandal1.equals("-1") ){ %>style="width:95%;margin:0px auto; "<%}else{ %> style="width:65%;margin:0px auto;" <% }%>>

 <div style=" text-align: center;margin-left: auto;margin-right: auto; ">
 <%=heading%>
 <a href="<%=request.getContextPath()%>/newExpiredSadaremCertificates.xls?mode=excelNew&fromdate=<%=fromdate1%>&todate=<%=todate1%>&district=<%=district1%>&mandal=<%=mandal1%>&heading=<%=heading%>&areatype=<%=areatype1%>&TRIGPSel=<%=TRIGPSel %> ">
<img height="30" width="30" src="<%=request.getContextPath()%>/images/excel.jpg" border="0" align="right" title="Export Excel"/>
 ...
 <%  if(fromdate1.length()==10 && todate1.length()==10 && !district1.equals("-1") && !mandal1.equals("-1")  ) 
	 {%>
	 <thead>
      <tr>
	...
	<%
        ...
        <td  rowspan="2" style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Total Temporary <br> certificates</td>
        <td  colspan="2" style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Total</td>
   ...
   <tr>
      <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Expired</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Yet to be Expired</td>
    ...
    <%
       ...
       if(fromdate1.length()==10 && todate1.length()==10 && !district1.equals("-1") && !mandal1.equals("-1")   ) 
	 {
	       ...
	       <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=loopCount+1 %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(0) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;padding-left:2px;"><%=innerList.get(1) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(2) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(3) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(4)%></td>        
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(5) %><%=innerList.get(6) %></td>    	  
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(7) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(8) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(9) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(10) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(11) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(12) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(13) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(14) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(15) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(16) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(17) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(18) %></td>
    	         <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(19) %></td>    	           
    	          <td class="<%=style%>" style="background:#ADD8E6;border:#337ab7 1px solid;"><%=innerList.get(20) %></td>
