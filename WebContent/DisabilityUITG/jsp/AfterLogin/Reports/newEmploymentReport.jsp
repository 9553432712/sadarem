...
<title>:: SADAREM :: R3.5 Report</title>
...
String employment=CommonUtility.checkNullObj(request.getAttribute("employment"));
    	...
    	$("#districtwiseformSubmitbut").click(function( event )
    			{
    				...
    				if($("#fromdate1").val()=="")
    					...
    					else if($("#employment").val()!="-1" && $("#areatype1").val()=="-1")
    					{
    					...
    					else if($("#employment").val()!="-1" && $("#district1").val()=="-1")
    						{
    					...
    					else if($("#employment").val()!="-1" && $("#mandal").val()=="-1")
						{
    					...
    					else
    					{
    						...
    						document.districtwiseform.action="<%=request.getContextPath()%>/newEmploymentReport.do?randomid="+Math.random();
...
<body>
				    ...
				    <div class="panel  panel-primary" id="districtwiseform">
				        <div class="panel-heading" data-toggle="collapse" data-target="#collapseTwo" href="#collapseTwo" class="collapsed" style="cursor: pointer;text-align:center;">
				             <h4 class="panel-title">
				          			<b>R3.5: PWD's Employment wise - Details</b>
				      		</h4>
				        </div>
				            ...
				            <div class="panel-body">
				            		<form class="form-inline" role="form" id="districtwiseform" name="districtwiseform" method="post">
					            		<input type="hidden" id="mode" name="mode" value="getData">
										  ...
										  <div class="input-group" id="employmentdiv" name="employmentdiv" style="display:none;">											    
										   <div class="input-group-addon" style="background-color: #eee; color:#000; font-weight:bold;">Employment</div>
										    <span id="educationSPANID"><%=ComboUtil.createStrComboBoxAuto("employment",employmentList,"","form-control mycomboStyle","",true,false,"")%></span>
										  </div>
 ...
 <%=heading%>
 <a href="<%=request.getContextPath()%>/newEmploymentReport.xls?mode=excelNew&fromdate=<%=fromdate1%>&todate=<%=todate1%>&district=<%=district1%>&mandal=<%=mandal1%>&employment=<%=employment%>&heading=<%=heading%>&areatype=<%=areatype1%>&TRIGPSel=<%=TRIGPSel %> ">
<img height="30" width="30" src="<%=request.getContextPath()%>/images/excel.jpg" border="0" align="right" title="Export Excel"/>
 ...
 <%  if(fromdate1.length()==10 && todate1.length()==10  && !employment.equals("-1") ) 
	 {%>
	 <thead>
      <tr>
       <td   style="background-color:#337ab7;padding:5px;color:#fff;" align="center">S.No.</td>
        ...
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Employment</td>
	...
	<%
        ...
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Govt</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Private</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Self-Employed</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Un-employed</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Wage-employed</td>
