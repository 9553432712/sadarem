<%--
    Document   : PersoncodeForGraph
    Created on : Dec 27, 2011, 4:08:15 PM
    Author     : 490058
--%>
...
<script type="text/javascript">
               /*   {
                     var number = document.forms[0].pensioncode.value;
...
var re250 = document.forms[0].rightear250.value;
var re500 = parseInt(document.forms[0].rightear500.value);
var re1000=parseInt(document.forms[0].rightear1000.value);
var re2000=parseInt(document.forms[0].rightear2000.value);
var re4000=parseInt(document.forms[0].rightear4000.value);
var re8000=parseInt(document.forms[0].rightear8000.value);
        ...
        if(isNaN(re500) && isNaN(re1000) && isNaN(re2000)){
            ;
        }else{
...
var le250=parseInt(document.forms[0].leftear250.value);
var le500=parseInt(document.forms[0].leftear500.value);
var le1000=parseInt(document.forms[0].leftear1000.value);
var le2000=parseInt(document.forms[0].leftear2000.value);
var le4000=parseInt(document.forms[0].leftear4000.value);
var le8000=parseInt(document.forms[0].leftear8000.value);
        ...
        MyGraph.xscale=1000;
        MyGraph.yscale=10;
        //  document.getElementById("graphdiv").style.display='visible';
        // document.getElementById("graphdiv").style.visibility='visible';

        if(isNaN(le500) && isNaN(le1000) && isNaN(le2000)){
            ;
        }else{
            document.getElementById("graphdiv").style.visibility='visible';
...
<body onload="Calculate(),Calculateleft()">
    ...
    <br>
    <html:form action="HearingGraph.do"  styleId="hearingactionform"  method="post" onsubmit="return validate_form(this)" focus="pensioncode">
        ...
        %><%
                    ...
                    String rightear250 = null;
                    String rightear500 = null;
                    String rightear1000 = null;
                    String rightear2000 = null;
                    String rightear4000 = null;
                    String rightear8000 = null;

                    String leftear250 = null;
                    String leftear500 = null;
                    String leftear1000 = null;
                    String leftear2000 = null;
                    String leftear4000 = null;
                    String leftear8000 = null;
                    String p = null;
                    String speechaudiometryrightear_pta = null;
                    String speechaudiometryleftear_pta = null;
                    String lingualTeluguName = "&#3114;&#3143;&#3120;&#3137;&#9;&#9;&#9;&#9;&#9;&#9";
                    String personcode = null;
                    String telugupersonname = null;
                    h = (HearingImpairmentDto) request.getAttribute("data");
                    if (h != null) {
                        rightear250 = h.getRightear250();
                        rightear500 = h.getRightear500();
                        rightear1000 = h.getRightear1000();
                        rightear2000 = h.getRightear2000();
                        rightear4000 = h.getRightear4000();
                        rightear8000 = h.getRightear8000();

                        leftear250 = h.getLeftear250();
                        leftear500 = h.getLeftear500();
                        leftear1000 = h.getLeftear1000();
                        leftear2000 = h.getLeftear2000();
                        leftear4000 = h.getLeftear4000();
                        leftear8000 = h.getLeftear8000();
                        p = h.getPersoncode();
                        speechaudiometryrightear_pta = h.getSpeechaudiometryrightear_pta();
                        speechaudiometryleftear_pta = h.getSpeechaudiometryleftear_pta();
                        lingualTeluguName = "&#3114;&#3143;&#3120;&#3137;&#9;&#9;&#9;&#9;&#9;&#9";
                        personcode = h.getPersoncode();
                        telugupersonname = h.getTeluguname();
                    }
        %>
        ...
        <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="50%">
            <tr><th colspan="2">Enter Existing SADAREM ID</td></tr>
        </table>
        <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="50%">
            <tr>
                <td  align="center">SADAREM ID :</td>
                <td>
                    <html:text property="pensioncode" onkeypress="return isNumberKey(event)" maxlength="17" size="17" />
                </td>
            </tr>
            ...
            <table>
              ...
              <td><html:hidden value="<%=rightear250%>" property="rightear250" /></td>
                <td><html:hidden  property="rightear250" /></td>
                <td><html:hidden  property="rightear500"  /></td>
                <td><html:hidden  property="rightear1000" /></td>
                <td><html:hidden  property="rightear2000" /></td>
                <td><html:hidden  property="rightear4000" /></td>
                <td><html:hidden  property="rightear8000" /></td>
                <td><html:hidden  property="leftear250"/></td>
                <td><html:hidden  property="leftear500"  /></td>
                <td><html:hidden  property="leftear1000" /></td>
                <td><html:hidden  property="leftear2000" /></td>
                <td><html:hidden  property="leftear4000" /></td>
                <td><html:hidden  property="leftear8000" /></td>
                </tr>
            </table>
        <!--   <div id="graphdiv" align="center" style="visibility:hidden" class="graph" class="button"></div>-->

        <br><br><br>

        <div id="graphdiv" align="center"  style="visibility:hidden" class="graph"></div>
        ...
        <br><br>
        <table  border="1" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="20%">
            <tr class="tbl_bg2_content" >

                <td align="right">
                    <font color="red" size="6"><b>.</b></font><font color="red"><b>_____ Right Ear</b></font><br><font color="blue"><b>o ------ Left Ear</b></font></td>
            </tr></table>
        ...
        <table  border="1" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="70%">
            <tr class="tbl_bg2_content_hdr">
                <td colspan="2" align="center"><font size="4"><b>Speech Discrimination</b></font></td></tr>
        ...
        <br><br><br>
        <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="70%" id="bapi">
            <tr class="tbl_bg2_content" >
