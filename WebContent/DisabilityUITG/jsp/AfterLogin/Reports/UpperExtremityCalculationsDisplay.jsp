    ...
    <body><br>
        <form>
            ...
            <logic:notEmpty name="upperExtremityBean" scope="request">
                ...
                <table  align="center" cellspacing="0" cellpadding="0" class="table" width="85%">
                    <tr>
                ...
                <table  align="center" cellspacing="0" cellpadding="0" border="1" class="table" width="85%">
                    ...
                    <table  align="center" cellspacing="1" cellpadding="5" border="1" class="innerTable1" width="85%">
                        ...
                        <tr>
                            ...
                            <td class="label">&nbsp;
                                <%  if (ms_sf_right_per != 0.0) {
                                         out.println(ms_sf_right_per);
                                     }%>
                                <br><BR>   <%  if (ms_se_right_per != 0.0) {
                                         out.println(ms_se_right_per);
                                     }%>
                                <br><BR>  <%  if (ms_sab_right_per != 0.0) {
                                         out.println(ms_sab_right_per);
                                     }%>
                                <br><BR> <%  if (ms_sad_right_per != 0.0) {
                                         out.println(ms_sad_right_per);
                                     }%>
                                <br><BR> <%  if (ms_sext_right_per != 0.0) {
                                         out.println(ms_sext_right_per);
                                     }%>
                                <br><BR>  <%  if (ms_sint_right_per != 0.0) {
                                         out.println(ms_sint_right_per);
                                     }%>

                            </td>

                            <td class="label">&nbsp;
                                <%  if (ms_sf_left_per != 0.0) {
                                         out.println(ms_sf_left_per);
                                     }%>
                                <br><BR>   <%  if (ms_se_left_per != 0.0) {
                                         out.println(ms_se_left_per);
                                     }%>
                                <br><BR>  <%  if (ms_sab_left_per != 0.0) {
                                         out.println(ms_sab_left_per);
                                     }%>
                                <br><BR> <%  if (ms_sad_left_per != 0.0) {
                                         out.println(ms_sad_left_per);
                                     }%>
                                <br><BR> <%  if (ms_sext_left_per != 0.0) {
                                         out.println(ms_sext_left_per);
                                     }%>
                                <br><BR>  <%  if (ms_sint_left_per != 0.0) {
                                         out.println(ms_sint_left_per);
                                     }%>
                            </td>
                            <td class="label">&nbsp;
                        ...
                        <tr>
                            ...
                            <td class="label">&nbsp;
                                <%  if (ms_ef_right_per != 0.0) {
                                         out.println(ms_ef_right_per);
                                     }%>
                                <br><BR>   <%  if (ms_ee_right_per != 0.0) {
                                         out.println(ms_ee_right_per);
                                     }%>
                                <br><BR>  <%  if (ms_ep_right_per != 0.0) {
                                         out.println(ms_ep_right_per);
                                     }%>
                                <br><BR> <%  if (ms_es_right_per != 0.0) {
                                         out.println(ms_es_right_per);
                                     }%>
                            ...
                            <td class="label">&nbsp;
                                <%  if (ms_ef_left_per != 0.0) {
                                         out.println(ms_ef_left_per);
                                     }%>
                                <br><BR>   <%  if (ms_ee_left_per != 0.0) {
                                         out.println(ms_ee_left_per);
                                     }%>
                                <br><BR>  <%  if (ms_ep_left_per != 0.0) {
                                         out.println(ms_ep_left_per);
                                     }%>
                                <br><BR> <%  if (ms_es_left_per != 0.0) {
                                         out.println(ms_es_left_per);
                                     }%>
                        ...
                        <tr class="labelBlue">
                            ...
                            <td class="label">&nbsp;
                                <%  if (ms_wd_right_per != 0.0) {
                                         out.println(ms_wd_right_per);
                                     }%>
                                <br><BR>   <%  if (ms_wp_right_per != 0.0) {
                                         out.println(ms_wp_right_per);
                                     }%>
                                <br><BR>  <%  if (ms_wr_right_per != 0.0) {
                                         out.println(ms_wr_right_per);
                                     }%>
                                <br><BR> <%  if (ms_wu_right_per != 0.0) {
                                         out.println(ms_wu_right_per);
                                     }%>
                            ...
                            <td class="label">&nbsp;
                                <%  if (ms_wd_left_per != 0.0) {
                                         out.println(ms_wd_left_per);
                                     }%>
                                <br><BR>   <%  if (ms_wp_left_per != 0.0) {
                                         out.println(ms_wp_left_per);
                                     }%>
                                <br><BR>  <%  if (ms_wr_left_per != 0.0) {
                                         out.println(ms_wr_left_per);
                                     }%>
                                <br><BR> <%  if (ms_wu_left_per != 0.0) {
                                         out.println(ms_wu_left_per);
                                     }%>
                ...
                <table  align="center" cellspacing="1" cellpadding="5" border="1" class="innerTable1" width="85%">
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (index != 0) {
                                 out.println(index);
                             }%></td>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (ring != 0) {
                                 out.println(ring);
                             }%></td>
                    </tr>
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (little != 0) {
                                 out.println(little);
                             }%></td>
                    </tr>
                    <%}%>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (keyholding != 0) {
                                 out.println(keyholding);
                             }%></td>
                    </tr>
                    <%}%>
                    <% if (cylinder != 0) {%>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (cysmall != 0) {
                                 out.println(cysmall);
                             }%></td>
                    </tr>
                    <%}%>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (cylarge != 0) {
                                 out.println(cylarge);
                             }%></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (spsmall != 0) {
                                 out.println(spsmall);
                             }%></td>
                    </tr>
                    <%}%>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"><% if (Hand_hook_left != 0) {%><bean:write name="upperExtremityBean" property="hand_hook_left" /><% }%></td>
                            <td align ="center" class="label"> <% if (hook != 0) {
                                 out.println(hook);
                             }%></td>
                    </tr>
                    <%}
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (senthumb != 0) {
                                 out.println(senthumb);
                             }%></td>
                    </tr>
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (senindex != 0) {
                                 out.println(senindex);
                             }%></td>
                    </tr>
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (senmiddle != 0) {
                                 out.println(senmiddle);
                             }%></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (senring != 0) {
                                 out.println(senring);
                             }%></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (senlittle != 0) {
                                 out.println(senlittle);
                             }%></td>
                    </tr>
                    <% }%>
                    <% if (strength != 0) {%>
                    ...
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (strgrip != 0) {
                                 out.println(strgrip);
                             }%></td>
                    </tr>
                    <tr>
                        ...
                        <td align ="center" class="label"> <% if (strpinch != 0) {
                                 out.println(strpinch);
                             }%></td>
                    </tr>
                    <% }%>
                </table>
