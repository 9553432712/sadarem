...
<title>:: SADAREM :: R3.1 Report</title>
...
String education=CommonUtility.checkNullObj(request.getAttribute("education"));
    	...
    	$("#districtwiseformSubmitbut").click(function( event )
    			{
    				...
    				if($("#fromdate1").val()=="")
    					...
    					else if($("#education").val()!="-1" && $("#areatype1").val()=="-1")
    					{
	    						alert("Please select Area Type when you selected Education Type");
	    							$("#areatype1").focus();
    					...
    					else if($("#education").val()!="-1" && $("#district1").val()=="-1")
    						{
    						alert("Please select District when you selected Education Type");
							$("#district1").focus();
    					...
    					else if($("#education").val()!="-1" && $("#mandal").val()=="-1")
						{
						alert("Please select Mandal when you selected Education Type");
						$("#mandal").focus();
    					...
    					else
    					{
    						...
    						document.districtwiseform.action="<%=request.getContextPath()%>/newEducationWiseDetails.do?randomid="+Math.random();
...
<body>
				    ...
				    <div class="panel  panel-primary" id="districtwiseform">
				        <div class="panel-heading" data-toggle="collapse" data-target="#collapseTwo" href="#collapseTwo" class="collapsed" style="cursor: pointer;text-align:center;">
				             <h4 class="panel-title">
				          			<b>R3.1: PWD's Educational wise - Details</b>
				      		</h4>
				        </div>
				            ...
				            <div class="panel-body">
				            		<form class="form-inline" role="form" id="districtwiseform" name="districtwiseform" method="post">
					            		<input type="hidden" id="mode" name="mode" value="getData">
										  ...
										  <div class="input-group" id="educationdiv" name="educationdiv" style="display:none;">											    
										   <div class="input-group-addon" style="background-color: #eee; color:#000; font-weight:bold;">Education</div>
 ...
 <%=heading%>
 <a href="<%=request.getContextPath()%>/newEducationWiseDetails.xls?mode=excelNew&fromdate=<%=fromdate1%>&todate=<%=todate1%>&district=<%=district1%>&mandal=<%=mandal1%>&education=<%=education%>&heading=<%=heading%>&areatype=<%=areatype1%>&TRIGPSel=<%=TRIGPSel %> ">
<img height="30" width="30" src="<%=request.getContextPath()%>/images/excel.jpg" border="0" align="right" title="Export Excel"/>
 ...
 <%  if(fromdate1.length()==10 && todate1.length()==10  && !education.equals("-1") ) 
	 {%>
	 <thead>
      <tr>
	...
	<%
        ...
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Illiterate</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Below 10th</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">10th class</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Intermediate</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Diploma/ITI</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Graduate</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Post Graduate</td>
        <td  style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Others</td>
        <td style="background-color:#337ab7;padding:5px;color:#fff;" align="center">Total</td>
     ...
     <tr>
        ...
        <td class="<%=style%>" style="border:#337ab7 1px solid;"><%=loopCount+1 %></td>
         ...
         <td class="<%=style%>" style="border:#337ab7 1px solid;text-align:right;"><%=innerList.get(9) %></td>
            <td class="<%=style%>" style="border:#337ab7 1px solid;text-align:right;"><%=innerList.get(1) %></td>
