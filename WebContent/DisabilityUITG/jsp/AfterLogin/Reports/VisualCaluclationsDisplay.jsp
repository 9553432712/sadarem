...
<body>
    <form ><br><br>
        ...
        <logic:present name="visualimpairmentbean" scope="request">
            <table  align="center" cellspacing="0" cellpadding="0" class="table" border="1" width="85%">
                ...
                <tr>
                    <th class="labelBlue"><br>Category</th>
                    <th class="labelBlue"><br>Better Eye</th>
                    <th class="labelBlue"><br>Worse Eye</th>
                    <th class="labelBlue"><br>Percentage</th>
                </tr>
                <br><br>
                ...
                <logic:equal name="visualimpairmentbean"  property="visualimpairment" value="101.0">
                    ...
                    <p><font size="2" color="red">Since Percentage cannot be above 101,The present value is rounded off to 100.<br>
                            Hence,final percentage is 100.</font></p>
