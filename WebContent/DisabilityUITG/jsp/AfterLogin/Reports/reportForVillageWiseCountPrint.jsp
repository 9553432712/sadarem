<%-- 
    Document   : reportForVillageWiseCountPrint
    Created on : May 17, 2010, 8:47:47 PM
    Author     : srinivas_p
--%>
...
<html:html>
    ...
    <body>
        ...
        <p>Village Wise Count Report</p>
            <table  align="center" border="0" cellspacing="1" cellpadding="8" class="inputform" width="60%">
                    <tr>
                  ...
                  <logic:iterate id="disabilityreport" name="arraylist1">
                        ...
                        <tr>
                            ...
                            <td  ><bean:write name="disabilityreport" property="village_name"/></td>
