<%-- 
    Document   : Graphprint.jsp
    Created on : Jan 11, 2012, 4:39:03 PM
    Author     : 490058
--%>
...
<html:html>
    ...
    <script type="text/javascript">
        ...
        function Calculate() {
            ...
            MyGraph.xscale=1000;
            MyGraph.yscale=10;
            // alert("div -----------------"+graphdiv.innerHTML+MyGraph.Plot(MyLine));
    ...
    <body onload="Calculate(),Calculateleft(),window.print()">
        <form name="id">

            <table  border="0" align="center" cellspacing="1" cellpadding="0" class="tbl_bg2" >
                ...
                <tr align="center">
                    ...
                    <td align="center"><html:hidden value="<%=rightear250%>" property="rightear250" /></td>
            ...
            <table  border="1" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="70%">
                <tr>
                    <td colspan="2" align="center"><font size="4"><b>Speech Discrimination<b></font></td></td></tr>
                                   ...
                                   <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="80%" id="bapi">
                                        <tr  >
