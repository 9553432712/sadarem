<%-- 
    Document   : HearingDBGraph
    Created on : Dec 27, 2011, 4:07:06 PM
    Author     : 490058
--%>
...
<%@page import="org.bf.disability.dto.HearingImpairmentDto"%>
...
<html:html>
    ...
    <%
                ...
                HearingImpairmentDto h = new HearingImpairmentDto();
                h = (HearingImpairmentDto) request.getAttribute("data");
                String rightear250 = h.getRightear250();
                String rightear500 = h.getRightear500();
                String rightear1000 = h.getRightear1000();
                String rightear2000 = h.getRightear2000();
                String rightear4000 = h.getRightear4000();
                String rightear8000 = h.getRightear8000();

                String leftear250 = h.getLeftear250();
                String leftear500 = h.getLeftear500();
                String leftear1000 = h.getLeftear1000();
                String leftear2000 = h.getLeftear2000();
                String leftear4000 = h.getLeftear4000();
                String leftear8000 = h.getLeftear8000();
                String p = h.getPersoncode();
 ...
 /* String rightear250=(String)request.getParameter("rightear250");
                String rightear500=(String)request.getParameter("rightear500");

                String rightear1000=(String)request.getParameter("rightear1000");
                String rightear2000=(String)request.getParameter("rightear2000");
                String rightear4000=(String)request.getParameter("rightear4000");
                String rightear8000=(String)request.getParameter("rightear8000");

                String leftear250=(String)request.getParameter("le250");
                String leftear500=(String)request.getParameter("le500");
                String leftear1000=(String)request.getParameter("le1000");
                String leftear2000=(String)request.getParameter("le2000");
                String leftear4000=(String)request.getParameter("le4000");
                String leftear8000=(String)request.getParameter("le8000");

                String speechaudiometryrightear_pta=(String)request.getParameter("sre_pta");

                String speechaudiometryleftear_pta=(String)request.getParameter("sle_pta");*/
                ...
                String personcode = h.getPersoncode();
                String telugupersonname = h.getTeluguname();



                /* if((String)session.getAttribute("personcode")!=null) {
                ...
                if((String)session.getAttribute("teluguname")!=null) {
                telugupersonname = (String)session.getAttribute("teluguname");
                }else {
                telugupersonname = (String)session.getAttribute("teluguNameAu");
                }*/
    ...
    <script type="text/javascript">
        ...
        {//alert("entered----");
            ...
            document.forms[0].action="HearingGraph.do";
    ...
    <script type="text/javascript">
        ...
        function XYGraph() {
            ...
            this.xaxis="A.C PURE TONE AUDIOGRAM";
            this.yaxis="DB Level";
        ...
        XYGraph.prototype.Plot = function (XYLine2) {
    ...
    <script type="text/javascript">
        ...
        function Calculate() {
            ...
            var re500 = parseInt(document.getElementById("rightear500").value);
            var re1000=parseInt(document.getElementById("rightear1000").value);
            var re2000=parseInt(document.getElementById("rightear2000").value);
            var re4000=parseInt(document.getElementById("rightear4000").value);
            var re8000=parseInt(document.getElementById("rightear8000").value);
    ...
    <script type="text/javascript">
        ...
        function Calculateleft() {
            var le250=parseInt(document.getElementById("leftear250").value);
            var le500=parseInt(document.getElementById("leftear500").value);
            var le1000=parseInt(document.getElementById("leftear1000").value);
            var le2000=parseInt(document.getElementById("leftear2000").value);
            var le4000=parseInt(document.getElementById("leftear4000").value);
            var le8000=parseInt(document.getElementById("leftear8000").value);
            //alert("values=============="+le2000+le8000);
            var first=250;
            var second=500;
            var third=1000;
            var fourth=2000;
    ...
    <!--Calculate(),,window.print()-->
    <body onload="Calculate(),Calculateleft()">
        <form name="id">
            ...
            <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="80%">
                ...
                <div id="graphdiv" align="center"  class="graph"></div>


                <tr>

                    <td><html:hidden value="<%=rightear250%>" property="rightear250" /></td>
                    <td><html:hidden value="<%=rightear500%>" property="rightear500"  /></td>
                    <td><html:hidden value="<%=rightear1000%>" property="rightear1000" /></td>
                    <td><html:hidden value="<%=rightear2000%>" property="rightear2000" /></td>
                    <td><html:hidden value="<%=rightear4000%>" property="rightear4000" /></td>
                    <td><html:hidden value="<%=rightear8000%>" property="rightear8000" /></td>

                    <td><html:hidden value="<%=leftear250%>" property="leftear250"/></td>
                    <td><html:hidden value="<%=leftear500%>" property="leftear500"  /></td>
                    <td><html:hidden value="<%=leftear1000%>" property="leftear1000" /></td>
                    <td><html:hidden value="<%=leftear2000%>" property="leftear2000" /></td>
                    <td><html:hidden value="<%=leftear4000%>" property="leftear4000" /></td>
                    <td><html:hidden value="<%=leftear8000%>" property="leftear8000" /></td>

                    <td>
                        <font color="red"><font color="red" size="6"><b>.</font>_____ Right Ear</font></b><br><font color="blue"><b>o ------ Left Ear</b></font></td>
                </tr>
            </table><br><br><br><br><br><br><br><br><br><br>

            <table  border="1" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="70%">
                <tr>
                    <td colspan="2" align="center"><font size="4"><b>Speech Discrimination<b></font></td></td></tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><html:text property="speechaudiometryrightear_pta" value="<%=speechaudiometryrightear_pta%>" size="5" maxlength="3" /></td>
                                    </tr>
                                    <tr >
                                        <td align="left"><b>%of speech discrimination in Left Ear</b></td>
                                        <td><html:text property="speechaudiometryleftear_pta" value="<%=speechaudiometryleftear_pta%>" size="5" maxlength="3" /></td>
                                    </tr>
                                    ...
                                    <table  border="0" align="bottom" cellspacing="1" cellpadding="5" class="tbl_bg2" width="80%" id="bapi">
                                        <tr  >
                                            <td align="left" colspan="10"><b><font color="blue">SADAREM ID :&nbsp;<%=personcode%></font></b></td> </tr>
                                        <tr>
                                            <td align="left" colspan="10"><b><font color="blue">Name :  <%=telugupersonname%></font></b>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table align="center">
                                        ...
                                        <a href="HearingGraph.do?print=print&pensioncode=<%=p%> " target="_blank" >
                                            Print<img src="DisabilityUITG/images/print.gif"  height="25" width="25"/></a>

                                    </table><br><br>

                                    <table align="center">
                                        <center> <html:button property="" value="Back" onclick="goBack()" styleClass="button"> </html:button> </center>
