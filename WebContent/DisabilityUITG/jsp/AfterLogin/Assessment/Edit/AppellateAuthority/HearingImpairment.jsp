...
<html:html>
    ...
    <script language="javascript" src="./DisabilityUITG/js/hearing.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
     function validateForm(thisForm){
        ...
        function getingvalues(thisForm) {
    ...
    <BODY>
        ...
        <html:form action="/hearing.do?insertHearingImpairment=insertHearingImpairment" styleId="hearingactionform"  onsubmit="return  validateForm(this)"
                    method="post">
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">

                <tr>
                    <th colspan="5"  >10.&nbsp;&nbsp ADD HEARING IMPAIRMENT</th>
                </tr>
                <tr>
                    <th><br>Category</th>
                    <th><br>Type of Impairment</th>
                    <th><br>Speech Audiometry</th>
                    <th><br>DB Level</th>
                    <th><br>% of Impairment</th>
                </tr>
                ...
                <tr>
                    <th colspan="9" >Pure Tone Audiometry<font size="2">(please assess the frequencies and
                            write the values in appropriate boxes)</font>
                    </th>
                </tr>
            </table>
        ...
        <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                ...
                <tr>
                    ...
                    <td><html:text property="rightear250"  maxlength="3" style="width:50px"/></td>
                    <td><html:text property="rightear500"  maxlength="3" onkeyup="righteardblevelcalculation()" onblur="righteardblevelcalculation()" style="width:50px"/></td>
                    <td><html:text property="rightear1000"  maxlength="3" onkeyup="righteardblevelcalculation()" onblur="righteardblevelcalculation()" style="width:50px"/></td>
                    <td><html:text property="rightear2000"  maxlength="3" onkeyup="righteardblevelcalculation()" onblur="righteardblevelcalculation()" style="width:50px"/></td>
                    <td><html:text property="rightear4000"  maxlength="3" style="width:50px"/></td>
                    <td><html:text property="rightear8000"  maxlength="3" style="width:50px"/></td>
                    <td><html:text property="righteardblevel"  onclick="righteardblevelcalculation()" readonly="true" style="width:50px"/></td>
                ...
                <tr>
                    ...
                    <td><html:text property="leftear250"  maxlength="3" style="width:50px"/></td>
                    <td><html:text property="leftear500"  maxlength="3" onkeyup="righteardblevelcalculation()" onblur="righteardblevelcalculation()" style="width:50px"/></td>
                    <td><html:text property="leftear1000"  maxlength="3" onkeyup="righteardblevelcalculation()" onblur="righteardblevelcalculation()" style="width:50px"/></td>
                    <td><html:text property="leftear2000"  maxlength="3" onkeyup="righteardblevelcalculation()" onblur="righteardblevelcalculation()" style="width:50px"/></td>
                    <td><html:text property="leftear4000"  maxlength="3" style="width:50px"/></td>
                    <td><html:text property="leftear8000"  maxlength="3" style="width:50px"/></td>
                    <td><html:text property="lefteardblevel"  onclick="righteardblevelcalculation()" readonly="true" style="width:50px"/></td>
                ...
                <tr id="row1">
                    ...
                    <td><div  id="static" style="visibility:hidden"><font color="red"><font color="red" size="4">
            ...
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">
                <tr>
                    <th colspan="5" align="center" >Speech Discrimination</th>
                </tr>
     
                <tr>
                    <td >%of speech discrimination in Right Ear</td>
                    <td><html:text property="speechaudiometryrightear_pta"  maxlength="3" /></td>
                </tr>
                <tr>
                    <td >%of speech discrimination in Left Ear</td>
                    <td><html:text property="speechaudiometryleftear_pta"  maxlength="3" /></td>
                </tr>

          

                <tr>
                    <th align="center" colspan="2">Need Assessment/Referred/Recommended</th>
                </tr>
                ...
                <tr>
                    ...
                    <td ><html:checkbox property="speechtheraphy" value=" EarlyIntervention Speech Therapy" style="width:25px">
                        </html:checkbox></td>
                </tr>
                <tr>
                    <td  >2. Surgery</td>
                    <td   ><html:text property="surgery" maxlength="75" style="width:250px"></html:text> </td>
                </tr>
                <tr>
                    <td  >3. Speech Therapy</td>
                    <td ><html:checkbox property="speechtherapy" value="Speech Therapy " style="width:25px"> </html:checkbox> </td>
                </tr>
                <tr>
                    <td  >4. Language Development</td>
                    <td><html:checkbox property="languagedevelopment" value="Language Development" style="width:25px"></html:checkbox> </td>
                </tr>
                <tr>
                    <td colspan="2" >5.  Assistive & Augmentative Devices For  Hearing  Impairment</td>
                </tr>
                <tr>
                    <td  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i.Hearing Aid(Select Fields) </td>
                    <td width="48%" ><html:select property="hearingaidselect"  >
                        ...
                        <html:select property="hearingaidtype"    >
                    ...
                    <tr>
                        ...
                        <td > <html:checkbox property="cochlearimplantation" value="Cochlear Implantation" style="width:25px"> </html:checkbox> </td>
                </tr>
                <tr>
                    <td  > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; iii.Implantable Hearing Aid</td>
                    <td> <html:checkbox property="implantablehearingaid" value="Implantable Hearing Aid" style="width:25px"> </html:checkbox> </td>
                </tr>
                <tr>
                    <td   align="tpo">6. Any Other Hearing Impairment Needs</td>
                    <td><html:textarea rows="4" cols="30" property="anyotherhearingimpairement" onkeydown="textCounter2()" onkeyup="textCounter2()"> </html:textarea></td>
                </tr>
          <%--  </table><br>

            <table align="center">--%>
                <tr>
                    <th colspan="2"><html:button property=""  value="Back" onclick="goBack()" styleClass="button"/>


                   <html:submit  value="Add"  styleId="hearButton" onfocus="validatecharecters()" onclick="return getingvalues(this)" onmouseover="righteardblevelcalculation()" styleClass="button"/>
