...
<HTML>
    ...
    <BODY >
        <html:form action="/insertMRBinetKamatDetailedTestDetails.do?insertMRBinetKamatDetailedTestDetails=insertMRBinetKamatDetailedTestDetails" styleId="MRBinetKamatDetailedTestForm"
                   onsubmit="return avoidDuplicateForm(this)">

            <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                <tr>
                    <th colspan="14">Add BKT Detailed Test Details </th>
                </tr>
                <tr >


                    <th  rowspan="3" >Item No</th>
                    <th colspan="14"  >AGE LEVELS</th>
                <tr>
                <tr >
                    <th align="center" >3
                    </th>
