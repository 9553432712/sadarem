<%-- 
    Document   : PartADetailsDisplayofPersoncodeDelete
    Created on : Apr 10, 2010, 10:58:09 AM
    Author     : srinivas_p
--%>
       ...
       for(var i=1;i<=13;i++)
        ...
        document.getElementById(i).disabled=false;
           ...
           document.forms[0].noOfYears.focus();
            ...
            with (thisform)
            {
            if (validate_required(hospitalname,"Hospital Name must be selected!")==false)
            {
            hospitalname.focus();
            return false
            }
            if (validate_required(hospitaladdress,"Hospital Address must be selected!")==false)
            {
...
return (allow.indexOf(String.fromCharCode(k))!=-1);
    ...
    <body onload="validaterelationcheckbox(),validateepiccheckbox(),validatepensioncheckbox()">
        <html:form action="deletepersondetails.do?deletPersonalDetails=deletPersonalDetails"  styleId="partAForm" onsubmit="return validate_form(this)">
             <input type="hidden" name="status" value="success" />
            <br>
            <table  align="center" cellspacing="0" cellpadding="8" class="innerTable" width="85%">

                <tr>
                    <td align="center" class="heading">Check Delete Personal Data Details</td>
                </tr>
            ...
            <table  align="center" cellspacing="0" cellpadding="8" class="innerTable1" width="85%">
                ...
                <tr>
                    ...
                    <td><font size="2"><b><%=telugu%></b></font></td>
        ...
        %>
                ...
                <td colspan="3" class="label">
                <html:select property="marital" disabled="true" styleId="7">
                    <html:option value="">--SELECT--</html:option >
...
<td colspan="4" width="57%" class="label"><html:radio  property="parents_marriage" value ="1" disabled="true" >Yes</html:radio><html:radio  property="parents_marriage" value ="0" disabled="true" >No</html:radio>
               ...
               <tr>
                    <td class="label"><font size="2" color="red"><%=fathername%></font></td>
   ...
   <td class="label" width="46%"> H.No<font color="red" size="3"><b>*</b></font>  </td>
  ...
  <tr>
      ...
      <td class="label"><html:radio property="personstatus" name="partAForm" value="Eligible" /> Eligible
          <html:radio property="personstatus" name="partAForm" value="Rejected" /> Rejected</td>
  </tr>  </table>
            <br><br>
            <center>

                <html:submit  value="Delete" onmouseover="selecttype()" onfocus="validatecandidateage()"/>&nbsp;&nbsp;
