...
<html:html >
    ...
    <body onload="validateepiccheckbox(),validatepensioncheckbox()">
        <html:form action="updatePartAPersonalDetails.do?updatePersonalDetails=updatePersonalDetails"  styleId="partAForm" onsubmit="return validate_form(this)">
            <br>
            ...
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">
                ...
                <tr>
                    <th align="center" class="heading" colspan="4">Update Personal Data</th>
                </tr>

                <%-- </table>


            <table  align="center" cellspacing="0" cellpadding="0" class="innerTable1" width="85%">--%>

                <tr>

                    <td >Form No<font color="red"><b>*</b></font></td>
                    <td ><html:text property="formno"  name="partAForm" maxlength="25" readonly="true"
                               onkeypress="return specialcharactets(event,numbers+letters)"/></td>
                    <td  >Date of Assessment<font color="red"><b>*</b></font></td>
                    <td ><html:text property="fromdate"   name="partAForm" readonly="true"/></td>
            ...
            <table  align="center" cellspacing="0" cellpadding="0" class="innerTable1" width="85%">--%>
                ...
                <%-- </table>
                 <table  align="center" cellspacing="0" cellpadding="0" border="1" class="innerTable1" width="85%">--%>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">Years&nbsp;&nbsp;<html:text property="noOfYears" size="6" onfocus="disableCalculateDob(this);"
                               onblur="validatecandidateage()" readonly="true" styleId="30" style="width:50px"/></td>
                </tr>
                <tr>
                    <td>Date Of Birth</td>
                    <td colspan="3">
                        Day <html:select  property="day"  name="partAForm" styleId="1" disabled="true" style="width:50px">
                            <%
                        ...
                        Month <html:select property="month" name="partAForm" disabled="true"  styleId="2" style="width:100px">
                        ...
                        Year <html:select property="year" styleId="year" name="partAForm" onchange="enableCalculateAge(this);"
                                     styleId="3" disabled="true" style="width:100px">
                ...
                <tr>
                    ...
                    <td ><html:select property="gender" styleId="gender" name="partAForm" onchange="generateDob(this);changeothercombo(this.options.selectedIndex)" styleId="4" disabled="true">
                    ...
                    <td>1.4 Education</td>
                    <td ><html:select property="education"  name="partAForm" styleId="5" disabled="true">
                ...
                <tr>
                    ...
                    <td><html:text property="card" size="25" maxlength="20" disabled="true"/></td>
                    <td >Type <html:select property="rtype" name="partAForm" disabled="true" styleId="10">
                            <html:option value="">--SELECT--</html:option>
                ...
                <tr>
                    <td width="32%">1.10 EPIC Card</td>
                    <td width="18%">Click if Yes<html:checkbox  property="epiccard" value="true" name="partAForm"
                                    onclick="validateepiccheckbox(this.value)" disabled="true" styleId="11" style="width:25px"/></td>
                    <td colspan="2">
                ...
                <tr>
                    <td width="32%">1.11 Pension Card </td>
                    <td width="18%">Click if Yes<html:checkbox  property="pensioncard" value="true" name="partAForm"
                                    onclick="validatepensioncheckbox(this.value)" disabled="true" styleId="12" style="width:25px"/></td>
                        ...
                        <div id="pension" style="visibility:hidden;display:none">
                            <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="85%">
                                <tr>
                                    ...
                                    <td colspan="3"><html:text property="pensioncardno"  maxlength="7" readonly="true"/>
                                    </td> </tr>
                            </table>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td width="30%"><font color="red"><b>*</b></font><b> 1)<html:text property="mole1" size="25" name="partAForm" maxlength="50" onkeyup="validatemole1()" readonly="true"/></b></td>
                    <td colspan="2"><font color="red"><b>*</b></font><b>2) <html:text property="mole2" size="25" name="partAForm" maxlength="50" onkeyup="validatemole2()" readonly="true"/></b></td>

                </tr>
                <tr>
                    <td width="28%" align="left">1.13 Consanguineous Marriage of Parents
                    </td>
                    <td colspan="3" width="57%"><html:radio  property="parents_marriage" value ="1" disabled="true" style="width:25px">Yes</html:radio><html:radio  property="parents_marriage" value ="0" disabled="true" style="width:25px">No</html:radio>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="34%">2.1 Father/Mother/Husband/Guardian's Name<font color="red"><b>*</b></font></td>
                ...
                <tr>
                    <td  colspan="4">3.0 Address (As recorded in RATION CARD)</td>
                            ...
                            <tr>
                                <td width="31%"> House No.<font color="red" size="3"><b>*</b></font>  </td>
                            ...
                            <tr>
                                ...
                                <td>Phone No</td>
                                <td><html:text  property="phoneno" onkeypress="return onlyNumbers();" maxlength="15" readonly="true"></html:text></td>
                            </tr>
                            <tr>
                                <td>EMail</td>
                                <td><html:text  property="email" onblur="validateemail()" maxlength="50" readonly="true"></html:text></td>
                           
                                <td>Pin</td>
                                <td><html:text  property="pin" maxlength="6" onblur="validatepin()" readonly="true"></html:text></td>
                            </tr>
                        
                <tr>
                    <td  >4.0 Person Status<font color="red"><b>*</b></font></td>
                    <td colspan="3"><html:radio property="personstatus" name="partAForm" value="Eligible" disabled="true" styleId="14" style="width:25px"/> Eligible
                        <html:radio property="personstatus" name="partAForm" value="Rejected" disabled="true"  styleId="15" style="width:25px"/> Rejected</td>
                </tr>
                <tr>
                    <th colspan="4">
