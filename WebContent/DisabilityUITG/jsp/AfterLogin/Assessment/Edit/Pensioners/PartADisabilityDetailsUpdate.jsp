...
<html:html>
    <head>
        ...
        <script language="JavaScript">
            ...
            function disabile()
            {
                if(document.partAForm.education.selectedIndex == 1)
                {
                    document.partAForm.edustatus.disabled = true;
                    document.partAForm.edustatus.value = 0;
                }
                else
                {
                    document.partAForm.edustatus.disabled = false;
                }
            }
                ...
                function validateForm(thisForm){
                    ...
                    if(flag){
                        if (thisForm.getAttribute('submitted')){
                            ...
                            document.getElementById('updateDisButton').disabled = true;
                        }
                    }
                    return flag;
                }
    ...
    <body onload="displayAppropriate(this.value),years(),validatecheckbox()">
 
        <html:form action="updatePartADisabilityDetails.do?updateDisabilityDetails=updateDisabilityDetails"  styleId="partAForm"  onsubmit="return validateForm(this)">
            ...
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">
                <tr>
                    <th colspan="8">Update Disability Details</th>
                </tr>

                <tr>
                    <td  width="35%">Venue of the Camp</td>
                    <td><html:text  property="camp_venue"   name="partAForm" readonly="true" style="width:250px"/></td>

                </tr>
                <tr>
                    <td >Name of the Medical Authority</td>
                    <td><html:text styleId="31" property="hospitalname"  name="partAForm" readonly="true" style="width:250px"/></td>
                </tr>
                <tr>

                    <td >Address of the Medical Authority</td>
                    <td> <html:text styleId="32"  property="hospitaladdress"  name="partAForm" readonly="true" style="width:250px"/></td>
                </tr>
            ...
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">
                <tr>
                    <th colspan="8" >Doctor Details</th>
                </tr>
            </table>
            <div id="singledoctor" style="visibility:hidden;display:none">
                <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%" border="0">
                    <tr>
                        ...
                        <td >1. Doctor Name<font color="red"><b>*</b></font> <html:text styleId="doctor1name" property="doctor1name" name="partAForm" onkeypress="return alpha(event)" maxlength="25" style="width:185px"/> </td>
                        <td  >Reg. Number<font color="red"><b>*</b></font> <html:text styleId="doctor1regnumber" property="doctor1regnumber" name="partAForm" style="width:185px"/></td>
                        <td  >Designation<font color="red"><b>*</b></font> <html:text styleId="doctor1designation" property="doctor1designation" name="partAForm" onkeypress="return isNumberKey(event)" maxlength="25" style="width:185px"/></td>
            ...
            <div id="multipledoctor" style="visibility:hidden;display:none"> 
                <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">
                    <tr>
                        ...
                        <!-- start-->
                        <td ><html:checkbox property="ohdoctor" styleId="OH" value="1" onclick="validatecheckbox(this.value)" style="width:25px"/>OH Doctor Name <html:text styleId="42" property="doctornameOH" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameOH);" onkeypress="return space(event,this)"
                                                                                                                                                    onchange="capitalizeMe(this)" maxlength="25" style="width:150px"/> </td>
                        <td  >Reg. Number <html:text styleId="43" property="doctorregnumberOH" name="partAForm" onkeypress="return space(event,this)" style="width:150px"/></td>
                        <td  >Designation <html:text styleId="44" property="doctordesignationOH" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctordesignationOH);" maxlength="25" onkeypress="return space(event,this)" style="width:150px"/></td>
                    ...
                    <tr>
                        ...
                        <!-- start-->
                        <td ><html:checkbox property="vidoctor" styleId="VI" value="2" onclick="validatecheckbox(this.value)" style="width:25px"/>VI Doctor Name&nbsp; <html:text styleId="45" property="doctornameVI" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameVI);" onkeypress="return space(event,this)"
                                                                                                                                                    onchange="capitalizeMe(this)" maxlength="25" style="width:150px"/> </td>
                        <td  >Reg. Number <html:text styleId="46" property="doctorregnumberVI" name="partAForm" onkeypress="return space(event,this)" style="width:150px"/></td>
                        <td  >Designation <html:text styleId="47" property="doctordesignationVI" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctordesignationVI);" maxlength="25" onkeypress="return space(event,this)" style="width:150px"/></td>
                    ...
                    <tr>
                        ...
                        <!-- start-->
                        <td ><html:checkbox property="hidoctor" styleId="HI" value="3" onclick="validatecheckbox(this.value)" style="width:25px"/>HI Doctor Name&nbsp; <html:text styleId="48" property="doctornameHI" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameHI);" onkeypress="return space(event,this)"
                                                                                                                                                    onchange="capitalizeMe(this)" maxlength="25" style="width:150px"/> </td>
                        <td  >Reg. Number <html:text styleId="49" property="doctorregnumberHI" name="partAForm" onkeypress="return space(event,this)" style="width:150px"/></td>
                        <td  >Designation <html:text styleId="50" property="doctordesignationHI" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctordesignationHI);" maxlength="25" onkeypress="return space(event,this)" style="width:150px"/></td>
                    ...
                    <tr>
                        ...
                        <!-- start-->
                        <td ><html:checkbox property="mrdoctor" styleId="MR" value="4" onclick="validatecheckbox(this.value)" style="width:25px"/>MR Doctor Name&nbsp;
                            <html:select property="mdspecialistprefix" >
                            ...
                            <html:text styleId="51" property="doctornameMR" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameMR);" onkeypress="return space(event,this)"
                                       onchange="capitalizeMe(this)" maxlength="25" style="width:150px"/> </td>
                        <td  >Reg. Number <html:text styleId="52" property="doctorregnumberMR" name="partAForm" onkeypress="return space(event,this)" style="width:150px"/></td>
                        <td  >Designation <html:text styleId="53" property="doctordesignationMR" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctordesignationMR);" maxlength="25" onkeypress="return space(event,this)" style="width:150px"/></td>
                    ...
                    <tr>
                        ...
                        <!-- start-->
                        <td ><html:checkbox property="midoctor" styleId="MI" value="5" onclick="validatecheckbox(this.value)" style="width:25px"/>MI Doctor Name <html:text styleId="54" property="doctornameMI" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameMI);" onkeypress="return space(event,this)"
                                                                                                                                                    onchange="capitalizeMe(this)" maxlength="25" style="width:150px"/> </td>
                        <td  >Reg. Number <html:text styleId="55" property="doctorregnumberMI" name="partAForm" onkeypress="return space(event,this)" style="width:150px"/></td>
                        <td  >Designation <html:text styleId="56" property="doctordesignationMI" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctordesignationMI);" maxlength="25" onkeypress="return space(event,this)" style="width:150px"/></td>
            ...
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="90%">
                <tr>
                    ...
                    <!-- start-->
                    <td >2. Doctor Name<font color="red"><b>*</b></font> <html:text styleId="36" property="doctor2name" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameMI);" onkeypress="return space(event,this)"
                               onchange="capitalizeMe(this)" maxlength="25" style="width:185px"/> </td>
                    <td >Reg. Number<font color="red"><b>*</b></font> <html:text styleId="37" property="doctor2regnumber" name="partAForm" onkeypress="return space(event,this)" style="width:185px"/></td>
                    <td >Designation<font color="red"><b>*</b></font> <html:text styleId="38" property="doctor2designation" name="partAForm" onkeypress="return isNumberKey(event)" maxlength="25" onkeypress="return space(event,this)" style="width:185px"/></td>
                ...
                <tr>
                    ...
                    <!-- start-->
                    <td >3. Doctor Name<font color="red"><b>*</b></font> <html:text styleId="39" property="doctor3name" name="partAForm" onkeydown="return isAlpha(event.keyCode,doctornameMI);" onkeypress="return space(event,this)"
                               onchange="capitalizeMe(this)" maxlength="25" style="width:185px"/> </td>
                    <td >Reg. Number<font color="red"><b>*</b></font> <html:text styleId="40" property="doctor3regnumber" name="partAForm" onkeypress="return space(event,this)" style="width:185px"/></td>
                    <td >Designation<font color="red"><b>*</b></font> <html:text styleId="41" property="doctor3designation" name="partAForm" onkeypress="return isNumberKey(event)" maxlength="25" onkeypress="return space(event,this)" style="width:185px"/></td>
                ...
                <table  align="center" cellspacing="1" cellpadding="0" border="0" width="90%">
                    <tr>
                        <td>
                            <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="100%">
                                <tr>
                        <td >
                            Locomotor Disability/OH Subtypes<logic:equal name="partAForm" property="disabilityId"
                        ...
                        <td >Part Involved<logic:equal name="partAForm" property="disabilityId"
                                     value="1"><font color="red"><b>*</b></font></logic:equal> </td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td>
                            <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="100%">
                                <tr>
                        <td width="34%">Any other</td>
                        <td colspan="3">
                            <html:text property="othertypeofdisability" size="40" maxlength="50" style="width:280px"></html:text>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td >PP-can perform work by pulling and pushing<font color="red">*</font></td>
                    ...
                    <tr>
                        ...
                        <td >KC-can perform work by kneeling and crouching<font color="red">*</font></td>
                    ...
                    <tr>
                        ...
                        <td >S-can perform work by sitting<font color="red">*</font></td>
                    ...
                    <tr>
                        ...
                        <td >W-can perform work by walking<font color="red">*</font></td>
            ...
            <div id="visual" style="visibility:hidden;display:none">
                <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                    <tr>
                        <td  width="34%">Visual Impairment Subtypes<logic:equal name="partAForm" property="disabilityId" value="2">
                                <font color="red"><b>*</b></font></logic:equal></td>
                            <td>
                            <html:select  property="disabilityLocoSubIds" styleId="visualSubTypes" multiple="true" style="width:275px">
                                <html:option  value="">--SELECT--</html:option>
            ...
            <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                ...
                <tr>
                    <td width="34%" >Disability/Impairment is due to</td>

                    <td>
                        <html:text  maxlength="150"  property="diagnosisofdisability" onblur="validatediagnosisofdisability()" style="width:310px"></html:text>
                    </td>
                </tr>
            </table>
            ...
            <div id="conditionofdisabilityvisual" style="visibility:hidden;display:none">
                <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                    <tr>
                        ...
                        <td ><html:select property="conditiondisability" style="width:310px" styleId="conditiondisabilityvisual" name="partAForm" onchange="disabile()"><html:option  value="">----------------------SELECT----------------------</html:option>
                ...
                <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                    <tr>
                        ...
                        <td  width="34%">Period of Reassessment</td>
                        <td><html:select property="yearsfortemporary"  name="partAForm"  >
            ...
            <div id="causeOfDisabilityVisual" style="visibility:hidden;display:none">
                <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                    <tr>
                        <td  colspan="5">1.2 Causes of Disability</td>
            ...
            <div id="causeOfDisabilityOther" style="visibility:visible;display:inline">
                <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%">
                    <tr>
                        <td  colspan="4">1.2 Causes of Disability</td>
                    </tr>
                    <tr>
                        <td width="34%"> Congenital
                        </td>
            ...
            <table  align="center" cellspacing="1" cellpadding="0" border="0" class="inputform" width="90%" id="hideTB">
                <tr>

                    <td  width="34%">Any other Cause of Disability</td>
                    <td><html:text property="otherconditionofdisability"   maxlength="75" style="width: 300px"></html:text></td>
                </tr>

                <tr align="center">
                    <th colspan="8" align="center">
                        <html:submit value="Update" onclick="return multipleDoctors();" styleClass="button" styleId="updateDisButton"/>&nbsp;&nbsp;
