...
<body>
    <html:errors/>
    <html:form action="MRSfbdetailsupdate.do?updateMRseguintestdetails=updateMRseguintestdetails" method="post"
               onsubmit="return validateForm(this)" styleId="mentalform">
        ...
        <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="60%">
            <tr>
                <th  align="center" colspan="6">5.&nbsp;&nbsp;Update Seguin Form Board(S.F.B)</th>
            </tr>
      ...
      <%--  </table>
        <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="60%">--%>
            <tr>
                <td >Mental Age</td>
                <td align="left">&nbsp;Years<font color="red">*</font> <html:text property="sfbyear" onblur="this.value=removeSpaces(this.value);"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;
