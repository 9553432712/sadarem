...
<html:html>
    ...
    <body onload="disableForm(partAForm);">

        <html:form action="getRejectedDetailsPrint.do" styleId="partAForm" ><br><br>


            <table  align="center" cellspacing="1" cellpadding="8" class="innerTable" width="85%">
                <tr>
                    <th align="center" class="heading">Rejected Person Disability Details</th>
                </tr>
            </table>
        ...
        <form action="">
             <table  align="center" cellspacing="0" cellpadding="0" width="85%">
                <tr>
                    <td align="center">
                        <html:button value="Go to Home Page" property="nam" onclick="goURL()" styleClass="button"/>&nbsp;&nbsp;
                        <html:button value="Print" property="pri" styleClass="button" onclick="window.print();"/></td>
                </tr>
            </table>
        </form>
    </body>
