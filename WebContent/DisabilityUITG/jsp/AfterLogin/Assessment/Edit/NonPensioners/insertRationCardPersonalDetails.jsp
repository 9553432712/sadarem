...
<% String personname = "&#3093;&#3134;&#3120;&#3149;&#3105;&#3137; &#3118;&#3136;&#3110; &#3098;&#3138;&#3114;&#3125;&#3122;&#3128;&#3135;&#3112;  &#3114;&#3143;&#3120;&#3137; ";
            ...
            String aadharcard = null;
            if (request.getAttribute("aadharcardNo") != null) {
                aadharcard = (String) request.getAttribute("aadharcardNo");
            }
%>
<style type="text/css">
...
<html:html>
    <head>
        ...
        <script language="JavaScript" src="./DisabilityUITG/js/PartADetailsExistingPensionNumberPhaseIII.js"></script>
        ...
        <script>
            ...
            <%request.removeAttribute("noOfRows");%>
                ...
                function callActionMethod(id){
                    ...
                    document.forms[0].action="MemberDetails.do?noofrows="+id;
                    document.forms[0].submit();
                }
    ...
    <body onload="document.partAForm.formno.focus(),currentdate(),validatepensioncheckbox(),validateepiccheckbox(),generateDob(),rationType(),checkDisability();" >
        <html:form action="/insertRationCardPersonalDetails.do?mode=insertPersonalDetails"
            ...
            <table  align="center" cellspacing="1" cellpadding=""  width="90%" border="0" class="inputform">
                ...
                <tr>
                    ...
                    <td>
                        <html:text property="firstname" name="partAForm" maxlength="25" onkeydown="return isAlpha(event.keyCode,firstname);" onkeypress="return space(event,this)"
                                   onchange="capitalizeMe(this)" readonly="false" style="width:200px"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%                             } else {%>
                        <html:text property="card"  maxlength="20"
                                   onkeyup="rationType()" onkeypress="return space(event,this)" style="width:50px"/>
                        <%}%>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <html:text property="aadharCardNo" onkeydown="return isNumeric(event.keyCode);"  styleId="aadharCardId" onkeyup="return isNumeric(event.keyCode);" maxlength="12" style="width:160px" onblur="validateAadhar(this.value);"/>
                        <%                        } else {%>
                        <html:text property="aadharCardNo" onkeydown="return isNumeric(event.keyCode);"  styleId="aadharCardId" onkeyup="return isNumeric(event.keyCode);" maxlength="12" style="width:160px" readonly="true" />
                        <%                        }%>
                    </td>
                    <td colspan="2">
                        <div id="data"></div>
