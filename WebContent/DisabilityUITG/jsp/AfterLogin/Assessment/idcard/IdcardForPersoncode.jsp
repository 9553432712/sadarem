        ...
        <form action="MentalCertificate.do">
            ...
            <logic:iterate id="reportprint" name="reportlist" >
                                    ...
                                    <td  style="padding-left: 5px;text-align: left" width="100%">
                                       <table border="0" align="center" width="100%">
                                                 ...
                                                 %> <tr> 
                                                    ...
                                                    <span style="color:green; font-size: 12px;">Government of Andhra Pradesh<br>IDENTITY CARD FORPERSON WITH DISABILITY</span>
                                                	</td>
                                                	</tr>
                                                  <%
                                                  }
                                            ...
                                            <tr>
                                                <td colspan="2"  class="idcardLabels">
                                ...
                                <tr>
                                    <td width="100%" style="padding-left: 5px;">
                                        <table border="0" align="center" width="100%">
                                            ...
                                            <tr>
                                                <td  class="idcardLabels">Name : <span style="color: blue !important; "><bean:write name="reportprint"  property="firstdoctorname"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  class="idcardLabels">Designation : <span style="color: blue !important; "> <bean:write name="reportprint"  property="firstdesgination"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  class="idcardLabels">Registration No : <span style="color: blue !important; "> <bean:write name="reportprint"  property="firstdoctornumber"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="idcardLabels">Name : <span style="color: blue !important; ">Dr. <bean:write name="reportprint"  property="seconddoctorname"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  class="idcardLabels">Designation : <span style="color: blue !important; "> <bean:write name="reportprint"  property="seconddesgination"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  class="idcardLabels">Registration No : <span style="color: blue !important; " > <bean:write name="reportprint"  property="seconddoctornumber"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="50%" class="idcardLabels">Doctor
                                            ...
                                            <tr>
                                                <td  class="idcardLabels">Name : <span style="color: blue !important; " >Dr. <bean:write name="reportprint"  property="thirddoctorname"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="idcardLabels">Designation : <span style="color: blue !important; "> <bean:write name="reportprint"  property="thirddesgination"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="idcardLabels">Registration No : <span style="color: blue !important; " > <bean:write name="reportprint"  property="thirddoctornumber"/></span>
                                                    <br>
                                                </td>
                                            </tr>
                                        </table>
             ...
             <div class="printhide" style="text-align: center;padding-top: 20px;">
            	<!-- <h3 align="center"> <a href="TerritorySelectForIdcard.do?print=idcardprint&status=finish&personstatus=Eligible" target="_blank" >Print<img src="DisabilityUITG/images/print.gif" height="25" width="25"/></a></h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
