<%--
    Document   : SelectPensionerOrNonPensioner
...
<html>
    ...
    <body>
        ...
        <html:form action="SelectPensionerOrNonPensioner.do"  method="post" styleId="partAForm" onsubmit="return validate_form(this)" >
...
<input type="radio" style="width:30px" name="aadhar" id="3" value="3" onclick="return selectflow(this.value)"/>AadharCard Number<%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp--%>
            ...
            <table  align="center" cellspacing="1" cellpadding="0" class="inputform" width="60%" border="0" >
