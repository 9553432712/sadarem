<%-- 
    Document   : alreadyDataEnterPage
    Created on : Dec 30, 2011, 6:38:39 PM
    Author     : 484898
--%>
            ...
            <tr>
                <td align="center" class="labelBlue">
                    ...
                    <logic:notPresent name="aadharNoPersonCode">
                        <font  size="4">This pension number <font  size="5" color="red"> <%= session.getAttribute("pensionIdDis")%> </font>
