...
<%--
    ...
    Created on : Mar 27, 2012, 7:07:24 PM
    Author     : 490058
--%>
...
<table  class="tbl_bgbg" width="90%" border="0" cellspacing="5" cellpadding="0" align="center" style="border:2px #666 solid;border-color:green;">
              ...
              <td align="left" valign="middle" style="padding-left: 15px;">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                    	...
                    	Appendix No. 1/13<br>(See Rule 101, Serial No: 9(1) and 9(2))<br><span style="font-size:20px;">CONCESSION CERTIFICATE</span>
                  	</td>
                  </tr>
                </table>
            </td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:10px; line-height: 17px; font-family:Verdana; font-weight: bold; text-align:left;"> 
                    	Form for the purpose of grant of rail <br>concession to  completely Blind
                                        persons<br>to be issued by a Regd.Medical Practitioner/<br>government Doctor/Heads of the<br>Institutions for the Blind recognized<br>by Ministry of welfare/ Govt.of India<br>or Social Welfare Dept.of the<br>concerned state Government
                                                </td></tr></table></td>
                  </tr>
                </table>
            </td>
  ...
  <tr>
  	<td style="font-size:12px; line-height: 22px; font-family:Verdana, Geneva, sans-serif; font-weight: normal;">
    	This is to certify that <span style="font-size:12px; font-weight:bold;color:#00F;"><bean:write name="reportprint"  property="maritialstatus"/> <bean:write name="reportprint"  property="name"/></span>, Whose Particulars are furnished below, is a <span style="font-weight:bold;"> COMPLETELY BLIND PERSON.</span>
  	</td>
  </tr>
  <tr>
  	<td align="center" valign="middle" style="font-size:12px; line-height: 22px; font-family:Verdana; font-weight: bold;">Particulars of the COMPLETELY BLIND PERSON:</td>
  </tr>
  <tr>
  	<td valign="left">
                  ...
                  <ol style="list-style-type:lower-alpha; font-family:Verdana, Geneva, sans-serif; font-size:12px; font-weight:normal;">
                	<li>
            	Address : <logic:notEmpty name="reportprint" property="housenumber"> H.No.# <span style="font-size:12px; font-weight:bold; color:#00F;">
            	<bean:write name="reportprint"  property="housenumber"/></span>, </logic:notEmpty>
                    ...
                    <li>Age : <span style="font-family:Verdana, Geneva, sans-serif;font-size:12px; font-weight:bold;color:#00F;"><bean:write name="reportprint"  property="age"/></span> years</li>
                    <li>Sex : <span style="font-family:Verdana, Geneva, sans-serif;font-size:12px; font-weight:bold;color:#00F;"><bean:write name="reportprint"  property="gender"/></span></li><br><br>
                    <li>Signature or Left Hand Thumb<br>
 impression of Blind Person:
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="50%" align="left" valign="top" style="font-size:11px; font-family:Verdana, Geneva, sans-serif; font-weight:bold; line-height:22px;">
            	Place : <span style="font-size:11px; font-weight:bold;color:#00F;font-family:Verdana, Geneva, sans-serif;"><bean:write name="reportprint"  property="hospitaladdress"/></span><br>
                Date : <span style="font-size:11px; font-weight:bold;color:#00F;font-family:Verdana, Geneva, sans-serif;"><bean:write name="reportprint"  property="dateofisse"/></span><br>
            ...
            <td width="50%" align="right" valign="top" style="font-size:11px;font-family:Verdana, Geneva, sans-serif; line-height:22px; font-weight:bold;">
            	Signature of Government Doctor<br>
                
                <%if(dn!=null){%>
                <%=dn%>
                <%}else { %>
                <span style="font-size:11px;font-family:Verdana, Geneva, sans-serif; font-weight:bold;color:#00F;">  <bean:write name="reportprint"  property="firstdoctorname"/></span><%}%><br>
                 Regn.No :
				 <%if(rn!=null){%>
                 <%=rn%>
                 <%}else { %>
                 <span style="font-size:11px;font-family:Verdana, Geneva, sans-serif; font-weight:bold;color:#00F;"><bean:write name="reportprint"  property="firstdoctornumber"/></span><%}%><br>
  ...
  <tr>
    <td align="left" valign="middle" style="font-size:9px; line-height: 16px; font-family:Verdana; font-weight: normal;">
        ...
        <ol>
            <li>This certificate should be issued only to<B> COMPLETELY BLIND PERSONS. </B>The photo must be signed and stamped by the certificate issuing Doctor/person in such way that signature and stamp appears partly on the photo and partly on the certificate.</li>
