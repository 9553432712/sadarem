        ...
        <logic:notEmpty name="rejectlist"  >
            <logic:iterate id="suggestion" name="rejectlist">
                <logic:iterate id="reject" name="rejectedlist">
                    ...
                    <table class="table_four cert-table" align="center" width="100%">
                         <%if ("0".equals(apflag)) {%>
                         <tr>
                        ...
                        <tr>
                            <td width="80%" valign="bottom">
                                <table>
                                    ...
                                    <tr><td class="Cert-label">ID No:</td><td class="Cert-label"><font color="blue">R<bean:write name="reject"  property="personcode"/></font></td>
                                    </tr>
                                    <tr>
                                        <td class="Cert-label">
...
<%-- <img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reject"  property="districtname"/>/<bean:write name="reject"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"> --%>
                        ...
                        <tr><td colspan="2">
                                <table>
                                    <tr valign="top" >
                                        <td class="Cert-label"><bean:write name="reject"  property="maritialstatus"/>&nbsp; <font color="blue">
