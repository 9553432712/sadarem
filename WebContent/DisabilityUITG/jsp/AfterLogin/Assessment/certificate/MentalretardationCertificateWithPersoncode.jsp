...
<%--                                             <img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reportprint"  property="district_name"/>/<bean:write name="reportprint"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"> --%>
                            ...
                            <td class="Cert-label">Re-assessment of this case is
                                <span style="color: blue !important; "><bean:write name="reportprint"  property="kindofdisability"/>&nbsp;<bean:write name="reportprint"  property="period"/></span>
                            </td>
                            </tr>
                            <tr>
                                <td valign="top" class="Cert-label"><li/></td>
                            ...
                            <td class="Cert-label">
                                ...
                                <span style="color: blue !important; "><bean:write name="reportprint"  property="mentalRetardationPhysicalRequirementList" /></span>
