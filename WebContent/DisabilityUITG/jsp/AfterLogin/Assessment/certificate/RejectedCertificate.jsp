...
<html:html>
    ...
    <BODY><br>
                        ...
                        <tr>
                            <td width="80%" valign="bottom">
                                <table>
                                    ...
                                    <tr>
                                        <td class="Cert-label">ID No:</td>
                                        <td class="Cert-label"><font color="blue">R<bean:write name="reject"  property="personcode"/></font></td>
                                    </tr>
                                    <tr>
                                        <td class="Cert-label">
                            ...
                            <td width="20%" align="right">
                                <table>
                                    <tr>
                                        ...
                                        <img align="right" src="<%=request.getContextPath()%>/dispimg.do?action=showsadaremimg&sadaremid=<bean:write name="reject"  property="personcode"/>&distName=<bean:write name="reject"  property="districtname"/>&randiomid=<%=Math.random()%>"  width="60" height="60" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"/>
                                        </td>
                                ...
                                <table>
                                    <tr valign="top" >
                                        <td class="Cert-label">
                                            ...
                                            <logic:notEqual name="suggestion" property="lowvisionaid" value=""><%  rejectsugg = true;%></logic:notEqual>
      ...
      selectFlow= request.getAttribute("selectedValue").toString();
                       ...
                       <%--  <a href="rejectedCertificate.do?print=certificateprint&flag=false&selectedValue=<%=selectFlow%>"  target="_blank">
