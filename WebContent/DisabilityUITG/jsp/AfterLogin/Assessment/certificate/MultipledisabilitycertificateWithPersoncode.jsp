                     ...
                     <%
                      ...
                      {  
                        ...
                        <tr>
						 ...
						 <%if("4".equals(categoryId)){ %> 
                            <tr>
                                <td align="center" class="labelAppelate" colspan="2"><span style="color: red !important; font-size: 12px !important;">(Appellate Authority Assessment)</span></td>
                            </tr>
                            <%} %>
                        <tr>
...
<%--                                         <img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reportprint"  property="district_name"/>/<bean:write name="reportprint"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"> --%>
                        ...
                        <tr>
                            <td colspan="2">
                                <table class="table_three">
                                    <tr>
                                        <td valign="top" width="4%" class="Cert-label"><li/></td>
                            <td width="96%" align="left" class="Cert-label">
                                ...
                                <logic:notEmpty name="reportprint" property="physicalImpairmentName">
                                    <br><span style="color: blue !important; "><bean:write name="reportprint" property="physicalImpairmentName"/>
                                        <bean:write name="reportprint" property="physicalImpairmentPercentage"/>%</span>
                                        ...
                                        <span style="color: blue !important; "><bean:write name="reportprint"  property="totalsubsubdisabilities" /></span>
                                        <span style="color: blue !important; "><bean:write name="reportprint"  property="totallocomotorarmlegeffectedlist" /></span>
                                        <br><logic:notEmpty name="reportprint" property="physicalImpairmentTotalsubdisabilities">
                                            Sub-type of disability :<span style="color: blue !important; "><bean:write name="reportprint"  property="physicalImpairmentTotalsubdisabilities" /></span>
                                        </logic:notEmpty>
                                    </logic:notEmpty></logic:notEmpty>

                                <logic:notEmpty name="reportprint" property="visualImpairmentName">
                                    <br><span style="color: blue !important; "><bean:write name="reportprint" property="visualImpairmentName"/>
                                        <bean:write name="reportprint" property="visualImpairmentPercentage"/>%</span>
                                    <br><logic:notEmpty name="reportprint" property="visualImpairmentTotalsubdisabilities">
                                        Sub-type of disability :<span style="color: blue !important; "><bean:write name="reportprint"  property="visualImpairmentTotalsubdisabilities" /></span>
                                    </logic:notEmpty>
                                </logic:notEmpty>

                                <logic:notEmpty name="reportprint" property="hearingImpairmentName">
                                    <br><span style="color: blue !important; "><bean:write name="reportprint" property="hearingImpairmentName"/>
                                        <logic:notEmpty name="reportprint"  property="hearingImpairmentCondition">
                                            <span style="color: blue !important; ">(<bean:write name="reportprint" property="hearingImpairmentCondition"/>)</span>
                                        </logic:notEmpty>
                                        <bean:write name="reportprint" property="hearingImpairmentPercentage"/>%</span>
                                        <logic:notEmpty name="reportprint" property="hearing_DB">
                                        <br>Loss of<span style="color: blue !important; "> <bean:write name="reportprint"  property="hearing_DB"/></span>(<bean:write name="reportprint"  property="hearing_DB_In_Words"/>)&nbsp;decibels in the better ear in the conversational range of frequencies.
                                    </logic:notEmpty>
                                </logic:notEmpty>

                                <logic:notEmpty name="reportprint" property="mentalRetardationName">
                                    <br><span style="color: blue !important; "><bean:write name="reportprint" property="mentalRetardationName"/>
                                        <logic:notEmpty name="reportprint"  property="mentalRetardationCondition">
                                            <span style="color: blue !important; ">(<bean:write name="reportprint" property="mentalRetardationCondition"/>)</span>
                                        </logic:notEmpty>
                                        <bean:write name="reportprint" property="mentalRetardationPercentage"/>%</span>
                                        <logic:notEmpty name="reportprint" property="mentalRetardation_IQ">
                                        <br>  IQ= <span style="color: blue !important; " ><bean:write name="reportprint"  property="mentalRetardation_IQ"/></span>(<bean:write name="reportprint"  property="mentalRetardation_IQ_Inwords"/>)&nbsp;
                                    </logic:notEmpty>
                                </logic:notEmpty>
                                <logic:notEmpty name="reportprint" property="mentalIllnessName">
                                    <br><span style="color: blue !important; "><bean:write name="reportprint" property="mentalIllnessName"/>
                                        <logic:notEmpty name="reportprint"  property="mentalIllnessCondition">
                                            <span style="color: blue !important; ">(<bean:write name="reportprint" property="mentalIllnessCondition"/>)
                                            </span>
                                        </logic:notEmpty>
                                        <bean:write name="reportprint" property="mentalIllnessPercentage"/>%</span>
                                        <logic:notEmpty name="reportprint"  property="global_Disablity">
                                        <br> Global Disability Score : <span style="color: blue !important; " ><bean:write name="reportprint"  property="global_Disablity" /></span><logic:notEmpty  name="reportprint" property="global_Disablity_InWords">[<bean:write name="reportprint"  property="global_Disablity_InWords"/>].</logic:notEmpty>
                                    </logic:notEmpty>
                                </logic:notEmpty>
                        ...
                        <td class="Cert-label">
                            ...
                            <span style="color: blue !important; "><bean:write name="reportprint"  property="multipleDisabilityPhysicalRequirementList" /></span>
            ...
            <tr>
                <td colspan="2">
                    <table class="table_three">
                        <tr>
                            <td align="left" width="33%" class="Cert-label">Signature</td>
                            <td align="left" width="33%" class="Cert-label">Signature</td>
                            <td align="left" width="30%" class="Cert-label">Signature</td>
                        </tr>
                        <tr>
