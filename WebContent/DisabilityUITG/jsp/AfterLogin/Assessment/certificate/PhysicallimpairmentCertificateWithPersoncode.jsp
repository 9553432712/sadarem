<%@page import="com.tcs.sadarem.util.CommonUtility" contentType="text/html"%>
...
<div class="row">
	<div class="col-md-12">
                         <table class="<%=classStyle %> cert-table"  align="center" width="98%" cellpadding="5" cellspacing="5">
                            <%if ("0".equals(apflag)) {%>
                            <tr>
                            ...
                            <tr>
                                <td align="center"  colspan="2"><span style="color: green !important; font-size: 10px !important;">(Issued under the authority vide G.O.Ms.No.31, WD CW & DW Dept.Dated 01.12.2009)</span></td>
                            </tr>
                           <%if("4".equals(categoryId)){ %> 
                            <tr>
                                <td align="center"  colspan="2"><span style="color: red !important;  font-size: 10px !important;">(Appellate Authority Assessment)</span></td>
                            </tr>
                            <%} %>
                            <tr>
...
<%--                                             <img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reportprint"  property="district_name"/>/<bean:write name="reportprint"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'">
 --%>                                       
                                ...
                                <td width="96%" align="left" class="Cert-label">
                                    ...
                                    <logic:notEmpty name="reportprint" property="totalsubdisabilities">
                                        ...
                                        <span style="color: blue !important; "><bean:write name="reportprint"  property="totallocomotorarmlegeffectedlist" /></span>
                                         <br><logic:notEmpty name="reportprint" property="totalsubdisabilities">
                                        Sub-type of disability :<span style="color: blue !important; "><bean:write name="reportprint"  property="totalsubdisabilities" /></span>
                                        </logic:notEmpty>
                            ...
                            <td class="Cert-label">
                                ...
                                <span style="color: blue !important; "><bean:write name="reportprint"  property="physicalImpairmentPhysicalRequirementList" /></span>
        ...
        <div class="printhide" style="text-align: center;">
            ...
            <%-- <h3><a href="TerritorySelectForCertificate.do?print=certificateprint&status=finish&selectedValue=<%=selectFlow%>&personstatus=Eligible" target="_blank">
                        Print<img src="DisabilityUITG/images/print.gif"  height="25" width="25"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3> --%>
                   <button type="button" class="btn btn-primary" onclick="window.print()"><span class="glyphicon glyphicon-print"></span> <b>Print</b></button>     
