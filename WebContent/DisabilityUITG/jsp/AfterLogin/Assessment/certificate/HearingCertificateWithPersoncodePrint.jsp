...
<html:html>
    ...
    <BODY onLoad="window.print()">
        ...
        <form action="MentalCertificate.do" method="get">
            <table border="5" class="tbl_bg3" bgcolor="green">
                    ...
                    <logic:iterate id="reportprint" name="reportlist" >
                      ...
                      {  
                         ...
                         <table class="<%=classStyle %> cert-table" align="center">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table class="table_three">
                                        <tr>
                                            <td valign="top" width="4%" class="Cert-label" align="left"><li></td>
                                        <td width="96%" align="left" class="Cert-label">
                                            ...
                                            <logic:notEmpty name="reportprint" property="hearing_DB">
                                                <br>Loss of<font color="blue"> <bean:write name="reportprint"  property="hearing_DB"/>(<bean:write name="reportprint"  property="hearing_DB_In_Words"/>)</font>&nbsp;decibels in the better ear in the conversational range of frequencies .
                                            </logic:notEmpty>
                            ...
                            <tr>
                                <td valign="top" class="Cert-label" align="left"><li></td>
                            ...
                            <td class="Cert-label">
                                ...
                                <font color="blue"><bean:write name="reportprint"  property="hearingImpairmentPhysicalRequirementList" /></font>
                                <%}%>
                            </td>
                            </tr>
                            <tr>
