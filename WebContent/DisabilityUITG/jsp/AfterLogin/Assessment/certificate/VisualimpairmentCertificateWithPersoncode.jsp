...
<%--                                             <img align="right" src="./DisabilityUITG/uploadedphotos/<bean:write name="reportprint"  property="district_name"/>/<bean:write name="reportprint"  property="personcode"/>.JPG" width="100" height="100" onerror="this.src='<%=request.getContextPath()%>/images/noimage.png'"> --%>
                            ...
                            <td class="Cert-label">
                                ...
                                <span style="color: blue !important; "><bean:write name="reportprint" property="disabilityPercentage"/></span>%&nbsp;
                            ...
                            <td class="Cert-label">
                                ...
                                <span style="color: blue !important; "><bean:write name="reportprint"  property="visualImpairmentPhysicalRequirementList" /></span>
                                <%}%>
                            </td>
                            </tr>
                            <tr>
                ...
                <%--     <center>
                  ...
                  <%--   <center>
                        ...
                        <h3><a href="CertificateWithPersoncode.do?print=certificateprint&flag=true&selectedValue=<%=selectFlow%>&personcode=<bean:write name="reportprint"  property="personcode"/>" target="_blank">
                                Print<img src="DisabilityUITG/images/print.gif" height="25" width="25"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
                        <h3><a href="CertificateWithPersoncode.do?print=idcard&selectedValue=<%=selectFlow%>&certificatewithidcard=<%=certificatewithidcard%>&flag=false&personcode=<bean:write name="reportprint"  property="personcode"/>" >
                                ID CARD<img src="DisabilityUITG/images/Photo-ID.gif" height="25" width="25"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
                       <h3><a href="CertificateWithPersoncode.do?print=railwayform&certificatewithidcard=<%=certificatewithidcard%>&flag=false&personcode=<bean:write name="reportprint"  property="personcode"/>" >
                        Railway Concession<img src="DisabilityUITG/images/Photo-ID.gif" height="25" width="25"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
                    </center> --%>
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.print()"><span class="glyphicon glyphicon-print"></span> <b>Print</b></button>
                    <button type="button" class="btn btn-warning" onclick="window.location='CertificateWithPersoncode.do?print=idcard&selectedValue=<%=selectFlow%>&certificatewithidcard=<%=certificatewithidcard%>&flag=false&personcode=<bean:write name="reportprint"  property="personcode"/>'"><span class="glyphicon glyphicon-picture"></span> <b>ID Card</b></button>
