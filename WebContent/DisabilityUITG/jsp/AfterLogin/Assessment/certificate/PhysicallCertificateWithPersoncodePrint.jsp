                     ...
                     <%
                      ...
                      {  
                                    ...
                                    <td width="96%" align="left" class="Cert-label">
                                        ...
                                        <logic:notEmpty name="reportprint" property="totalsubdisabilities">
                                            ...
                                            <br><logic:notEmpty name="reportprint" property="totalsubdisabilities">
                                                Sub-type of disability :<font color="blue"><bean:write name="reportprint"  property="totalsubdisabilities" /></font>
                                            </logic:notEmpty>
                                        </logic:notEmpty>
                        ...
                        <td class="Cert-label">
                            ...
                            <font color="blue"><bean:write name="reportprint"  property="physicalImpairmentPhysicalRequirementList" /></font>
                            <%}%>
                        </td>
                        </tr>
                        <tr>
