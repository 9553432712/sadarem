...
boolean a=false;String fai=(String)request.getAttribute("fail");
//String dd=(String)session.getAttribute("Mdspecialistprefix");
        //     String ddd=(String)session.getAttribute("des");
//if(dd!=null)
          //   dd=dd.toLowerCase();
          //   if((dd!=null && dd.equalsIgnoreCase("psychologist"))||(ddd!=null && ddd.equalsIgnoreCase("yes"))){
...
%>
        <form>
            ...
            <center><font color="red"><h3> Not Eligible For Railway Concession</h3></font></center>
...
<% }else if(fai!=null && fai.equalsIgnoreCase("yes")){%>
