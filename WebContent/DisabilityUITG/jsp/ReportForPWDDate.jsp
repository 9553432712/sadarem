...
<BODY><br>
 <html:form action="statusforpwdforreports.do?getDistrictReports=getDistrictReports" 
       styleId="territoryform" onsubmit="return validate_form(this)">
   
   <table  align="center" cellspacing="1" cellpadding="8" class="innerTable" width="60%">
        <tr><td class="heading" align="center">Select The Date For Disability Report </font>
                    </td></tr>
  </table>
          <table  align="center" cellspacing="1" cellpadding="8" class="innerTable1" width="60%">
              ...
              <tr><td align="right" class="label"><font color="red"><b>*</b></font>From Date</td>
                  <td>
         <html:text property="fromdate"  readonly="true"  name="territoryform"/>
    ...
    <td align="right" class="label"><font color="red"><b>*</b></font>To Date :    
                </td><td  align="left"> </font>
 <html:text property="todate"  readonly="true"  name="territoryform"/>
 ...
 onmouseout="window.status='';return true;">
   ...
   <br>
     <center> <html:submit property="button"  value="Generate Reports"/> </center>
