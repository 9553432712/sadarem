    ...
    <body>
     ...
     <table  border="1" height="10%" align="center" cellspacing="1"
            ...
            <tr class="tbl_bg2_content" >
                ...
                <b>Mandal Name</b></font></td>
                <td align="center" bgcolor="white">
                <font  size="2" color="#660000">
                <b>Mandal Level Count</b></font></td>
            </tr>
       <% int i=0;%> 
...
<font color="blue"><b>you are in</b></font> <font color="red"> > </font>  <a href="getMandalidForEducation.do?getMandalReport=getMandalReport&districtid=<bean:write name="modify" property="districtid"/>&field=<%=fieldvalue%>&secondfield=<%=secondfieldvalue%>&FromDate=<%= fromdate %>&ToDate=<%= todate %>">
       ...
       <% }%>
                ...
                <tr class="tbl_bg2_content">
                    ...
                    <td align="center" bgcolor="white"><a href="selectmandalforeducation.do?nexxt=start&back=start&getmandalPersonalReport=getmandalPersonalReport&districtid=<bean:write name="modify" property="districtid"/>&fieldvalue=<%=fieldvalue%>&secondfieldvalue=<%=secondfieldvalue%>&mandalid=<bean:write name="modify" property="mandalid"/>&FromDate=<%= fromdate %>&ToDate=<%= todate %>&distcount=<bean:write name="modify" property="mandalcount"/>"> 
