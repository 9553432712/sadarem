                ...
                <logic:iterate id="reject" name="rejectedlist">
                        ...
                        <tr>
                            <td width="80%" valign="bottom">
                                <table>
                                    ...
                                    <tr><td class="label">ID No:</td><td class="label"><font color="blue">R<bean:write name="reject"  property="personcode"/></font>
                                    </tr>
                                    <tr>
                                        <td class="label">
                    ...
                    <center>
                        ...
                        <h3>
                            ...
                            <%-- <a href="rejectedCertificate.do?print=certificateprint&flag=true&selectedValue=<%=selectFlow%>&personcode=<bean:write name="reject"  property="personcode"/>"  target="_blank">
