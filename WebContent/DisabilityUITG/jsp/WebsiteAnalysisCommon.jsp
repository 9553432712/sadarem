<%--
    Document   : WebsiteAnalysisCommon
    Created on : Dec 10, 2010, 2:36:51 PM
    Author     : 509865
--%>
...
<html>
    <head>
        ...
        <script language="javascript" src="./DisabilityUITG/js/Mianheader.js"></script>
        ...
        <style type="text/css">
            .login_button {
                background:  url(./DisabilityUITG/images/top-tab-bg.gif) 19px;
                padding: 1px 3px 0 3px;
                height: 22px; padding-left:10px; padding-right:10px;
                font-weight: bold;
        ...
        <script type="text/javascript">
            function fadeshow(fadebgcolor,fadearray,fadeclear,dom,iebrowser)
            {
                ...
                theimages[0]=["./DisabilityUITG/images/IMG1.gif","",""]
                theimages[1]=["./DisabilityUITG/images/IMG2.gif","",""]
                theimages[2]=["./DisabilityUITG/images/IMG3.gif","",""]
                ...
                <tr>
                    <td height="445" align="center" bgcolor="#e4f5fd" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="81%" align="center" valign="top" style="padding-top:20px;">
                                    <table border="0" cellspacing="0" cellpadding="0" width="90%" align="center">
                                        <tr>
                                            <td><img src="./DisabilityUITG/images/srch-lft-top-img.png" width="11" height="28"></td>
                                            <td width="99%" background="./DisabilityUITG/images/srch-top-bg.png" class="label" align="center"><strong>Analysis Reports</strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td height="90" align="left" valign="middle" bgcolor="#f4f4f4">
                                                <table  align="left" cellspacing="1" cellpadding="5">
                                                    <tr>
                                                        <td align="left" class="labelBlue">A1 Report For Health Insurance Scheme:<br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onClick="clickOnLink(this.id);" id="niramayaReport" style="color:#000000">
                                                                A1.1 &nbsp; Niramaya Health Insurance Scheme</a>


                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="labelBlue"><br>A2 Functional Needs Reports:<br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="analysisReport" style="color:#000000">
                                                                A2.1 &nbsp; Specific Needs</a> <br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="generalNeedsReport" style="color:#000000">
                                                                A2.2 &nbsp; General Needs</a>
                                                        </td>
                                                    </tr>


                                                    <tr>
                                                        <td align="left" class="labelBlue"><br>A3 General Profile of PwDs (All Disabilities):<br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="TotalReport" style="color:#000000">
                                                                A3.1&nbsp; General Profile of Eligible PwDs (All Disabilities)</a> <br>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td align="left" class="labelBlue"><br>A4: Causes, Subtypes, Percentage of disability and functional needs (specific of disabiities)<br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            A.4.1  Locomotor Disability <br> <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="oh" style="color:#000000">
                                                                R.4.1.1:Causes, subtypes, Percentages</a> <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="ohf" style="color:#000000">
                                                                A.4.1.2: Functional needs</a>
                                                            <br><br>
                                                            <br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="lds" style="color:#000000">
                                                                A.4.1.3: Disability Sub Type Report</a>
                                                            <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            A.4.2 Visual Impairment <br> <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="vi" style="color:#000000">
                                                                A.4.2.1:Causes, Performance ability, Cateogories, Percentages </a> <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="vif" style="color:#000000">
                                                                A.4.2.2: Functional needs</a>
                                                            <br><br>
                                                            <br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="vids" style="color:#000000">
                                                                A.4.2.3: Disability Sub Type Report</a>
                                                            <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            A.4.3 Hearing Impairment <br> <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="hi" style="color:#000000">
                                                                A.4.3.1:Causes, Performance ability, Percentages </a> <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="hif" style="color:#000000">
                                                                A.4.3.2: Functional needs</a>
                                                            <br><br>
                                                            <br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="hids" style="color:#000000">
                                                                A.4.3.3: Disability Sub Type Report</a>
                                                            <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            A.4.4 Mental Retardation <br> <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="mr" style="color:#000000">
                                                                A.4.4.1:Causes, Performance ability, Percentages </a> <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="mrf" style="color:#000000">
                                                                A.4.4.2: Functional needs</a>
                                                            <br><br>
                                                            <br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="mrds" style="color:#000000">
                                                                A.4.4.3: Disability Sub Report</a>
                                                            <br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            A.4.5 Menat Illness <br> <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="mi" style="color:#000000">
                                                                A.4.5.1:Causes, Percentages </a> <br><br><br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="mif" style="color:#000000">
                                                                A.4.5.2: Functional needs</a>
                                                            <br><br>  <br>
                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                            <a href="javascript:void(0);" onclick="clickOnLink(this.id);" id="mids" style="color:#000000">
                                                                A.4.5.3: Disability Sub Type Report</a>
                                                            <br><br>
                                ...
                                <td align="center" valign="middle"><img src="./DisabilityUITG/images/analy-ico.gif" width="153" height="182"></td>
                            </tr>
                        </table>
