<%-- 
    Document   : GeneralNeedsPersonalTotalExcel
    Created on : Feb 15, 2011, 10:33:11 AM
    Author     : 509865
--%>
...
<% String fromDate = (String) request.getParameter("fD");
   ...
   getAddressList = (ArrayList) request.getAttribute("genaralPersonalTotalList");
...
<html>
    <head>
        ...
        <title>General Needs total</title>
    </head>
    <body>
        <logic:present name="genaralPersonalTotalList" scope="request">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="90%">
                        <tr>
                        <td align="center" colspan="13">Details of Persons with Disability Personal Details.</td>
                    </tr>
                   <tr>
                    ...
                    <tr>
                        <td colspan="13" align="center">
                            ...
                            <% int i = 0;%>
                            <logic:iterate id="modify" name="genaralPersonalTotalList" scope="request">
