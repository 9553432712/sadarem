<%-- 
    Document   : OtherNeedsVIExcel
    Created on : Jan 4, 2011, 9:48:20 AM
    Author     : 509865
--%>
    ...
    <body>
        <logic:present name="otherNeedsVIList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="40%">
                <tr>
                    <td align="center" colspan="3"><b>Other Needs VI Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></td>
                </tr>
                <tr>
