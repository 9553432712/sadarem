                    ...
                    <tr>
                        ...
                        <td width="50%" valign="top">
                            <table border="1" align="center" width="100%" style="height: 431px">
                                ...
                                <tr>
                                    <td class="idcardLabels"><div align="justify">  <u>NOTE</u> :- 1. This card is valid for claiming Air / Bus /  Rail  Concession and benefits  sanctioned for eligible disabled persons,  by authorities concerned / Government of 
                                            <%if ("0".equals(apflag)) {%>
                                            A.P.
                                            <%} else {%>
                                            T.S.
