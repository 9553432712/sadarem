...
<%         double totalDisability = (Double) request.getAttribute("totalDisability");
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                                <td height="530" align="center"valign="middle">
                                    ...
                                    <table border="1" cellspacing="0" cellpadding="0" width="70%" align="center" class="inputform">
                                        <tr>

                                            <th>PwD's Individual Details</th>
                                        </tr>
                                        <tr>
                                            <td width="99%" align="center"  padding-bottom:10px;">

                                                <TABLE border="0" cellSpacing="0" cellPadding="6" width="100%" align="center" >
                                                    <TR>
                                                        <TD width="30%" align="left" valign="middle" class="formbg" height="30"><strong><p>Searching Number</p></strong></TD>
                                                        <TD width="70%" align="left" valign="middle" class="formaltbg"><%= personcode%></TD>
                                                    </TR>
                                                </TABLE>

                                            </td>
                                            <%--<td  style="border-right:1px #7c7c7c solid;">&nbsp;</td>--%>
                                        </tr>
                                        <tr>
                            ...
                            <tr valign="bottom"><td><script language="javascript" src="./DisabilityUITG/js/Mainfooter.js"></script></td></tr>
                        </table>
                    </td></tr>
            </table>
