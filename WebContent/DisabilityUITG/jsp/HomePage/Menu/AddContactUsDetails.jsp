        ...
        <script type="text/javascript">
            ...
            function updateDetails() {
                if(document.forms[0].employeeName.value==""){
                    ...
                    alert("Please Enter Name");
                    return false;
                }else  if(document.forms[0].contactUsType.value=="0"){
                    document.forms[0].contactUsType.value="0";
                    document.forms[0].contactUsType.focus();
                    alert("Please Select Type Of Contact");
                    return false;
                }else  if( document.forms[0].contactCode.value=="" ){
                    document.forms[0].contactCode.value="";
                    document.forms[0].contactCode.focus();
    ...
    <body >
        <html:form action="/contactUs" >
            ...
            <table align="center" width="90%" border="0" cellspacing="1" cellpadding="0" class="inputform">
                ...
                <% if (request.getAttribute("upadate") != null) {%>
                <tr >
                ...
                <logic:notPresent name="ExistingMSG">
                    <tr >
                        <th colspan="5" align="center" valign="middle" class="formbg2" style="text-align:center;">
                            <div id="abc" > <html:button property="sub" value="Submit" onclick="insertDetails1();" styleId="insertBut"/></div>
                        </th>
                    </tr>
                </logic:notPresent >
            </table><br/>
                      ...
                      <tr>
                                            ...
                                            <logic:iterate name="contactUsList" id="row">
                                                <tr>
                                                    ...
                                                    <td class="gridbg1" align="center"><a href="./contactUs.do?mode=editDetails&type=contactUs&rowId=${row.rowid}"> <img src="<%=basePath%>DisabilityUITG/images/Edit.jpg" border="0" height="25px" width="25px" alt="Edit"/></a></td>
                                                    <td class="gridbg1" align="center">
                                                        ...
                                                        <a href="#"  style="text-decoration: none;border: 0px; border-left: 2px solid grey">&nbsp;
                                                            <img src="<%=basePath%>DisabilityUITG/images/delete.jpg" alt="Delete" border="0" onclick="disp_confirm('${row.rowid}');" height="25px" width="25px" /></a>
                                                    </td>
