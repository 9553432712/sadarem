...
<html>
 ...
 <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%">
                ...
                <tr>
                    <td   colspan="9" align="center" class="formaltbg" ><b>   SADAREM Eligible Person with Disability Personal Details Profile<br>
          ...
          <tr>
              ...
              <td align="center"  width="4%"class="formaltbg" ></td>
                           <td class="formaltbg" align="left" width="31%" rowspan="7">Number of the person with Disability(Category Wise)</td>
                               <td  align="left" class="formaltbg" width="17%">Locomotor Disability</td>
                              <td width="8%" class="formaltbg1"> ${row.r1}</td>
                              <td width="8%"class="formaltb">${row.r2}</td>
                              <td width="8%"class="formaltbg1">${row.r3}</td>
                              <td width="8%"class="formaltb">${row.r4}</td>
                              <td width="8%"class="formaltbg1">${row.r1+row.r3}</td>
                             <td width="8%" class="formaltb" >${row.s1}</td></tr>
                        <tr><td></td><td  align="left" class="formbg" width="17%">Visual Impairment</td>
                              <td width="8%"class="formbg1">${row.r5}</td>
                              <td width="8%"class="formb">${row.r6}</td>
                              <td width="8%"class="formbg1">${row.r7}</td>
                              <td width="8%"class="formb">${row.r8}</td>
                              <td width="8%"class="formbg1">${row.r5+row.r7}</td>
                       ...
                       <td  align="left" class="formbg" width="17%">Govt</td>
                        ...
                        <tr><td></td> <td  align="left" class="formbg" width="17%">Wage Employee</td>
                         ...
                         <tr><td></td> <td  align="left" class="formbg" width="17%">Total</td>
                               <td width="8%" class="formbg1"> ${row.toem}</td>
                              <td width="8%" class="formb">${row.tem}</td>
                              <td width="8%" class="formbg1">${row.toef}</td>
                              <td width="8%"class="formb">${row.tef}</td>
                              <td width="8%"class="formbg1">${row.toef+row.toem}</td>
...
<table align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%" >
                 ...
                 <td class="formaltbg" align="left" width="31%" rowspan="6">Number of the person with Disability(Marital Status Wise)</td>
                        ...
                        <tr> <td></td><td  align="left" class="formaltbg" width="17%">Widower</td>
                             <td width="8%"class="formaltbg1"> ${row.r41}</td>
                              ...
                              <td width="8%"class="formaltbg1">${row.r43+row.row.r41}</td>
                             <td width="8%" class="formaltb" >${row.s11}</td></tr>
                         <tr><td></td> <td  align="left" class="formbg" width="17%">Total</td>
                             <td width="8%"class="formbg1"> ${row.tomm}</td>
                              <td width="8%"class="formb">${row.tmm}</td>
                              <td width="8%"class="formbg1">${row.tomf}</td>
                              <td width="8%"class="formb">${row.tmf}</td>
                              <td width="8%"class="formbg1">${row.tomf+row.tomm}</td>
             ...
             <td class="formaltbg" align="left" width="31%" rowspan="8" >Number of the person with Disability(Caste Wise)</td>
                       ...
                       <td  align="left" class="formbg" width="17%">ST</td>
                        ...
                        <tr><td></td> <td  align="left" class="formbg" width="17%">Minarity</td>
                         ...
                         <tr><td></td> <td  align="left" class="formbg" width="17%">Total</td>
                               <td width="8%" class="formbg1"> ${row.tocm}</td>
                              <td width="8%" class="formb">${row.tcm}</td>
                              <td width="8%" class="formbg1">${row.tocf}</td>
                              <td width="8%"class="formb">${row.tcf}</td>
                              <td width="8%"class="formbg1">${row.tocm+row.tocf}</td>
           ...
           <tr>
            ...
            <td align="center"  width="4%" class="formaltbg"></td>
           <td class="formaltbg" align="left" width="31%"  rowspan="9">Number of the person with Disability(Religion Wise)</td>
                        ...
                        <tr><td></td> <td  align="left" class="formbg" width="17%">Christian</td>
                              ...
                              <td width="8%"class="formbg1">${row.r43}</td>
                              <td width="8%"class="formb">${row.r44}</td>
                              <td width="8%"class="formbg1">${row.r43+row.r41}</td>
                             <td width="8%" class="formb" >${row.s11}</td></tr>
                       ...
                       <tr><td></td> <td  align="left" class="formaltbg" width="17%">Budhist</td>
                              <td width="8%"class="formaltbg1"> ${row.r53}</td>
                              <td width="8%"class="formaltb">${row.r54}</td>
                              <td width="8%"class="formaltbg1">${row.r55}</td>
                              <td width="8%"class="formaltb">${row.r56}</td>
                              <td width="8%"class="formaltbg1">${row.r53+row.r55}</td>
                             <td width="8%" class="formaltb" >${row.s14}</td></tr>
                       <tr><td></td> <td  align="left" class="formbg" width="17%">Others</td>
                              <td width="8%"class="formbg1"> ${row.r57}</td>
                              <td width="8%"class="formb">${row.r58}</td>
                              <td width="8%"class="formbg1">${row.r59}</td>
                              <td width="8%"class="formb">${row.r60}</td>
                              <td width="8%"class="formbg1">${row.r59+row.r57}</td>
                             <td width="8%" class="formb" >${row.s15}</td></tr>
                              ...
                              <td width="8%"class="formaltbg1">${row.r31}</td>
                              <td width="8%"class="formaltb">${row.r32}</td>
                              <td width="8%"class="formaltbg1">${row.r31+row.r29}</td>
                             <td width="8%" class="formaltb" >${row.s8}</td></tr>
                      <tr><td></td> <td  align="left" class="formaltbg" width="17%">Total</td>
                              <td width="8%"class="formaltbg1"> ${row.torem}</td>
                              <td width="8%"class="formaltb">${row.trem}</td>
                              <td width="8%"class="formaltbg1">${row.toref}</td>
                              <td width="8%"class="formaltb">${row.tref}</td>
                              <td width="8%"class="formaltbg1">${row.torem+row.toref}</td>
                             <td width="8%" class="formaltb" >${row.e1}</td></tr>
          ...
          <tr>
            ...
            <td ></td>
                        ...
                        <tr> <td></td>  <td  align="left" class="formaltbg" width="17%"> Total</td>
                               <td width="8%" class="formaltbg1"> ${row.toagm}</td>
                              <td width="8%" class="formaltb">${row.tagm}</td>
                              <td width="8%"class="formaltbg1">${row.toagf}</td>
                              <td width="8%"class="formaltb">${row.tagf}</td>
                              <td width="8%"class="formaltbg1">${row.toagm+row.toagf}</td>
  ...
  <td  align="left" class="formbg" width="17%">Yes</td>
                       ...
                       <tr>  <td style="border-left:0px;border-right: 0px;border-bottom: 0px;border-top: 0px;" align="center"  width="4%" class="formaltbg" >9</td>
                        ...
                        <tr><td></td> <td  align="left" class="formbg" width="17%">Not Recorded</td>
                             ...
                             <td width="8%" class="formb" >${row.s13}</td></tr>
                         <tr> <td></td>  <td  align="left" class="formaltbg" width="17%"> Total</td>
                               <td width="8%" class="formaltbg1"> ${row.totpm}</td>
                              <td width="8%" class="formaltb">${row.tpm}</td>
                              <td width="8%"class="formaltbg1">${row.totpf}</td>
                              <td width="8%"class="formaltb">${row.tpf}</td>
                              <td width="8%"class="formaltbg1">${row.totpm+row.totpf}</td>
                             <td width="8%" class="formaltb" >${row.s11+row.s12+row.s13}</td></tr>
 ...
 <table align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%" >
           ...
           <tr>
            ...
            <td align="center"  width="4%" class="formaltbg"></td>
           <td class="formaltbg" align="left" width="31%"  rowspan="5">Number of the person with Disability(RationCard Wise)</td>
             <td  align="left" class="formbg" width="17%">White</td>
                             ...
                             <tr><td></td> <td  align="left" class="formaltbg" width="17%">Pink</td>
                              <td width="8%"class="formaltbg1"> ${row.r61}</td>
                              <td width="8%"class="formaltb">${row.r62}</td>
                              <td width="8%"class="formaltbg1">${row.r63}</td>
                              <td width="8%"class="formaltb">${row.r64}</td>
                              <td width="8%"class="formaltbg1">${row.r61+row.r63}</td>
                             ...
                             <tr><td style="border-left:0px;border-right: 0px;border-bottom: 0px;border-top: 0px;" align="center"  width="4%" class="formaltbg" >10</td><td  align="left" class="formbg" width="17%">AAY</td>
                              <td width="8%"class="formbg1"> ${row.a1}</td>
                              <td width="8%"class="formb">${row.a2}</td>
                              <td width="8%"class="formbg1">${row.a3}</td>
                              <td width="8%"class="formb">${row.a4}</td>
                              <td width="8%"class="formbg1">${row.a1+row.a3}</td>
                             ...
                             <td width="8%" class="formaltb" >${row.s14}</td></tr>
                              ...
                              <tr><td></td> <td  align="left" class="formbg" width="17%">Total</td>
                              <td width="8%"class="formbg1"> ${row.totrm}</td>
                              <td width="8%"class="formb">${row.trm}</td>
                              <td width="8%"class="formbg1">${row.totrf}</td>
                              <td width="8%"class="formb">${row.trf}</td>
                              <td width="8%"class="formbg1">${row.totrm+row.totrf}</td>
