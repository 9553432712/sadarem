<%-- 
    Document   : AssistiveDevicesMR
    Created on : Jan 4, 2011, 12:09:23 PM
    Author     : 509865
--%>
                ...
                <td>
                    <logic:present name="assistiveDevicesMRList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="6">Assistive Devices MR Report</th></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=learningMaterialsTotal %></td>
                                <td class="formhdbg" align="center"><%=specialSoftwareTotal %></td>
                                <td class="formhdbg" align="center"><%=toysTotal %></td>
                                <td class="formhdbg" align="center"><%= total%></td>
                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("assistiveDevicesMRList", assistiveDevicesMRList);
                            %>
                            <a href="AssistiveDevicesMRExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                            <a href="AssistiveDevicesMRPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
