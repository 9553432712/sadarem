...
<html:html>
    ...
    <html:form  action="TotalReport.do"  method="post" >
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="90%" align="center" id="grid">
            <tr>
                ...
                <td width="99%" background="./DisabilityUITG/images/srch-top-bg.png" class="label" align="center"><strong>----------SADAREM Eligible Person with Disability Personal Details Profile---
 </strong></td>
            ...
            <tr>
                <td height="40" align="left" valign="middle" bgcolor="#f4f4f4">
                    <table  align="center" cellspacing="1" cellpadding="5" width="100%" class="table">
                        <tr>
                        ...
                        <tr>
                          <!--  <td class="label" valign="middle" colspan="2">Caste<font color="red"><b>*</b>
