<%-- 
    Document   : MedicalInterventionMR
    Created on : Jan 4, 2011, 11:33:15 AM
    Author     : 509865
--%>
                ...
                <td height="445" align="center" valign="top">
                    ...
                    <logic:present name="medicalInterventionMRList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="12">Medical Intervention MR Report</th></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=speechTherapyBelowThreeYearsMRTotal%></td>
                                <td class="formhdbg" align="center"><%=speechTherapyAboveThreeYearsMRTotal%></td>
                                <td class="formhdbg" align="center"><%=behaviourModificationPsychotherapyBelowTotal%></td>
                                <td class="formhdbg" align="center"><%=behaviourModificationPsychotherapyAboveTotal%></td>
                                <td class="formhdbg" align="center"><%=sensoryIntegrationCognitiveDevelopmentTotal%></td>
                                <td class="formhdbg" align="center"><%=cognitiveBehaviourTherapyTotal%></td>
                                <td class="formhdbg" align="center"><%=parentFamilyInterventionTotal%></td>
                                <td class="formhdbg" align="center"><%=physiotherapyMRTotal%></td>
                                <td class="formhdbg" align="center"><%=occupationalTherapyMRTotal%></td>
                                <td class="formhdbg" align="center"><%= total%></td>
                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("medicalInterventionMRList", medicalInterventionMRList);
                            %>
                            <a href="medicalInterventionMRExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                            <a href="medicalInterventionMRPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
