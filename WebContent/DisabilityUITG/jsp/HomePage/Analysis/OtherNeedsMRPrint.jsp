<%-- 
    Document   : OtherNeedsMRPrint
    Created on : Feb 17, 2011, 10:02:20 AM
    Author     : 509865
--%>
...
<%          String fromdate = (String) request.getParameter("fdate");
            ...
            otherNeedsMRList = (ArrayList) session.getAttribute("otherNeedsMRList");
...
<html>
    <head>
        ...
        <title>Other Needs MR</title>
    </head>
    <body  onLoad="window.print()">
        <logic:present name="otherNeedsMRList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="40%">
                ...
                <tr>
                    <th align="center" colspan="3"><b>Other Needs MR Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
                ...
                <% int i = 0;%>
                <logic:iterate id="modify" name="otherNeedsMRList" scope="session">
                    <tr>
                        ...
                        <logic:notEmpty name="modify" property="habitationName">
                            ...
                            <td align="center"><bean:write name="modify" property="otherNeedsMR"/></td>
                    </tr>
                </logic:iterate>
                <tr>
                    <td colspan="2" align="center"><b>Total</b></td>
                    <td align="center"><b><%=otherNeedsMRTotal %></b></td>
                </tr>
            </table><br>
        </logic:present>
    </body>
