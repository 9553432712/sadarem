<%-- 
    Document   : MedicalInterventionMI
    Created on : Jan 4, 2011, 12:52:00 PM
    Author     : 509865
--%>
                ...
                <td height="445" align="center"  valign="top">
                    ...
                    <logic:present name="medicalInterventionMIList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="7">Medical Intervention MI Report</th></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=psychotherapyBehaviourBelowThreeYearsMITotal %></td>
                                <td class="formhdbg" align="center"><%=psychotherapyBehaviourAboveThreeYearsMITotal %></td>
                                <td class="formhdbg" align="center"><%=surgeryMITotal %></td>
                                <td class="formhdbg" align="center"><%=admissionPsychiatricTotal %></td>
                                <td class="formhdbg" align="center"><%= total%></td>
                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("medicalInterventionMIList", medicalInterventionMIList);
                            %>
                            <a href="medicalInterventionMIExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                            <a href="medicalInterventionMIPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
