<%-- 
    Document   : AssistiveDevicesMobility
    Created on : Dec 27, 2010, 9:36:54 AM
    Author     : 509865
--%>
                ...
                <td height="445" align="center"  valign="top">
                    ...
                    <logic:present name="mobilityList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="9">Assistive Devices Mobility Aids Report</th></tr>
                            <tr>
                            ...
                            <logic:iterate id="modify" name="mobilityList" scope="request">
                                ...
                                <tr>
                                    ...
                                    <logic:notEmpty name="modify" property="districtName">
                                        <td  class="formbg" align="center"><bean:write name="modify" property="districtName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="mandalName">
                                        <td  class="formbg" align="center"><bean:write name="modify" property="mandalName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="villageName">
                                        <td  class="formbg" align="center"><bean:write name="modify" property="villageName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="habitationName">
                                        <td  class="formbg" align="center"><bean:write name="modify" property="habitationName"/></td>
                                    </logic:notEmpty>
                                ...
                                <tr>
                                    ...
                                    <logic:notEmpty name="modify" property="districtName">
                                        <td  class="formaltbg" align="center"><bean:write name="modify" property="districtName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="mandalName">
                                        <td  class="formaltbg" align="center"><bean:write name="modify" property="mandalName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="villageName">
                                        <td  class="formaltbg" align="center"><bean:write name="modify" property="villageName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="habitationName">
                                        <td  class="formaltbg" align="center"><bean:write name="modify" property="habitationName"/></td>
                                    </logic:notEmpty>
                        ...
                        <table align="center">
                            <%
                                        session.setAttribute("mobilityList", mobilityList);
                            %>
                            <a href="assistiveMobilityExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                            <a href="assistiveMobilityPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
