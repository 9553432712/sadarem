<%-- 
    Document   : NirmayaReportDate
    Created on : Sep 17, 2010, 11:44:46 AM
    Author     : 509865
--%>
...
<html:html>
    ...
    <BODY bgcolor="#F2f0e6">
        ...
        <html:form action="getDistrictidForNiramaya.do?getDistrictReportNiramaya=getDistrictReportNiramaya"
                   styleId="surgeryreportform" onsubmit="return validate_form(this)">
            <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2_content"><br>
                <tr  align="center" bgcolor="white">
                    <td bgcolor="white"><font face="vardana" color="#660000" size="4">
                            <b>Select The Date For Niramaya Report</b> </font>
                    </td>
                    <td  bgcolor="white">
                        <font color="red"><b>*</b></font><font size="2"face="vardana" color="#660000"><b>From Date : </b></font>
                    </td>
                    <td  bgcolor="white">
                ...
                <tr bgcolor="white">
                    <td align="center" colspan="5" bgcolor="white"><html:submit property="button"  value="Generate Reports"/></td>
                </tr></table>
