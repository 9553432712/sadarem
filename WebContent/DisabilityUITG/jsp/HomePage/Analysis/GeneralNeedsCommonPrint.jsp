<%-- 
    Document   : GeneralNeedsCommonPrint
    Created on : Feb 14, 2011, 10:45:20 AM
    Author     : 509865
--%>
...
<%          String fromdate = (String) request.getParameter("fdate");
            ...
            commonGeneralNeedsList = (ArrayList) session.getAttribute("commonGeneralNeedsList");
...
<html>
    <head>
        ...
        <title>Common General Needs Print</title>
    </head>
    <body  onLoad="window.print()">
        <logic:present name="commonGeneralNeedsList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                <tr>
                    <th align="center" colspan="12"><b>General Needs Common Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
                    <th align="center" colspan="12">
                        ...
                        <% }%>
                        &nbsp; Type of Disability: <font color="blue"><%=typeOfDisability%></font>
                    </th>
                </tr>
                <tr>
                ...
                <% int i = 0;%>
                <logic:iterate id="modify" name="commonGeneralNeedsList" scope="session">
                    <tr>
                        <td><%=++i%></td>
