<%-- 
    Document   : MedicalInterventionMIPrint
    Created on : Feb 17, 2011, 10:10:24 AM
    Author     : 509865
--%>
    ...
    <body  onLoad="window.print()">
        <logic:present name="medicalInterventionMIList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                <tr>
                    <th align="center" colspan="7"><img src="DisabilityUITG/images/Banner.jpg"/></th>
                </tr>
                <tr>
                    <th align="center" colspan="7"><b>Medical Intervention MI Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
