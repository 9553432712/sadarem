<%-- 
    Document   : AssistiveDevicesHI
    Created on : Jan 4, 2011, 10:26:15 AM
    Author     : 509865
--%>
                ...
                <td height="445" align="center"  valign="top">
                    ...
                    <logic:present name="assistiveDevicesHIList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="10">Assistive Devices HI Report</th></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=lowIntensitySCordTotal %></td>
                                <td class="formhdbg" align="center"><%=lowIntensityVCordTotal %></td>
                                <td class="formhdbg" align="center"><%=moderateIntensitySCordTotal %></td>
                                <td class="formhdbg" align="center"><%=moderateIntensityVCordTotal %></td>
                                <td class="formhdbg" align="center"><%=highIntensitySCordTotal %></td>
                                <td class="formhdbg" align="center"><%=highIntensityVCordTotal %></td>
                                <td class="formhdbg" align="center"><%=implantableHearingAidTotal %></td>
                                <td class="formhdbg" align="center"><%= total%></td>
                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("assistiveDevicesHIList", assistiveDevicesHIList);
                            %>
                            <a href="AssistiveDevicesHIExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                            <a href="AssistiveDevicesHIPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
