<%-- 
    Document   : MedicalInterventionVIPrint
    Created on : Feb 17, 2011, 10:11:45 AM
    Author     : 509865
--%>
    ...
    <body  onLoad="window.print()">
        <logic:present name="medicalInterventionVIList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="40%">
                ...
                <tr>
                    <th align="center" colspan="3"><b>Medical Intervention VI Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <% }%>
                    <th align="center"><b>Surgery</b></th>
                </tr>
