...
<%          String fromdate = (String) request.getParameter("fromdate");
            ...
            Iterator iter = commonGeneralNeedsList.iterator();
            while (iter.hasNext()) {
                    ...
                    <td height="445" align="center"  valign="top">
                           ...
                           <p>Select General Needs Report Details</p>
                            <tr>
                                <td height="40" align="left" valign="middle" bgcolor="#f4f4f4">
                                    <table  align="center" cellspacing="1" cellpadding="10" width="100%" id="grid">
                                        <tr>
                        ...
                        <logic:present name="commonGeneralNeedsList" scope="request">
                            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                                <tr><th class="formhdbg" align="center" colspan="12">General Needs Report</th></tr>
                                <tr>
                            ...
                            <table align="center">
                                <%
                                            session.setAttribute("commonGeneralNeedsList", commonGeneralNeedsList);
                                %>
                                <a href="commonGeneralNeedsExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>&D=<%=typeOfDisability%>" target="_blank">
                                    Export To Excel <img src="DisabilityUITG/images/excel.jpg" height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                                <a href="commonGeneralNeedsPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>&D=<%=typeOfDisability%>" target="_blank">
