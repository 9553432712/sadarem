<%-- 
    Document   : OtherNeedsMIPrint
    Created on : Feb 17, 2011, 10:01:34 AM
    Author     : 509865
--%>
    ...
    <body  onLoad="window.print()">
        <logic:present name="otherNeedsMIList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="40%">
                <tr>
                    <th align="center" colspan="3"><img src="DisabilityUITG/images/Banner.jpg"/></th>
                </tr>
                <tr>
                    <th align="center" colspan="3"><b>Other Needs MI Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
