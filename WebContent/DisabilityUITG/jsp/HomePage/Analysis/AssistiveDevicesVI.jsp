<%-- 
    Document   : AssistiveDevicesVI
    Created on : Jan 4, 2011, 9:07:40 AM
    Author     : 509865
--%>
                ...
                <td height="445" align="center"  valign="top">
                    ...
                    <logic:present name="assistiveDevicesVIList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="11">Assistive Devices VI Report</th></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=whiteCaneBlindStickTotal %></td>
                                <td class="formhdbg" align="center"><%=brailleEquipmentsTotal %></td>
                                <td class="formhdbg" align="center"><%=arithmeticFramesAbacusTotal %></td>
                                <td class="formhdbg" align="center"><%=lowVisionAidsSpectaclesMagnifiersTotal %></td>
                                <td class="formhdbg" align="center"><%=speechSynthesizerTotal %></td>
                                <td class="formhdbg" align="center"><%=brailleShortHandMachinesWritersTotal %></td>
                                <td class="formhdbg" align="center"><%=talkingWatchCalculatorTotal %></td>
                                <td class="formhdbg" align="center"><%=viADLEquipmentTotal %></td>
                                <td class="formhdbg" align="center"><%= total%></td>
                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("assistiveDevicesVIList", assistiveDevicesVIList);
                            %>
                            <a href="AssistiveDevicesVIExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;

                            <a href="AssistiveDevicesVIPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
