<%-- 
    Document   : GeneralNeedsMultiplePrint
    Created on : Feb 14, 2011, 11:05:08 AM
    Author     : 509865
--%>
    ...
    <body  onLoad="window.print()">
        <logic:present name="multipleGeneralNeedsList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                <tr>
                    <th  align="center" colspan="14"><b>Multiple Disability General Needs Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
