<%-- 
    Document   : OtherNeedsHI
    Created on : Jan 4, 2011, 10:54:24 AM
    Author     : 509865
--%>
...
<html:html>
    ...
    <html:form action="functionalNeed.do?getFunctionalNeedReport=getFunctionalNeedReport" method="post" onsubmit="return selectedNames(),validate_form(this)"   >
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="10" align="center">
            <tr><td><p>Select Report Details</p>
                </td></tr>
            <tr>
                <td height="445" align="center"  valign="top">
                    ...
                    <logic:present name="otherNeedsHIList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="40%">
                            <tr><th class="formhdbg" align="center" colspan="3">Other Needs HI Report</th></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=otherNeedsHITotal %></td>

                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("otherNeedsHIList", otherNeedsHIList);
                            %>
                            <a href="otherNeedsHIExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                           <a href="otherNeedsHIPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
