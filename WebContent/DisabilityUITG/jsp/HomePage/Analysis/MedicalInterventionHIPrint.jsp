<%-- 
    Document   : MedicalInterventionHIPrint
    Created on : Feb 17, 2011, 10:11:23 AM
    Author     : 509865
--%>
    ...
    <body  onLoad="window.print()">
        <logic:present name="medicalInterventionHIList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                <tr>
                    <th align="center" colspan="8"><b>Medical Intervention HI Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
