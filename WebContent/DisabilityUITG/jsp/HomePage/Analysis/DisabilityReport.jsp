<%-- 
    Document   :Disability Report
    Created on : Oct 20, 2011, 2:22:50 PM
    Author     : 509862
--%>
    ...
    <body onload="ShowDate()">
        ...
        <html:form  action="<%=ur%>"  method="post" >
            ...
            <table border="1" cellspacing="0" cellpadding="0" width="90%" class="inputform" align="center">
                <tr> <th colspan="6">SADAREM Eligible Person with Disability Personal Details Profile</th> </tr>
                <tr>
                    <td >
                        <table  align="center" cellspacing="0" border="0" cellpadding="5" width="100%">
                            <tr>
                ...
                <tr>  <th ><html:button property="but" onclick="getDetails()" value="Submit"/></tr>
            </table>
