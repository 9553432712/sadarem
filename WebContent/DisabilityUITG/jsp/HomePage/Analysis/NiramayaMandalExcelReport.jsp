<%-- 
    Document   : NiramayaMandalExcelReport
    Created on : Sep 23, 2010, 11:42:37 AM
    Author     : 509865
--%>
...
<html:html>
    ...
    <body><br>
            ...
            <tr align="center"  width="100%">
                <td colspan="5"><b><font color="blue">Excel sheet for Mandalwise Niramaya Report</font></b></td>
            </tr>
           <tr class="tbl_bg2_content_hdr_new" valign="middle">
                ...
                <% int i=0;%>
                <logic:notEmpty name="mandalList" scope="session" >
                <logic:iterate id="modify" name="mandalList" scope="session">
                    <tr class="tbl_bg2_content_hdr_new" valign="middle">
                        <td class="cellheader"><%=++i%> </td>
                        <td><bean:write name="modify" property="mandalname"/></td>
                        <td>&nbsp;<bean:write name="modify" property="mandalMRCount"/></td>
                        <td>&nbsp;<bean:write name="modify" property="mandalCEREBRALPALSYCount"/></td>
                        <td>&nbsp;<bean:write name="modify" property="mandalMULTIPLECount"/></td>
                    </tr>
