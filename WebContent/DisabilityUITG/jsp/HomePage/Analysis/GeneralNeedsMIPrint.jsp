<%-- 
    Document   : GeneralNeedsMIPrint
    Created on : Feb 14, 2011, 10:55:43 AM
    Author     : 509865
--%>
...
<html>
    <head>
        ...
        <title>MI General Needs Print</title>
    </head>
    <body  onLoad="window.print()">
        <logic:present name="miGeneralNeedsList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                <tr>
                    <th align="center" colspan="13"><b>Mental Illness General Needs Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th rowspan="2">Manager to Take Care Properties</th>
