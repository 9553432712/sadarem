      ...
      <logic:iterate name="Totalcount" id="row">
          ...
          <table  align="center" cellspacing="0" border="0" cellpadding="0" class="innerTable" width="90%">
            ...
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%">
                ...
                <tr>
                    <td align="center"> <img src="DisabilityUITG/images/Banner.jpg"/></td>
                </tr>
                <tr>
                    <td align="center" class="formaltbg" ><b>   SADAREM Eligible Person with Disability Personal Details Profile<br>
...
<!--
 ...
 <table align="center" cellspacing="0" border="1" cellpadding="4"  class="innerTable" width="90%" >
                       <tr>

                           <td align="center"  width="4%"class="formaltbg" >&nbsp;</td>
                           <td  align="left" width="48%"class="formaltbg">&nbsp;</td>
                           <td width="48%">
                               <table border="1" width ="100%">
                                   <tr>
                              <td width="16%" class="formaltbg1"> Male</td>
                              <td width="16%" class="formaltbg">Female </td>
                              <td width="16%" class="formaltbg1">Total</td>

                          </table></td></tr>
                        <tr>

                           <td align="center"  width="4%"class="formaltbg" >S.No</td>
                           <td  align="left" width="48%"class="formaltbg">Disability type</td>
                           <td width="48%">
                               <table border="1" width ="100%">
                                   <tr>
                              <td width="8%" class="formaltbg1"> No</td>
                              <td width="8%" class="formaltbg">% </td>
                              <td width="8%" class="formaltbg1">No</td>
                              <td width="8%" class="formaltbg">%</td>
                              <td width="8%" class="formaltbg1">No</td>
                             <td width="8%" class="formaltbg" >%</td></tr></table></td>
                        </tr>
...
-->
 <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%">
                    ...
                    <tr>
                                 <td align="center" class="formhdbg" colspan="9"></td>
                             ...
                             <tr>
                                 <td class="formhdbg" align="center" width="4">1</td>
                                <td class="formhdbg" align="left" width="31%">Number of the Person with Disability (As per the SADAREM)</td>
                                <td class="formhdbg"  align="left" width="17%">TotalCategories</td>
                             ...
                             <td width="8%" class="formbg" >${row.Tmaleper+row.Tfemaleper}</td>
                            </tr>
 ...
 <!--  <table align="center" cellspacing="1" border="1" cellpadding="4"  class="innerTable" width="100%" >
                       <tr>
                           ...
                           <td width="65%">
                               <table border="1" width ="100%">
                                   <tr>
                                       <td  align="left" class="formaltbg" width="17%">Total</td>
                              <td width="8%" class="formbg">${row.Tmale}</td>
                              <td width="8%"class="formbg">${row.Tmaleper} </td>
                              <td width="8%" class="formbg">${row.Tfemale}</td>
                              <td width="8%" class="formbg">${row.Tfemaleper}</td>
  ...
  <table align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="100%" >
          ...
          <tr>
           ...
           <tr>
                           ...
                           <td class="formaltbg" align="left" width="48%">Number of the peson with Disability having Consanguineous Marriage Parents
</td>
