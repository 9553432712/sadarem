<%-- 
    Document   : OtherNeedsOHPrint
    Created on : Feb 17, 2011, 10:05:03 AM
    Author     : 509865
--%>
...
<%          String fromdate = (String) request.getParameter("fdate");
            ...
            ArrayList otherNeedsOHList = new ArrayList();
            otherNeedsOHList = (ArrayList) session.getAttribute("otherNeedsOHList");
            int otherNeedsTotal = 0;
            Iterator iter = otherNeedsOHList.iterator();
            while (iter.hasNext()) {
...
<html>
    <head>
        ...
        <title>Other Needs OH</title>
    </head>
    <body  onLoad="window.print()">
        <logic:present name="otherNeedsOHList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="40%">
                <tr>
                    <th align="center" colspan="3"><b>Other Needs Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
                ...
                <% int i = 0;%>
                <logic:iterate id="modify" name="otherNeedsOHList" scope="session">
                    <tr>
                        ...
                        <logic:notEmpty name="modify" property="habitationName">
                            ...
                            <td align="center"><bean:write name="modify" property="otherNeeds"/></td>
                    </tr>
                </logic:iterate>
                <tr>
                    <td colspan="2" align="center"><b>Total</b></td>
                    <td align="center"><b><%=otherNeedsTotal %></b></td>
                </tr>
            </table><br>
        </logic:present>
    </body>
