<%--
    Document   : GeneralNeedsCommon
    Created on : Jan 5, 2011, 5:04:17 PM
    Author     : 509865
--%>
                ...
                <td height="445" align="center"  valign="top">
                    ...
                    <logic:present name="mrGeneralNeedsList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="13">General Needs Mental Retardation Report</th></tr>
                            <tr>
                        ...
                        <table align="center">
                            <%
                                        session.setAttribute("mrGeneralNeedsList", mrGeneralNeedsList);
                            %>
                            <a href="MRGeneralNeedsExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                            <a href="MRGeneralNeedsPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
