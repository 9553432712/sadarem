<%-- 
    Document   : OtherNeedsVIPrint
    Created on : Feb 17, 2011, 10:04:39 AM
    Author     : 509865
--%>
...
<%          String fromdate = (String) request.getParameter("fdate");
            ...
            otherNeedsVIList = (ArrayList) session.getAttribute("otherNeedsVIList");
...
<html>
    <head>
        ...
        <title>Other Needs VI</title>
    </head>
    <body  onLoad="window.print()">
        <logic:present name="otherNeedsVIList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="40%">
                
                <tr>
                    <th align="center" colspan="3"><b>Other Needs VI Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></th>
                </tr>
                <tr>
                ...
                <% int i = 0;%>
                <logic:iterate id="modify" name="otherNeedsVIList" scope="session">
                    <tr>
                        ...
                        <logic:notEmpty name="modify" property="habitationName">
                            ...
                            <td align="center"><bean:write name="modify" property="otherNeedsVI"/></td>
                    </tr>
                </logic:iterate>
                <tr>
                    <td colspan="2" align="center"><b>Total</b></td>
                    <td align="center"><b><%=otherNeedsVITotal %></b></td>
                </tr>
            </table><br>
        </logic:present>
    </body>
