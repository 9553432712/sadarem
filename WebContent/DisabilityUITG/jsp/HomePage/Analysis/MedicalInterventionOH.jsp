<%-- 
    Document   : MedicalIntervention
    Created on : Dec 20, 2010, 4:01:50 PM
    Author     : 509865
--%>
                ...
                <td  align="center"  valign="top">
                    ...
                    <logic:present name="medicalInterventionList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><th class="formhdbg" align="center" colspan="8">Medical Intervention Report</th></tr>
                            <tr>
                                ...
                                <% }%>
                                <th align="center" class="formhdbg" colspan="2">Physiotherapy</th>
                                <th align="center" class="formhdbg" colspan="2">Occupational Therapy</th>
                            ...
                            <logic:iterate id="modify" name="medicalInterventionList" scope="request">
                                ...
                                <tr>
                                    ...
                                    <logic:notEmpty name="modify" property="districtName">
                                        <td  class="formbg" align="left"><bean:write name="modify" property="districtName"/></td>
                                    </logic:notEmpty>
                                ...
                                <tr>
                                    ...
                                    <logic:notEmpty name="modify" property="districtName">
                                        <td  class="formaltbg" align="left"><bean:write name="modify" property="districtName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="mandalName">
                                        <td  class="formaltbg" align="left"><bean:write name="modify" property="mandalName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="villageName">
                                        <td  class="formaltbg" align="left"><bean:write name="modify" property="villageName"/></td>
                                    </logic:notEmpty>
                                    <logic:notEmpty name="modify" property="habitationName">
                                        <td  class="formaltbg" align="left"><bean:write name="modify" property="habitationName"/></td>
                                    </logic:notEmpty>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%= phyBelow3Total%></td>
                                <td class="formhdbg" align="center"><%= phyAbove3Total%></td>
                                <td class="formhdbg" align="center"><%= otBelow3Total%></td>
                                <td class="formhdbg" align="center"><%= otAbove3Total%></td>
                                <td class="formhdbg" align="center"><%= surgeryTotal%></td>
                                <td class="formhdbg" align="center"><%= total%></td>
                            </tr>
                        </table><br>
                        <table align="center">
                            <%
                                        session.setAttribute("medicalInterventionOHList", medicalInterventionList);
                            %>
                            <a href="medicalInterventionOHExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                           <a href="medicalInterventionOHPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
