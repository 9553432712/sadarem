            ...
            <tr>
                <td height="445" align="center" bgcolor="#e4f5fd" valign="top">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="90%" align="center">
                        <br/><p>Select General Needs Report Details</p>
                        <tr>
                            <td height="40" align="left" valign="middle" >
                                <table  align="center" cellspacing="1" cellpadding="10" id="grid" width="100%">
                                    <tr>
                    ...
                    <logic:present name="multipleGeneralNeedsList" scope="request">
                        <table  align="center" cellspacing="1" border="1" cellpadding="4" class="table" width="90%">
                            <tr><td class="formhdbg" align="center" colspan="14">Multiple Disability General Needs Report</td></tr>
                            <tr>
                                <td align="center" class="formhdbg" rowspan=2>S.No</td>
                                <% if (village_id != null && !village_id.equals("0")) {%>
                                <td class="formhdbg" rowspan=2 align="center">Habitation</td>
                                <% } else if (village_id != null) {%>
                                <td class="formhdbg" rowspan="2" align="center">Village</td>
                                <% } else if (mandal_id != null) {%>
                                <td class="formhdbg" rowspan="2" align="center">Mandal</td>
                                <% } else if (district_id != null) {%>
                                <td class="formhdbg" rowspan="2" align="center">District</td>
                                <% }%>
                                <td align="center" class="formhdbg" colspan="4">Education Services</td>
                                <td align="center" class="formhdbg" colspan="2">Vocational Training</td>
                                <td align="center" class="formhdbg" colspan="2">Counseling & Guidance</td>
                                <td align="center" class="formhdbg" rowspan="2">Legal Gurdian</td>
                                <td align="center" class="formhdbg" rowspan="2">Manager to Take Care Properties</td>
                                <td align="center" class="formhdbg" rowspan="2">Other General Needs</td>
                                <td align="center" class="formhdbg" rowspan="2">Total</td>
                            </tr>
                            <tr>
                                <td class="formhdbg" align="center">Early Education Service(<5Yrs)</td>
                                <td class="formhdbg" align="center">Home Based</td>
                                <td class="formhdbg" align="center">Special Education</td>
                                <td class="formhdbg" align="center">Inclusive Education</td>
                                <td class="formhdbg" align="center">Employment in public/ Pvt.Sector</td>
                                <td class="formhdbg" align="center">Self Employment</td>
                                <td class="formhdbg" align="center">Individual</td>
                                <td class="formhdbg" align="center">Family</td>
                            </tr>
                            <% int i = 0;%>
                            ...
                            <tr>
                                ...
                                <td class="formhdbg" align="center"><%=legalGurdianTotal %></td>
                        ...
                        <table align="center">
                            <%
                                        session.setAttribute("multipleGeneralNeedsList", multipleGeneralNeedsList);
                            %>
                            <a href="MultipleGeneralNeedsExcel.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
                                Export To Excel <img src="DisabilityUITG/images/excel.jpg"
                                                     height="25" width="25"/></a> &nbsp; &nbsp; &nbsp;
                                <a href="MultipleGeneralNeedsPrint.xls?fdate=<%=fromdate%>&todate=<%=todate%>&dName=<%=dName%>&mName=<%=mName%>&vName=<%=vName%>&hName=<%=hName%>&dID=<%=district_id%>&mID=<%=mandal_id%>&vID=<%=village_id%>&hID=<%=habitation_id%>" target="_blank">
