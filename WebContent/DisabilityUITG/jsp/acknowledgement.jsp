...
<%
            ...
            String renualFormId = (String) request.getAttribute("RenualFormId");
            String pId = (String)request.getAttribute("pId");
            String reesId = (String)request.getAttribute("reesId");

          
            //String change = "Change";

           // String pId1 = (String)request.getAttribute("pId1");
//
 


           //int name = pId1.indexOf('1');
                            ...
                            <tr>
                                <td colspan="3" bgcolor="#f4f4f4" style="border:1px #7c7c7c solid;">
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="1" width="100%" align="center">
                                        <tr class="label">
                                            <td class="formhdbg" align="center" colspan="2"> <b>ACKNOWLEDGEMENT FOR GRIEVANCES.</b></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="50%" class="formhdbg"><font size="2">SADAREM ID:</font>&nbsp;&nbsp;<font color="white" size="2"><%=pwdRequestDTO.getReciptPersonCode()%></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td align="left" width="50%" class="formhdbg"><font size="2">Registration Number:</font>
                                                <font color="white" size="2"><%=pwdRequestDTO.getReciptRequestId()%></font>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="left" class="label" style="line-height:20px;padding:5px">
                                                <br/><strong>
                                                    <p>This is acknowledged that
                                                        ...
                                                        &nbsp;is applied for the  &nbsp; <font color="blue"><%=pwdRequestDTO.getReciptRequestTypeName()%></font>
                                                        <%if(pId !=null && pId.equals("10") || pId !=null  && pId.equals("8")){%>&nbsp;<%}%><%else if(renualFormId !=null && renualFormId.equals("9")){%>&nbsp;<%}%><%else if(reesId !=null && reesId.equals("7")){%>&nbsp;<%}%><%else{%>&nbsp;Change<%}%>
                                                       on &nbsp;<font color="blue"><%=pwdRequestDTO.getReciptRegisteratedDate()%>.</font>&nbsp;
                                                    </p></strong>
                                            </td>
                                        </tr>
                                        <tr>
