...
<html:html>
    <logic:notEmpty name="lowerExtremityBean" scope="request">  
        ...
        <tr class="tbl_bg2_content_hdr">
            <th align="center"><font size="4">1.&nbsp;&nbsp;Lower EXTREMITY fghfghfgh</font></th>
        </tr>
        ...
        <logic:equal name="lowerExtremityBean" property="checkforrom" value="true"> 
            ...
            <tr class="tbl_bg2_content">
                ...
                <td align="left" rowspan="3"> <logic:notEqual scope="request" property="romhiptotalrightcalculation" value="" name="lowerExtremityBean"><bean:write property="romhiptotalrightcalculation" name="lowerExtremityBean"  /></td></logic:notEqual>
                <td align="left" rowspan="3"> <logic:notEqual scope="request" property="romhiptotalleftcalculation" value="" name="lowerExtremityBean"><bean:write property="romhiptotalleftcalculation" name="lowerExtremityBean"  /></td></logic:notEqual>
            ...
            <tr class="tbl_bg2_content">
                ...
                <td align="left" rowspan="3"> <logic:notEqual scope="request" property="romankletotalrightcalulation" value="" name="lowerExtremityBean"><bean:write property="romankletotalrightcalulation" name="lowerExtremityBean"  /></td></logic:notEqual>
                <td align="left" rowspan="3"> <logic:notEqual scope="request" property="romankletotalleftcalulation" value="" name="lowerExtremityBean"><bean:write property="romankletotalleftcalulation" name="lowerExtremityBean"  /></td></logic:notEqual>
            ...
            <tr class="tbl_bg2_content">          
                ...
                <logic:notEqual scope="request" property="romtotalrightcalulation" value="" name="lowerExtremityBean"><bean:write property="romtotalrightcalulation" name="lowerExtremityBean"  /></td></logic:notEqual>
                <td colspan="4"><b>Total Rom Left =
                <logic:notEqual scope="request" property="romtotalleftcalulation" value="" name="lowerExtremityBean"><bean:write property="romtotalleftcalulation" name="lowerExtremityBean"  /></td></logic:notEqual>
            </tr>    
            <% }valEqualsOne= false; %> 
 ...
 <TABLE border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="100%">
  ...
  <logic:notEqual name="lowerExtremityBean" property="mshiptotalrightcalculation" value="0"><%  valEqualsOne = true;%></logic:notEqual>
            ...
            <%  if (valEqualsOne) {  %> 
            <tr class="tbl_bg2_content">
                <td rowspan="5"><B>1.Hip Joint</B></td>
            ...
            <%  if (valEqualsOne) {  %> 
            <tr class="tbl_bg2_content">
                <td rowspan="2"><B>2. Knee Joint</B></td>
 ...
 <TABLE border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="100%">
  ...
  <logic:notEqual name="lowerExtremityBean" property="complications" value="0"><%  valEqualsOne = true;%></logic:notEqual>
            <%  if (valEqualsOne) {  %> 
            <tr class="tbl_bg2_content">
