<%-- 
    Document   : GeneralNeedsCommonExcel
    Created on : Jan 5, 2011, 5:50:03 PM
    Author     : 509865
--%>
...
<html>
    <head>
        ...
        <title>Common General Needs</title>
    </head>
    <body>
        <logic:present name="commonGeneralNeedsList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="90%">
                <tr>
                    <td align="center" colspan="12"><b>General Needs Common Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></td>
                </tr>
                <tr>
