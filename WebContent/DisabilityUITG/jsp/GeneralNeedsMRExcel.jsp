    ...
    <body>
        <logic:present name="mrGeneralNeedsList" scope="session">
            <table  align="center" cellspacing="1" border="1" cellpadding="4" class="innerTable" width="90%">
                <tr>
                    <td align="center" colspan="13"><b>Mental Retardation General Needs Report As On <font color="blue"><%=fromdate%></font> To <font color="blue"><%=todate%></font></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="center" rowspan="2">Legal Gurdian</td>
                ...
                <logic:iterate id="modify" name="mrGeneralNeedsList" scope="session">
                    <tr>
                        ...
                        <logic:notEmpty name="modify" property="districtName">
                            <td align="center"><bean:write name="modify" property="districtName"/></td></logic:notEmpty>
                        <logic:notEmpty name="modify" property="mandalName">
                            <td align="center"><bean:write name="modify" property="mandalName"/></td></logic:notEmpty>
                        <logic:notEmpty name="modify" property="villageName">
                            <td align="center"><bean:write name="modify" property="villageName"/></td></logic:notEmpty>
                        <logic:notEmpty name="modify" property="habitationName">
                            <td align="center"><bean:write name="modify" property="habitationName"/></td>
                        </logic:notEmpty>
                        ...
                        <td align="center"><bean:write name="modify" property="legalGurdian"/></td>
                ...
                <tr>
                    ...
                    <td align="center"><%=legalGurdianTotal %></td>
