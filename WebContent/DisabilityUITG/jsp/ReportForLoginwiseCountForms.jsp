<%-- 
    Document   : ReportForLoginwiseCountForms
    Created on : May 12, 2010, 1:03:37 PM
    Author     : srinivas_p
--%>
    ...
    <BODY>
        <html:form action="loginwiseformscountreport.do?getReportForLoginWiseCount=getReportForLoginWiseCount"
            ...
            <table  align="center" cellspacing="1" cellpadding="8" class="innerTable" width="60%">
                <tr><td class="heading" align="center">Login Wise Count Report</td></tr>
                <tr >
            </table>
            <table  align="center" cellspacing="1" cellpadding="8" class="innerTable1" width="60%">
                ...
                <tr><td align="center" colspan="4"> <html:submit property="button"  value="Generate Report"
                         onclick="comparedate(this.fromdate,this.todate)" styleClass="button"/></td>
                </tr>
            </table>
            <center> </center>
            <br>
