    ...
    <body>
     ...
     <table  border="1" height="10%" align="center" cellspacing="1" 
            ...
            <tr class="tbl_bg2_content" >
                ...
                <td align="center" bgcolor="white"> <font size="2">
                <font color="#660000">
                <b>Village Name</b></font></td> <td align="center" bgcolor="white">
                <font size="2"><font color="#660000"><b>Village Level Count</b>
                </font></td>
            </tr>
        <% int i=0;%>  
    <logic:iterate id="modify" name="reportlist" scope="session">
    <% if(i==0) { %>
                <b><font color="blue" >you are in</b></font> <font color="red" > > </font> <a href="getMandalidForSurgery.do?getMandalReport=getMandalReport&districtid=<bean:write name="modify" property="districtid"/>&field=<%=fieldvalue%>&secondfield=<%=secondfieldvalue%>&FromDate=<%= fromdate %>&ToDate=<%= todate %>">
        ...
        <a href=" gotoexcelofvillagewisesurgery.do">
        <img src="DisabilityUITG/images/excel.jpg" height="25" width="25"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</table> -->
