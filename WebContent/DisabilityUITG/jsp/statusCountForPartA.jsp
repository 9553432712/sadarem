<%-- 
    Document   : StatusCountForPartA
    Created on : May 27, 2010, 8:37:20 PM
    Author     : srinivas_p
--%>
...
<BODY>
 <html:form action="statuscountforpartareport.do?getStatusCountForPartA=getStatusCountForPartA"
...
<img src="./DisabilityUITG/images/calendar.png" border="0"></a> </td>
    ...
    <tr><td align="center" colspan="4"><html:submit property="button"  value="Generate Report"
                  onclick="comparedate(this.fromdate,this.todate)" styleClass="button"/> </table>
