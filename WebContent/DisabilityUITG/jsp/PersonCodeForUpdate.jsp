...
<html>
    ...
    <body>
        <html:form action="/getPersonCodeUpdateDetails.do?getPersonalDetailsForUpdate=getPersonalDetailsForUpdate" onsubmit="return validate_form(this)" method="post">
            ...
            <table  align="center" cellspacing="0" cellpadding="8" class="innerTable" width="60%">
                ...
                <tr><td class="heading" colspan="2" align="center">Enter Existing SADAREM ID for Updating the Address</td></tr>
