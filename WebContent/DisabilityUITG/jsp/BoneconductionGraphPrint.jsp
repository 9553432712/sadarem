...
<html:html>
    <%
 String boneconductionrightear250=(String)request.getParameter("bre250");
 String boneconductionrightear500=(String)request.getParameter("bre500"); 
 String boneconductionrightear1000=(String)request.getParameter("bre1000");
  String boneconductionrightear2000=(String)request.getParameter("bre2000");
   String boneconductionrightear4000=(String)request.getParameter("bre4000");
    String boneconductionrightear8000=(String)request.getParameter("bre8000");
    
  String boneconductionleftear250=(String)request.getParameter("ble250");
  
 String boneconductionleftear500=(String)request.getParameter("ble500"); 
 String boneconductionleftear1000=(String)request.getParameter("ble1000");
  String boneconductionleftear2000=(String)request.getParameter("ble2000");
   String boneconductionleftear4000=(String)request.getParameter("ble4000");
    String boneconductionleftear8000=(String)request.getParameter("ble8000");  
    
    String lingualTeluguName="&#3114;&#3143;&#3120;&#3137;&#9;&#9;&#9;&#9;&#9;&#9";
    String personcode=(String)session.getAttribute("personcode");
   String telugupersonname=(String)session.getAttribute("teluguname");
...
%>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
     ...
     <style>
     <link rel="text/css" href="DisabilityUITG/css/cssmaster.css"
     </style> 
...
function XYGraph2() {
  ...
  // Data Properties
	...
	this.title="Frequency in HZ";
	this.xaxis="B.C PURE TONE AUDIOGRAM" ;
	this.yaxis="DB Level";
  ...
  // Style Properties
	...
	this.CSStitlefont = "font: 8pt 'Arial'; font-weight: bold;";  // font sizes must be set in "pt"
	this.CSSxaxisfont = "font: 10pt 'Arial'; font-weight: bold;";
...
// draw titles
	...
	gstr+='<span style="'+this.CSSxaxisfont+' position:absolute; text-align:center; top: '+((gymin+0.5*(pad_b-xaxis_pt*gxpt))/gxpt+(xticloc=="top" ? 0.75*tic_pt:0));
...
function XYGraph2() {
  ...
  // Style Properties
	...
	this.CSSticfont = "font: 8pt 'Arial';";
	this.CSStitlefont = "font: 8pt 'Arial'; font-weight: bold;  ";  // font sizes must be set in "pt"
	this.CSSxaxisfont = "font: 10pt 'Arial'; font-weight: bold; color='blue';";
	this.CSSyaxisfont = "font: 8pt 'Arial'; font-weight: bold;";
	this.VMLyaxisfontcolor = "black";  // must specify y-axis title font color since it is VML object
...
<script type="text/javascript">
 var MyGraph;
	function Calculatebonconductionrightear() {
        
  MyGraph = new XYGraph2(); // define new XYGraph object
var MyLine = new XYLine3();   // define new XYLine object  

 
var boneconductionrightear250=document.getElementById("boneconductionrightear250").value;
var boneconductionrightear500=document.getElementById("boneconductionrightear500").value;
var boneconductionrightear1000=document.getElementById("boneconductionrightear1000").value;
var boneconductionrightear2000=document.getElementById("boneconductionrightear2000").value;
var boneconductionrightear4000=document.getElementById("boneconductionrightear4000").value;
var boneconductionrightear8000=document.getElementById("boneconductionrightear8000").value;
...
if(boneconductionrightear250==""){
first=parseInt(second);
boneconductionrightear250=parseInt(boneconductionrightear500);
}
if(boneconductionrightear4000==""){
fifth=parseInt(fourth);
boneconductionrightear4000=parseInt(boneconductionrightear2000);
}
if(boneconductionrightear8000==""){
sixth=parseInt(fifth);
boneconductionrightear8000=parseInt(boneconductionrightear4000);
	...
	MyLine.y = [boneconductionrightear250,boneconductionrightear500,boneconductionrightear1000,boneconductionrightear2000,boneconductionrightear4000,boneconductionrightear8000];
	...
	MyGraph.xscale=1000;
	MyGraph.yscale=10;
  graphdiv2.innerHTML=MyGraph.Plot(MyLine);
 
  
 Calculatebonconductionleftear(); 
}



	
	function Calculatebonconductionleftear() {
var MyLine2 = new XYLine4();   // define new XYLine object

var boneconductionleftear250=document.getElementById("boneconductionleftear250").value;
var boneconductionleftear500=document.getElementById("boneconductionleftear500").value;
var boneconductionleftear1000=document.getElementById("boneconductionleftear1000").value;
var boneconductionleftear2000=document.getElementById("boneconductionleftear2000").value;
var boneconductionleftear4000=document.getElementById("boneconductionleftear4000").value;
var boneconductionleftear8000=document.getElementById("boneconductionleftear8000").value;
...
if(boneconductionleftear250==""){
first=parseInt(second);
boneconductionleftear250=parseInt(boneconductionleftear500);
}
if(boneconductionleftear4000==""){
fifth=parseInt(fourth);
boneconductionleftear4000=parseInt(boneconductionleftear2000);
}
if(boneconductionleftear8000==""){
sixth=parseInt(fourth);
boneconductionleftear8000=parseInt(boneconductionleftear2000);
}
	MyLine2.x = [first,second,third,fourth,fifth,sixth]; 
	MyLine2.y = [boneconductionleftear250,boneconductionleftear500,boneconductionleftear1000,boneconductionleftear2000,boneconductionleftear4000,boneconductionleftear8000];
	...
	MyGraph.xscale=1000;
	MyGraph.yscale=10;
  graphdiv2.innerHTML=MyGraph.Plot(MyLine2);
    ...
    <body onload="Calculatebonconductionrightear(),Calculatebonconductionleftear(),window.print()">
    ...
    <table  border="0" align="center" cellspacing="1" cellpadding="5" class="tbl_bg2" width="80%">
     ...
     <div id="graphdiv2" align="center"  class="graph"></div> 
 
  
      <tr class="tbl_bg2_content" >
    
     <td><html:hidden value="<%=boneconductionrightear250%>" property="boneconductionrightear250"/></td>
     <td><html:hidden value="<%=boneconductionrightear500%>" property="boneconductionrightear500"  /></td>
     <td><html:hidden value="<%=boneconductionrightear1000%>" property="boneconductionrightear1000" /></td>
     <td><html:hidden value="<%=boneconductionrightear2000%>" property="boneconductionrightear2000" /></td>
     <td><html:hidden value="<%=boneconductionrightear4000%>" property="boneconductionrightear4000" /></td>
     <td><html:hidden value="<%=boneconductionrightear8000%>" property="boneconductionrightear8000" /></td>
    
     <td><html:hidden value="<%=boneconductionleftear250%>" property="boneconductionleftear250"/></td>
     <td><html:hidden value="<%=boneconductionleftear500%>" property="boneconductionleftear500"  /></td>
     <td><html:hidden value="<%=boneconductionleftear1000%>" property="boneconductionleftear1000" /></td>
     <td><html:hidden value="<%=boneconductionleftear2000%>" property="boneconductionleftear2000" /></td>
     <td><html:hidden value="<%=boneconductionleftear4000%>" property="boneconductionleftear4000" /></td>
     <td><html:hidden value="<%=boneconductionleftear8000%>" property="boneconductionleftear8000" /></td>
     <td align="right">
<font color="red"><b><font color="red" size="6"><b>.</font>
_____ Right Ear</font><br><font color="blue"><b>o ----- Left Ear</font></td>
     </tr>
  
     </table><br><br><br><br><br><br><br><br><br><br><br>
   <table  border="0" align="bottom" cellspacing="1" cellpadding="5" class="tbl_bg2" width="80%" id="bapi">
    <tr class="tbl_bg2_content" >
      <td align="left" colspan="10"><b><font color="blue">SADAREM ID:&nbsp;<%out.println(personcode);%></font></td> </tr>
          <tr class="tbl_bg2_content" >
      <td align="left" colspan="10"><b><font color="blue"><%=lingualTeluguName%> : <b> <%=telugupersonname%></font></b>
      </td>
          </tr> 
   </table>
