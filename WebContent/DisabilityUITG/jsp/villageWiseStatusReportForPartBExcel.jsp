<%-- 
    Document   : villageWiseStatusReportForPartBExcel
    Created on : Jun 23, 2010, 1:56:14 PM
    Author     : srinivas_p
--%>
...
<html:html>
    ...
    <body>
        <table align="center" cellspacing="1" cellpadding="4" class="innerTable" width="60%" border="1">
            <tr><td align="center" colspan="15"><font color="#c71585">Village Wise Report For Personal Information & Assessed PWD's Details As on <%= fromdate%> To <%= todate%>
                        Mandal:<%=mandalname%>
                        <% if (districtname == null) {%>District:<%=districtname%> <% } else {%>
            ...
            <% int i = 0;%>
            <logic:iterate id="dailyreportlist" name="partBVillageReport" scope="session">
                <tr>
                    <td align="center" class="label" width="75%" ><%=++i%></td>
                    <td class="label"><bean:write name="dailyreportlist" property="village_name"/></td>
