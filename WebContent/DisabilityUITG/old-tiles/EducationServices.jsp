...
<BODY bgcolor="#F2f0e6">
 ...
 <html:form action="getEducationServiceDate.do" 
       styleId="surgeryreportform" onsubmit="return validate_form(this)">
  <table  border="0" align="center" cellspacing="1" cellpadding="5" 
               class="tbl_bg2_content"  width="100%">
            <tr  align="center"  width="100%" bgcolor="white"> 
            <td bgcolor="white"><font face="vardana" color="#660000" size="3">
                 <b>Select The Date For Reports</b> </font>
                    </td><td align="right" bgcolor="white"><font color="red"><b>*
    </b></font><font size="2"face="vardana" color="#660000"><b>From Date :    
                </td><td  align="left" bgcolor="white"> </font>
 <html:text property="fromdate"  readonly="true"  name="surgeryreportform" size="10" />
    ...
    <td align="right" bgcolor="white"><font color="red"><b>*</b></font>
 ...
 onmouseout="window.status='';return true;">
   ...
   <td>
     ...
     <center> <html:submit property="button"  value="Generate Reports"/>
   </td> </tr></table>
