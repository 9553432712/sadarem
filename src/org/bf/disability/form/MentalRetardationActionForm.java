/*
 * MentalRetardationActionForm.java
 *
 */
...
public class MentalRetardationActionForm  extends ValidatorForm {
    
    /**
     * Creates a new instance of MentalRetardationActionForm
     */
    ...
    private String toys;
    private String anyothermentalretardation = null;
    ...
    public String getAnyothermentalretardation() {
        if(!"".equals(anyothermentalretardation)) {
            return  this.anyothermentalretardation;
        } else {
            return null;
        }
    }
