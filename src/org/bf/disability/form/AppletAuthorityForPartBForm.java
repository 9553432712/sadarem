 ...
 * @author 484898
 */
public class AppletAuthorityForPartBForm extends ActionForm {
//added by rekha
    ...
    private String mode;
    private String sadaremCode;
    private String sadaremId;
    private String personStatusForAU;
    private String name;
 ...
 private FormFile photoUpload = null;
    public FormFile getPhotoUpload() {
        return photoUpload;
    }

    public void setPhotoUpload(FormFile photoUpload) {
    ...
    public String getPersonStatusForAU() {
        return personStatusForAU;
    }

    public void setPersonStatusForAU(String personStatusForAU) {
        this.personStatusForAU = personStatusForAU;
    }
    ...
    public String getSadaremCode() {
        return sadaremCode;
    }

    public void setSadaremCode(String sadaremCode) {
        this.sadaremCode = sadaremCode;
    }
