/*
 * MRDevelopmentalScreeningTestForm.java
 *
 * Created on October 14, 2008, 4:48 PM
 */
...
/**
 * This class contains the fields, required to compute IQ using Developmental Screening Test, 
 * for calculating Mental Retardation
 * @author Pramod Kuamr
 * @version 1.0
 */
public class MRDevelopmentalScreeningTestForm extends org.apache.struts.action.ActionForm 
{
    ...
    {
        dst_birth_cry_present =0;
     dst_equal_bilateral_movements =0;
     dst_responds_to_bell =0;
     dst_vocalises_sounds =0;
     dst_smiles_spontaneously =0;
     dst_eyes_following_moving_object =0;
     dst_head_steady =0;
     dst_reaches_for_objects =0;
     dst_laughs_loud =0;
     dst_recognises_mother =0;
     dst_vocalises_for_pleasure_or_babble =0;
     dst_carries_objects_to_mouth =0;
     dst_rolls_over =0;
    
     dst_imitates_speech_sounds =0;
     dst_sits_by_self =0;
     dst_thumb_finger_grasp =0;
     dst_shows_curiousity =0;
     dst_says_three_words =0;
     dst_stands_alone_well =0;
     dst_follows_simple_instructions =0;
     dst_cooperates_for_dressing =0;
     dst_many_intelligible_words =0;
     dst_walks_runs_well =0;
     dst_indicates_wants =0;
     dst_scribbles_spontaneously =0;
    
    
     dst_says_sentences_of_twobythree_words =0;
     dst_points_out_objects_in_pictures =0;
     dst_shows_body_parts =0;
     dst_participates_in_play =0;
     dst_copies_o =0;
     dst_relates_experiences =0;
     dst_knows_names_uses_of_common_objects =0;
     dst_begins_to_ask_why =0;
     dst_takes_food_by_self =0;
     dst_toilet_control_present =0;
     dst_buttons_up =0;
     dst_comprehends_hunger_cold =0;
     dst_plays_cooperatively_with_children =0;
     dst_repeats_three_digits =0;
     dst_tells_stories =0;
    
    
     dst_defines_words =0;
     dst_makes_simple_drawing =0;
     dst_dresses_with_no_supervision =0;
     dst_describes_actions_in_pictures =0;
     dst_gives_sensible_answers_to_questions =0;
     dst_goes_about_neighbourhood =0;
     dst_can_name_primary_colours =0;
     dst_plays_games_governed_by_rules =0;
     dst_writes_simple_words =0;
     dst_gains_admission_to_school =0;
     dst_enjoys_constructive_play =0;
    
    
     dst_adapts_to_home_school =0;
     dst_tells_differences_of_objects =0;
     dst_spells_reads_writes_simple_words =0;
     dst_enjoys_group_play =0;
     dst_knows_comparative_value_of_coins =0;
     dst_combs_hair_by_self =0;
     dst_makes_small_purchases =0;
     dst_competition_in_school_or_play =0;
     dst_tells_time =0;
     dst_tells_day_month_year =0;
     dst_reads_on_own_initiative =0;
     dst_recognises_property_rights =0;
     dst_favourite_of_fairy_tales =0;
     dst_muscle_coordination_games =0;
     dst_bathes_self_unaided =0;
    
    
    
     dst_cooperates_keenly_with_companions =0;
     dst_has_various_hobbies_collections =0;
     dst_goes_about_town_freely =0;
     dst_sex_differences_in_play_become_marked =0;
     dst_can_stay_away_from_home =0;
     dst_writes_occasional_short_letters =0;
     dst_comprehends_social_situations =0;
     dst_physical_feets_liked =0;
     dst_able_to_discuss_problems =0;
     dst_enjoys_books_newspapers_magazines =0;
     dst_more_independent_in_spending =0;
     dst_capable_of_self_criticism =0;
    
    
     dst_shows_foresight_planning_judgement =0;
     dst_learns_from_experience =0;
     dst_plays_difficult_games =0;
     dst_interested_in_dressing_up =0;
     dst_understands_abstract_ideas =0;
     dst_makes_sensible_plans_for_future =0;
     dst_follows_current_events =0;
     dst_buys_own_clothing =0;
     dst_systematises_own_work =0;
     dst_purchases_for_others =0; 
    }
