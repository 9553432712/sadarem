...
public class CertiUploadReportDAOImpl implements  CertiUploadReportDAO{
	static final private Logger log = Logger.getLogger(DirectorReportOutsideDAOImpl.class);
	Connection lcon;
	String lStrQuery;
	public ArrayList  getabstractcertiuploaddata(String fromdate,String todate,String district,String mandal,String village,String areatype, String Trigp)
	{
		...
		try{
					...
					lStrQuery = " {CALL PRO_SADAREM_REPORT_8_1_UPLOADED_CERTS_DETAILS(?,?,?,?,?,?,?)}";
	...
	public String getHeading(String fromdate, String todate, String distname,String mandalname,String villagename, String district,
			String mandal, String village,String areatype,String TRIGPSel)
	{
		String msg="";
