...
public class DirectorReportOutsideDAOImpl implements DirectorReportOutsideDAO {
	static final private Logger log = Logger.getLogger(DirectorReportOutsideDAOImpl.class);
	Connection lcon;
	String lStrQuery;
	
	public ArrayList  getabstractassesseddata(String fromdate,String todate,String district,String mandal,String village,String disability,String areatype,String Trigp)
	{
		...
		try{
					...
					lStrQuery = " {CALL PRO_SADAREM_REPORT_1_2_District_WISE(?,?,?,?,?,?,?,?)}";
	...
	public String getDistrictWiseHeading(String fromdate,String todate,String distname,String mandalname,String villagename,String districtid,String mandalid,String villageid,String areatype,String TRIGPSel)
	{
		String msg="";
