...
public class MultipleCasesReportDAOImpl implements  MultipleCasesReportDAO{
	static final private Logger log = Logger.getLogger(DirectorReportOutsideDAOImpl.class);
	Connection lcon;
	String lStrQuery;
	public ArrayList  getsearchddata(String fromdate, String todate,
			...
			String employment, String agefrom, String ageto, String disfrom,String disto,String Trigp)
	{
		...
		try{
					...
					lStrQuery = " {CALL PRO_SADAREM_REPORT_4_4_SEARCH_DETAILS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
					...
					tempList.add(district);
			      	...
			      	tempList.add(village);
			       	...
			       	tempList.add(agefrom);
			       	tempList.add(ageto);
			       	tempList.add(disfrom);
			       	tempList.add(disto);
			       	tempList.add(Trigp);
