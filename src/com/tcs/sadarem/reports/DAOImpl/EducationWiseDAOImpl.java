...
public class EducationWiseDAOImpl implements EducationWiseDAO{
	static final private Logger log = Logger.getLogger(DirectorReportOutsideDAOImpl.class);
	Connection lcon;
	String lStrQuery;
	public ArrayList  getabstracteducationdata(String fromdate,String todate,String district,String mandal,String education,String areatype,String Trigp)
	{
		...
		try{
					...
					lStrQuery = " {CALL PRO_SADAREM_REPORT_3_1_QUALIFICATION_DETAILS(?,?,?,?,?,?,?)}";
	...
	public String getHeading(String fromdate, String todate, String distname,String mandalname, String district,
			String mandal, String areatype,String education,String TRIGPSel)
	{
		String msg="";
		...
		if(education.length()>0)
		{
			...
			{
				msg+="<font color='blue'><b> Education : </b></font>All.";
			}
			else
			{
				msg+="<font color='blue'><b> Education : </b></font>"+education+". ";
			}
		}
		...
		//System.out.println("message:"+msg);TRIGPSel
	return msg;	
