...
public class NameChangeIssueAction extends BaseDispatchAction 
{
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    try{
				...
				if(nameChangeDtls.size()>0)
				{
				    ...
				    String fname     	= ((FileItem) nameChangeDtls.get("fname")).getString();
				    String telname   	= ((FileItem) nameChangeDtls.get("hidfulnametelugu")).getString();
					...
					proofTypeList = comObj.getproofdoucments();
						...
						{ 
							...
							nameChangModifyDtls.put("fname",fname );
							nameChangModifyDtls.put("telname",telname );
							...
							if(!issueAlreadyRaised.equals("N"))
							{
								...
								{
									toBemodifyStatus = comObj.insertNameChangeDtls(nameChangModifyDtls);
								}
							}
							else
							{
