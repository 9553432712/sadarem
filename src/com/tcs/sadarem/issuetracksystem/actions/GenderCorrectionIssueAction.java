...
public class GenderCorrectionIssueAction extends BaseDispatchAction 
{
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    try{
				...
				if(nameChangeDtls.size()>0)
				{
				    ...
				    String gender     	= ((FileItem) nameChangeDtls.get("gender")).getString();
				    String genderId   	= ((FileItem) nameChangeDtls.get("genderId")).getString();
					...
					proofTypeList = comObj.getproofdoucments();
						...
						{ 
							...
							nameChangModifyDtls.put("gender",gender );
							nameChangModifyDtls.put("genderId",genderId );
							...
							if(!issueAlreadyRaised.equals("N"))
							{
								...
								{
									toBemodifyStatus = comObj.insertGenderChangeDtls(nameChangModifyDtls);
								}
							}
							else
							{
