...
public class ServicesPortTypeProxy implements Aadhar.ServicesPortType {
  private String _endpoint = null;
  private Aadhar.ServicesPortType servicesPortType = null;
  ...
  private void _initServicesPortTypeProxy() {
    try {
      servicesPortType = (new Aadhar.ServicesLocator()).getServicesSOAP11port_http();
  ...
  public Aadhar.ServicesPortType getServicesPortType() {
    if (servicesPortType == null)
      _initServicesPortTypeProxy();
